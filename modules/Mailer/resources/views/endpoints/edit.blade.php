...
@section('page_header')
    @include('core::components.card', ['title' => 'Editar Email Endpoint'])
@endsection
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <p class="text-muted mb-3">Este token es necesario para autenticar las peticiones al endpoint. Envíalo en el header <code>X-API-Token</code>.</p>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <p class="text-muted mb-3">Resumen del uso de este endpoint.</p>
                    </div>

                    {{-- Stats pre-calculated in controller --}}
                    ...
                    <div class="col-12">
                        ...
                        <p class="text-muted mb-3">Define el nombre, slug único y la fuente del endpoint.</p>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('source') is-invalid @enderror" id="source" name="source" required>
                                ...
                                <option value="internal" {{ old('source', $endpoint->source) === 'internal' ? 'selected' : '' }}>Internal</option>
                                <option value="webhook" {{ old('source', $endpoint->source) === 'webhook' ? 'selected' : '' }}>Webhook</option>
                                <option value="api" {{ old('source', $endpoint->source) === 'api' ? 'selected' : '' }}>API</option>
                            </select>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('type') is-invalid @enderror" id="type" name="type" required>
                                ...
                                <option value="transactional" {{ old('type', $endpoint->type) === 'transactional' ? 'selected' : '' }}>Transactional</option>
                                <option value="notification" {{ old('type', $endpoint->type) === 'notification' ? 'selected' : '' }}>Notification</option>
                            </select>
                    ...
                    <div class="col-12">
                        ...
                        <p class="text-muted mb-3">Últimas peticiones recibidas en este endpoint.</p>
                    </div>
