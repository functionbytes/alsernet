...
class OpenLog extends Model
{
    ...
    {
        return $this->belongsTo('Modules\Mailing\Models\TrackingLog', 'message_id', 'message_id');
    }

    public function ipLocation()
    {
        return $this->belongsTo('Modules\Mailing\Models\IpLocation', 'ip_address', 'ip_address');
    }
