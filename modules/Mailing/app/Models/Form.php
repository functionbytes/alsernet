...
class Form extends Model implements HasTemplateInterface
{
    ...
    public function createFromArray($params)
    {
        ...
        $this->mail_list_id = \Modules\Mailing\Models\MailList::findByUid($params['mail_list_uid'])->id;
        $this->save();
    ...
    public function scopeFilter($query, $params)
    {
        ...
        if (! empty($params['mail_list_uid'])) {
            $query = $query->where('mail_list_id', '=', \Modules\Mailing\Models\MailList::findByUid($params['mail_list_uid'])->id);
        }

        // list
        if (! empty($params['website_uid'])) {
            $query = $query->byWebsite(\Modules\Mailing\Models\Website::findByUid($params['website_uid']));
        }
    }
    ...
    {
        return $this->getMetadata('website_uid') ? \Modules\Mailing\Models\Website::findByUid($this->getMetadata('website_uid')) : null;
    }
