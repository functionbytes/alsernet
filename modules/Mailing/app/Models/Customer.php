...
use Modules\Mailing\Library\AutoBillingData;
...
class Customer extends Model
{
    ...
    {
        $query = \Modules\Mailing\Models\Subscriber::leftJoin('mail_lists', 'mail_lists.id', '=', 'subscribers.mail_list_id')
    ...
    public function getColorScheme()
    {
        ...
        if (! empty($this->color_scheme)) {
            ...
            return \Modules\Mailing\Models\Setting::get('frontend_scheme');
        }
    }
    ...
    public static function customersCountByTime($begin, $end, $admin = null)
    {
        ...
        if (isset($admin) && ! $admin->can('readAll', new \Modules\Mailing\Models\Customer)) {
    ...
    {
        return $this->sendingServers()->where('status', '=', \Modules\Mailing\Models\SendingServer::STATUS_ACTIVE);
    }
    ...
    {
        $allTypes = \Modules\Mailing\Models\SendingServer::types();
        $types = [];
    ...
    {
        $address = new \Modules\Mailing\Models\BillingAddress;
    ...
    public function createAbandonedEmailAutomation($store)
    {
        ...
        $email = new \Modules\Mailing\Models\Email([
    ...
    public function getBuilderTemplates()
    {
        ...
        // Gallery
        $templates = \Modules\Mailing\Models\Template::where('customer_id', '=', $this->id)
    ...
    {
        $customer = new self;
        $customer->menu_layout = \Modules\Mailing\Models\Setting::get('layout.menu_bar');
    ...
    {
        $product = new \Modules\Mailing\Models\Product;
