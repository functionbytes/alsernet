...
class InvoiceItem extends Model
{
    ...
    public function getTaxPercent()
    {
        if ($this->invoice->billing_country_id) {
            $country = \Modules\Mailing\Models\Country::find($this->invoice->billing_country_id);
            $tax = \Modules\Mailing\Models\Setting::getTaxByCountry($country);
        } else {
            $tax = \Modules\Mailing\Models\Setting::getTaxByCountry(null);
        }
