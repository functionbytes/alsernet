...
use Modules\Mailing\Events\MailListUnsubscription;
...
class Subscriber extends Model
{
    ...
    {
        $query = \Modules\Mailing\Models\TrackingLog::where('tracking_logs.subscriber_id', '=', $this->id);
    ...
    {
        $query = \Modules\Mailing\Models\OpenLog::leftJoin('tracking_logs', 'tracking_logs.message_id', '=', 'open_logs.message_id')
    ...
    {
        $query = \Modules\Mailing\Models\ClickLog::leftJoin('tracking_logs', 'tracking_logs.message_id', '=', 'click_logs.message_id')
            ->where('tracking_logs.subscriber_id', '=', $this->id);
