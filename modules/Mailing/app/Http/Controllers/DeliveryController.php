...
use Modules\Mailing\Models\FeedbackLog;
use Modules\Mailing\Models\SendingServerBlastengine;
use Modules\Mailing\Models\SendingServerElasticEmail;
use Modules\Mailing\Models\SendingServerMailgun;
use Modules\Mailing\Models\SendingServerSendGrid;
use Modules\Mailing\Models\SendingServerSparkPost;
...
class DeliveryController extends Controller
{
    ...
    public function notify(Request $request)
    {
        ...
        try {
            ...
            } elseif ($type == SendingServerBlastengine::WEBHOOK) {
                SendingServerBlastengine::handleNotification();
            } else {
