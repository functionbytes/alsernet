...
class CampaignController extends Controller
{
    ...
    public function show($id)
    {
        ...
        event(new \Modules\Mailing\Events\CampaignUpdated($campaign));
    ...
    public function templateLayout(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            $template = \Modules\Mailing\Models\Template::findByUid($request->template);
    ...
    public function confirm(Request $request)
    {
        ...
        if ($request->isMethod('post') && $campaign->step() >= 5) {
            // Japan + not license
            if (config('custom.japan') && ! \Modules\Mailing\Models\Setting::get('license')) {
                return response()->json([
                    'status' => 'error',
    ...
    public function bounceLogListing(Request $request)
    {
        ...
        $items = \Modules\Mailing\Models\BounceLog::search($request, $campaign)->paginate($request->per_page);
    ...
    public function feedbackLogListing(Request $request)
    {
        ...
        $items = \Modules\Mailing\Models\FeedbackLog::search($request, $campaign)->paginate($request->per_page);
    ...
    public function openLogListing(Request $request)
    {
        ...
        $items = \Modules\Mailing\Models\OpenLog::search($request, $campaign)->paginate($request->per_page);
    ...
    public function clickLogListing(Request $request)
    {
        ...
        $items = \Modules\Mailing\Models\ClickLog::search($request, $campaign)->paginate($request->per_page);
    ...
    public function unsubscribeLogListing(Request $request)
    {
        ...
        $items = \Modules\Mailing\Models\UnsubscribeLog::search($request, $campaign)->paginate($request->per_page);
    ...
    public function templateBuild(Request $request)
    {
        ...
        if (isset($request->style)) {
            $elements = \Modules\Mailing\Models\Template::templateStyles()[$request->style];
        }
    ...
    {
        $webhook = \Modules\Mailing\Models\CampaignWebhook::findByUid($request->webhook_uid);
