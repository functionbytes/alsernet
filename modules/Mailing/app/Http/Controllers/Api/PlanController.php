...
class PlanController extends Controller
{
    ...
    public function index()
    {
        ...
        // authorize
        if (! $user->can('read', new \Modules\Mailing\Models\PlanGeneral)) {
            return \Response::json(['message' => 'Unauthorized'], 401);
        }

        $rows = \Modules\Mailing\Models\PlanGeneral::limit(100)->get();
    ...
    public function store(Request $request)
    {
        ...
        $plan = new \Modules\Mailing\Models\PlanGeneral;
        ...
        if ($request->isMethod('post')) {
            ...
            $plan->status = \Modules\Mailing\Models\PlanGeneral::STATUS_INACTIVE;
            $plan->save();
