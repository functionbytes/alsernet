...
class SubscriptionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $subscriptions = \Modules\Mailing\Models\Subscription::select('*')
    ...
    {
        $user = \Auth::guard('api')->user();
        $customer = \Modules\Mailing\Models\Customer::findByUid($request->customer_uid);
        $plan = \Modules\Mailing\Models\PlanGeneral::findByUid($request->plan_uid);
