...
class MailListController extends Controller
{
    ...
    public function index()
    {
        ...
        $lists = \Modules\Mailing\Models\MailList::getAll()
    ...
    public function show($id)
    {
        ...
        $item = \Modules\Mailing\Models\MailList::where('uid', '=', $id)
            ->first();
    ...
    public function store(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            $validator = \Validator::make($request->all(), \Modules\Mailing\Models\MailList::$rules);
            if ($validator->fails()) {
    ...
    public function addField(Request $request, $uid)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $exist = \Modules\Mailing\Models\Field::where('mail_list_id', '=', $list->id)
