...
class CampaignController extends Controller
{
    ...
    public function index()
    {
        ...
        $lists = \Modules\Mailing\Models\Campaign::getAll()
    ...
    {
        $user = \Auth::guard('api')->user();
        $campaign = \Modules\Mailing\Models\Campaign::findByUid($id);
    ...
    public function show($id)
    {
        ...
        $item = \Modules\Mailing\Models\Campaign::where('uid', '=', $id)
            ->first();
    ...
    public function pause($id)
    {
        ...
        $campaign = \Modules\Mailing\Models\Campaign::where('uid', '=', $id)
            ->first();
    ...
    {
        $user = \Auth::guard('api')->user();
        $campaign = \Modules\Mailing\Models\Campaign::findByUid($uid);
