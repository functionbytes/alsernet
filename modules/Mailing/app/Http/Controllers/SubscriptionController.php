...
use Modules\Mailing\Models\InvoiceNewSubscription;
use Modules\Mailing\Models\PlanGeneral;
use Modules\Mailing\Models\SubscriptionLog;
use Modules\Mailing\Models\Transaction;
...
class SubscriptionController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        ...
        if (
            \Modules\Mailing\Models\Setting::get('not_require_card_for_trial') == 'yes' &&
    ...
    {
        $invoice = \Modules\Mailing\Models\Invoice::findByUid($uid);
    ...
    {
        $invoice = \Modules\Mailing\Models\Invoice::findByUid($invoice_uid);
        $transaction = $invoice->getPendingTransaction();
