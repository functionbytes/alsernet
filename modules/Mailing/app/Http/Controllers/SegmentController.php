...
class SegmentController extends Controller
{
    ...
    {
        // authorize
        if (\Gate::denies('list', \Modules\Mailing\Models\Segment::class)) {
    ...
    public function listing(Request $request)
    {
        ...
        $list = \Modules\Mailing\Models\MailList::findByUid($request->list_uid);
        $segments = \Modules\Mailing\Models\Segment::search($request)->paginate($request->per_page);
    ...
    {
        $list = \Modules\Mailing\Models\MailList::findByUid($request->list_uid);
        $segment = new \Modules\Mailing\Models\Segment;
        ...
        if (isset($request->old()['conditions'])) {
            ...
            foreach ($request->old()['conditions'] as $key => $item) {
                $condition = new \Modules\Mailing\Models\SegmentCondition;
                $condition->uid = $key;
                $condition->fill($item);
    ...
    public function store(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            $rules = \Modules\Mailing\Models\Segment::$rules;
    ...
    {
        $list = \Modules\Mailing\Models\MailList::findByUid($request->list_uid);
        $segment = \Modules\Mailing\Models\Segment::findByUid($request->uid);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->isMethod('patch')) {
            ...
            event(new \Modules\Mailing\Events\MailListUpdated($segment->mailList));
    ...
    {
        $items = \Modules\Mailing\Models\Segment::whereIn(
            'uid',
    ...
    {
        $field = \Modules\Mailing\Models\Field::findByUid($request->field_uid);
