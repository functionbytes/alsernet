...
class AuthController extends Controller
{
    ...
    {
        $config = [
            'client_id' => \Modules\Mailing\Models\Setting::get('oauth.google_client_id'),
            'client_secret' => \Modules\Mailing\Models\Setting::get('oauth.google_client_secret'),
    ...
    public function googleCallback(Request $request)
    {
        ...
        if ($user) {
            ...
            \App\Models\User::createCustomer([
    ...
    {
        $config = [
            'client_id' => \Modules\Mailing\Models\Setting::get('oauth.facebook_client_id'),
            'client_secret' => \Modules\Mailing\Models\Setting::get('oauth.facebook_client_secret'),
