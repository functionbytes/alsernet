...
class MailerTemplatePolicy
{
     ...
     */
    public function view(User $user, MailingTemplate $template): bool
    {
        return $user->hasPermissionTo('mailer.templates.view');
    }
     ...
     */
    public function update(User $user, MailingTemplate $template): bool
    {
     ...
     */
    public function delete(User $user, MailingTemplate $template): bool
    {
     ...
     */
    public function preview(User $user, MailingTemplate $template): bool
    {
