...
class MailerComponentPolicy
{
     ...
     */
    public function view(User $user, MailingLayout $component): bool
    {
        return $user->hasPermissionTo('mailer.components.view');
    }
     ...
     */
    public function update(User $user, MailingLayout $component): bool
    {
     ...
     */
    public function delete(User $user, MailingLayout $component): bool
    {
     ...
     */
    public function preview(User $user, MailingLayout $component): bool
    {
