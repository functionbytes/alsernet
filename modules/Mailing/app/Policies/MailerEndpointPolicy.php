...
use App\Models\User;
use Modules\Mailer\Models\MailingEndpoint;
...
class MailerEndpointPolicy
{
     ...
     */
    public function view(User $user, MailingEndpoint $endpoint): bool
    {
        return $user->hasPermissionTo('mailer.endpoints.view');
    }
     ...
     */
    public function update(User $user, MailingEndpoint $endpoint): bool
    {
     ...
     */
    public function delete(User $user, MailingEndpoint $endpoint): bool
    {
     ...
     */
    public function viewLogs(User $user, MailingEndpoint $endpoint): bool
    {
     ...
     */
    public function regenerateToken(User $user, MailingEndpoint $endpoint): bool
    {
