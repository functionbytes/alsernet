...
class MailerTemplateRendererService
{
     ...
     */
    public static function renderEmailTemplate(MailingTemplate $template, array $variables = [], ?int $langId = null): string
    {
     ...
     *
     * @param  MailingTemplate|Template|MailingLayout  $template
    ...
    private static function getCachedLayoutContent(string $alias, int $langId): ?string
    {
        ...
        if ($content === null) {
            $layout = MailingLayout::where('alias', $alias)->first();
     ...
     *
     * @param  MailingTemplate|Template  $template
     */
    public static function getPreviewHtml($template, bool $includeLayout = true): string
    {
        ...
        if ($template instanceof MailingTemplate) {
     ...
     */
    public static function validateTemplate(MailingTemplate $template): array
    {
     ...
     */
    public static function prepareTestEmail(MailingTemplate $template, string $recipient = ''): array
    {
