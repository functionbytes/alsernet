...
class MailerVariableReplacementService
{
     ...
     *
     * @param  MailingTemplate  $template  Template para obtener el módulo
     * @param  int  $langId  ID del idioma para obtener valores traducidos
     * @return array Variables de preview con valores de ejemplo
     */
    public static function getPreviewVariablesForTemplate(MailingTemplate $template, int $langId = 1): array
    {
