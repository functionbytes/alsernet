...
-d contact[country_id]='.\Modules\Mailing\Models\Country::first()->id.' \
                    ...
                    'parameters' => [
                        ...
                        ['name' => '$options[...]', 'description' => 'Plan\'s options...<br>
                            <ul>
                                ...
                                <li><span class="text-semibold">sending_server_option</span>: ('.\Modules\Mailing\Models\PlanGeneral::SENDING_SERVER_OPTION_SYSTEM.'|'.\Modules\Mailing\Models\PlanGeneral::SENDING_SERVER_OPTION_OWN.'|'.\Modules\Mailing\Models\PlanGeneral::SENDING_SERVER_OPTION_SUBACCOUNT.')</li>
...
-d api_token='.\Auth::user()->api_token.'  \
-d name=Advanced \
-d currency_id='.\Modules\Mailing\Models\Currency::first()->id.' \
-d frequency_amount=1 \
-d frequency_unit=month \
-d price=20 \
-d color=red \
-d options[sending_server_option]='.\Modules\Mailing\Models\PlanGeneral::SENDING_SERVER_OPTION_OWN.' \
