...
class Tool
{
    ...
    public static function cronjobUpdateController($request, $controller)
    {
        ...
        $setting_php_bin_path = \Modules\Mailing\Models\Setting::get('php_bin_path');
        ...
        if (empty(\Modules\Mailing\Models\Setting::get('remote_job_token'))) {
            \Modules\Mailing\Models\Setting::set('remote_job_token', str_random(60));
        }
        ...
        if ($request->isMethod('post')) {
            ...
            if ($request->queue_driver == 'database') {
                ...
                \Modules\Mailing\Models\Setting::set('php_bin_path', $php_bin_path_value);
