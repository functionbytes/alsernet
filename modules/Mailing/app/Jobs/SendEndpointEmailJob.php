...
use Modules\Mailer\Models\MailingEndpointLog;

class SendEndpointEmailJob implements ShouldQueue
{
    use Dispatchable, InteractsWithQueue, Queueable, SerializesModels;

    protected MailingEndpointLog $log;

    /**
     * Create a new job instance
     */
    public function __construct(MailingEndpointLog $log)
    {
        $this->log = $log;
    }
     ...
     */
    private function mapVariables(array $payload, MailingEndpoint $endpoint): array
    {
        $variables = [];
