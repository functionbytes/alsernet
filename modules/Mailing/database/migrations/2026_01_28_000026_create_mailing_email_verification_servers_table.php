...
return new class extends Migration
{
    ...
    {
        Schema::connection('acelle')->create('mailing_email_verification_servers', function (Blueprint $table) {
    ...
    {
        Schema::connection('acelle')->dropIfExists('mailing_email_verification_servers');
    }
};
