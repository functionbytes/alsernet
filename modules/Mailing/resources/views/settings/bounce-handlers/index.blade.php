...
@section('page_title', 'Manejadores de rebote')

@section('content')

    {{-- Breadcrumb Card --}}
    @include('core::components.card', [
        'title' => 'Manejadores de rebote',
        'breadcrumbs' => [
            ['label' => 'Dashboard', 'url' => url('/home')],
            ['label' => 'Configuración', 'url' => ''],
            ['label' => 'Manejadores de rebote', 'active' => true]
        ]
    ])
        ...
        <div class="card">
            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="mb-1 fw-bold">Manejadores de rebote</h5>
                        <p class="small mb-0 text-muted">Gestiona los servicios que procesan correos rebotados</p>
                    </div>
                    <a href="{{ route('settings.mailing.bounce-handlers.create') }}" class="btn btn-primary">
                ...
                <div class="alert alert-info border-0 mb-0" role="alert">
                    <div class="d-flex align-items-center justify-content-between gap-3">
                        <div class="d-flex align-items-start">
                            ...
                            <div>
                                <h6 class="fw-bold mb-2">Manejadores de rebote</h6>
                                <p class="mb-0">
                                    Configura servicios para procesar automáticamente correos rebotados (IMAP, POP3 o Webhook).
                                    Los rebotes se procesan y se marcan los suscriptores inactivos automáticamente.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            {{-- Filters --}}
            <div class="card-body border-bottom">
                <form method="GET" action="{{ route('settings.mailing.bounce-handlers.index') }}">
                    <div class="row g-3 align-items-end">
                        <div class="col-12 col-md-7">
                            ...
                            <input type="text"
                                   ...
                                   name="search"
                                   class="form-control"
                                   placeholder="Buscar por nombre, email o host..."
                        ...
                        <div class="col-12 col-sm-6 col-md-2 d-flex gap-2">
                            ...
                            @if (request('search') || request('status'))
                                <a href="{{ route('settings.mailing.bounce-handlers.index') }}" class="btn btn-outline-secondary">
                    ...
                    <table class="table table-hover mb-0">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th width="15%">Rebotes procesados</th>
                        ...
                        <tbody>
                            @foreach ($handlers as $handler)
                                <tr>
                                    ...
                                    <td>
                                        @if($handler->type === 'imap' || $handler->type === 'pop3')
                                            <small class="text-muted">{{ $handler->email ?? 'N/A' }}</small>
                                        @else
                                            <small class="text-muted">Webhook</small>
                                        @endif
                                    </td>
                                    <td>
                                        <small class="text-muted">{{ $handler->bounces_processed ?? 0 }}</small>
                                    </td>
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('settings.mailing.bounce-handlers.edit', $handler->uid) }}">
            ...
            <div class="card-body">
                <div class="text-center py-5">
                    ...
                    <p class="text-muted mb-4">
                        ...
                        @else
                            Comienza creando tu primer manejador de rebote.
                        @endif
                    </p>
                    @if (request('search') || request('status'))
                        <a href="{{ route('settings.mailing.bounce-handlers.index') }}" class="btn btn-secondary">
                            Ver todos
                        </a>
                    @else
                        <a href="{{ route('settings.mailing.bounce-handlers.create') }}" class="btn btn-primary">
        ...
        btn.addEventListener('click', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    fetch(`{{ route('settings.mailing.bounce-handlers.destroy', '') }}/${handlerId}`, {
                        method: 'DELETE',
                        headers: {
