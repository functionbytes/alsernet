...
class UpdateProductAttributeSetRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()->can('ecommerce.product-attribute-sets.update');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => [
                ...
                'string',
                'max:120',
                Rule::unique('ecommerce_product_attribute_sets', 'slug')->ignore($this->route('productAttributeSet')),
            ],
