...
.chatbot-msg.user { background: #b10100; color: #fff; margin-left: auto; }
...
.chatbot-quick-btn:hover { border-color: #b10100; color: #b10100; }
.chatbot-input-wrap {
...
.chatbot-input-wrap button { background: #b10100; color: #fff; border: none; padding: 6px 12px; border-radius: 20px; cursor: pointer; }
...
.chatbot-product-card .price { color: #b10100; font-weight: 600; }
