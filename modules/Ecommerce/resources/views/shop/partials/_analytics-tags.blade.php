@php
    $ga4   = \Modules\Core\Models\Setting::get('ecommerce.ga4_id', '');
    $pixel = \Modules\Core\Models\Setting::get('ecommerce.meta_pixel_id', '');
    $gtm   = \Modules\Core\Models\Setting::get('ecommerce.gtm_id', '');
@endphp
