...
@section('content')
    @include('core::components.card', ['title' => 'Ecommerce - Nueva direccion'])
            ...
            <form action="{{ route('ecommerce.customers.addresses.store', $customer) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="type" class="form-control @error('type') is-invalid @enderror" value="{{ old('type') }}" placeholder="shipping / billing">
