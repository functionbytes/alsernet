        ...
        <div class="row g-4 align-items-start">
            ...
            <div class="col-12 col-lg-8">
                <div class="card">
                    <div class="card-header border-bottom p-3">
                        ...
                        <small class="text-muted">Modifica los datos de la venta flash.</small>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-4" style="position: sticky; top: 80px;">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary w-100 mb-2">Actualizar promocion</button>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="small">{{ $flashSale->created_at->translatedFormat('j M, Y') }}</span>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="text-muted small">Actualizado</span>
                            <span class="small">{{ $flashSale->updated_at->translatedFormat('j M, Y') }}</span>
                        </div>
                    </div>
                </div>
            </div>
