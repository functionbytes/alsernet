                ...
                <div class="col-12 col-lg-8">
                    <div class="card">
                        <div class="card-header p-3 border-bottom">
                            <h5 class="mb-0 fw-bold">Nueva etiqueta de producto</h5>
                            <small class="text-muted">Define los colores y el estado de la etiqueta</small>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <input type="color" id="text_color_picker" value="{{ old('text_color', '#ffffff') }}"
                                        class="form-control form-control-color flex-shrink-0">
                                    <input type="text" name="text_color" id="text_color_hex"
                                        class="form-control @error('text_color') is-invalid @enderror"
                                        placeholder="#ffffff" value="{{ old('text_color', '#ffffff') }}">
                                </div>
                                @error('text_color')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
