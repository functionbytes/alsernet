                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <input type="color" id="color_picker" value="{{ old('color', $label->color ?? '#b10100') }}"
                                        class="form-control form-control-color flex-shrink-0">
                                    <input type="text" name="color" id="color_hex"
                                        class="form-control @error('color') is-invalid @enderror"
                                        placeholder="#b10100" value="{{ old('color', $label->color ?? '#b10100') }}">
                                </div>
                                @error('color')
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <span id="label_preview" class="badge rounded-pill px-3 py-2"
                                    style="background-color: {{ $label->color ?? '#b10100' }}; color: {{ $label->text_color ?? '#ffffff' }}; font-size: 0.9rem;">
                                    {{ $label->name }}
                                </span>
                            </div>
                        </div>
