...
@section('page_header')
    @include('core::components.card', ['title' => 'Ecommerce - Editar página legal'])
@endsection

@section('content')
    @include('core::components.alerts')

    <form action="{{ route('ecommerce.legal-pages.update', $legalPage) }}" method="POST">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" id="legal-title"
                                ...
                                value="{{ old('title', $legalPage->title) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">URL pública: /legal/<strong id="slug-preview">{{ old('slug', $legalPage->slug) }}</strong></small>
                        ...
                        <div class="mb-0">
                            ...
                            <textarea name="content"
                                ...
                                rows="15">{{ old('content', $legalPage->content) }}</textarea>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-0">
                            ...
                            <textarea name="meta_description"
                                ...
                                rows="3" maxlength="500">{{ old('meta_description', $legalPage->meta_description) }}</textarea>
                        ...
                        <div class="card-body">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="is_published" value="1"
                                    id="is_published" {{ old('is_published', $legalPage->is_published) ? 'checked' : '' }}>
