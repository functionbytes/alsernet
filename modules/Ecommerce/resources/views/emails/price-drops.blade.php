            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr>
                    <td style="vertical-align:top;">
                        ...
                        <p style="margin:0;">
                            <span style="color:#b10100;font-weight:700;font-size:18px;">${{ number_format($product->sale_price, 2) }}</span>
                            <span style="color:#999;text-decoration:line-through;margin-left:8px;">${{ number_format($product->price, 2) }}</span>
                        </p>
                    </td>
                    <td style="vertical-align:top;text-align:right;">
                        <a href="{{ route('shop.product', $product->slug) }}" style="background:#b10100;color:#fff;padding:8px 16px;border-radius:4px;text-decoration:none;font-weight:600;">Ver oferta</a>
                    </td>
                </tr>
            </table>
        </td>
...
<p style="text-align:center;margin-top:24px;">
    <a href="{{ url('/tienda') }}" style="color:#b10100;font-weight:600;">Ver toda la tienda &rarr;</a>
</p>
@endcomponent
