                                ...
                                @foreach($shippings as $shipping)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('ecommerce.shipping.edit', $shipping) }}" class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></a>
                                            <form action="{{ route('ecommerce.shipping.destroy', $shipping) }}" method="POST" class="d-inline" onsubmit="return confirm('Eliminar este metodo?')">
                                                @csrf @method('DELETE')
