                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                @if($customer->avatar)
                                                    <img src="{{ $customer->avatar }}" class="rounded-circle" width="36" height="36" style="object-fit:cover;">
                                                @else
                                                    <div class="bg-light rounded-circle d-flex align-items-center justify-content-center" style="width:36px;height:36px;"><i class="fas fa-user text-muted"></i></div>
                                                @endif
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('ecommerce.customers.edit', $customer) }}" class="btn btn-sm btn-outline-primary"><i class="fas fa-edit"></i></a>
                                            <form action="{{ route('ecommerce.customers.destroy', $customer) }}" method="POST" class="d-inline" onsubmit="return confirm('Eliminar este cliente?')">
                                                @csrf @method('DELETE')
