    ...
    <form action="{{ route('settings.ecommerce.customers.update') }}" method="POST">
        ...
        <div class="card">
            <div class="card-header border-bottom p-3">
                <h5 class="mb-0 fw-bold">Configuración de clientes</h5>
                <small class="text-muted">Configura el registro, login y campos del formulario de cliente</small>
            </div>
            <div class="card-body">
                ...
                <div id="registration-fields-block" class="ps-3 " style="{{ $registrationEnabled ? '' : 'display:none' }}">
                    ...
                    <div id="phone-required-block" class="ps-3 " style="{{ $phoneFieldEnabled ? '' : 'display:none' }}">
                        <div class="mb-3">
                            <div class="form-check">
                ...
                <div id="keep-email-block" class="ps-3  mb-3" style="{{ $loginOption === 'phone' ? '' : 'display:none' }}">
                    <div class="form-check">
