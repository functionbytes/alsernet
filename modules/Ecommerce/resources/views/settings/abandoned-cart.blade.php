...
@section('content')
    ...
    <form action="{{ route('settings.ecommerce.abandoned-cart.update') }}" method="POST">
        ...
        <div class="mb-3">
            <h5 class="fw-bold mb-1">Recuperación de carritos abandonados</h5>
            <div class="text-muted small">Recupera automáticamente las ventas perdidas enviando correos electrónicos dirigidos a clientes que abandonaron sus carritos de compras</div>
        </div>
