...
@section('content')
    ...
    <div class="mb-2 d-flex align-items-start justify-content-between">
        <div>
            <h5 class="fw-bold mb-0">Reglas de envío</h5>
            <div class="text-muted small">Configurar reglas para calcular la tarifa de envío</div>
        </div>
    ...
    <div class="alert alert-info py-2 small mb-3">
        Si desea establecer la tarifa de envío según el código postal, debe habilitar "Habilitar código postal" en Configuración → Pagar y configurar el código postal para la dirección de la tienda.
    </div>

    <div id="zones-container" class="mb-4">
    ...
    ========================================================= --}}
    <div class="mb-2">
        <h5 class="fw-bold mb-0">Configuraciones de envío</h5>
    </div>
    ...
    <form action="{{ route('settings.ecommerce.shipping.update') }}" method="POST">
        ...
        <div class="card mb-4">
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-primary w-100 mb-2">Guardar ajustes</button>
            </div>
        </div>
    </form>
