    ...
    <form action="{{ route('settings.ecommerce.taxes.update') }}" method="POST">
        ...
        <div class="card">
            <div class="card-header border-bottom p-3">
                <h5 class="mb-0 fw-bold">Configuración de impuestos</h5>
                <small class="text-muted">Define la tasa impositiva predeterminada y opciones de cálculo</small>
            </div>
            <div class="card-body">
    ...
    <div class="card mt-3">
        <div class="card-header p-3 border-bottom">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h5 class="mb-0 fw-bold">Lista de impuestos</h5>
                    <small class="text-muted">Tasas impositivas configuradas en el sistema</small>
                </div>
