        ...
        <div class="row g-4 align-items-start">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="default_value" class="form-control @error('default_value') is-invalid @enderror" value="{{ old('default_value') }}">
            ...
            <div class="col-12 col-lg-4">
                <div class="card" style="top: 80px; position: sticky;">
                    ...
                    <div class="card-body">
                        <button type="submit" class="btn btn-primary w-100 mb-2">Guardar atributo</button>
                ...
                <div class="card mt-3">
                    ...
                    <div class="card-body">
                        <select name="type" id="attr_type" class="form-select @error('type') is-invalid @enderror">
                            <option value="text" {{ old('type', 'text') === 'text' ? 'selected' : '' }}>Texto</option>
                            <option value="textarea" {{ old('type') === 'textarea' ? 'selected' : '' }}>Area de texto</option>
                            <option value="select" {{ old('type') === 'select' ? 'selected' : '' }}>Lista de opciones</option>
                            <option value="checkbox" {{ old('type') === 'checkbox' ? 'selected' : '' }}>Casilla</option>
