                ...
                <div class="header-wrap header-space-between">
                    ...
                    <div class="search-style-2">
                        <form action="{{ route('shop.index') }}" method="get">
                            <input type="text" name="q" class="input-search-product" placeholder="Buscar productos..." value="{{ request('q') }}" autocomplete="off">
                        ...
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="{{ route('cart.index') }}">
                                    ...
                                    <span class="pro-count blue">{{ app(\Modules\Ecommerce\Services\CartService::class)->count() }}</span>
                                </a>
                            </div>
                            <div class="header-action-icon-2">
                ...
                <div class="header-wrap header-space-between position-relative main-nav">
                    ...
                    <div class="main-categories-wrap d-none d-lg-block">
                        ...
                        <div class="categories-dropdown-wrap categories-dropdown-active-large default-open open">
                            <ul>
                                @php
                                    $headerCategories = \Modules\Ecommerce\Models\ProductCategory::query()
                                        ->where('parent_id', 0)
                        ...
                        <div class="header-action-2">
                            ...
                            <div class="header-action-icon-2">
                                <a class="mini-cart-icon" href="{{ route('cart.index') }}">
                                    ...
                                    <span class="pro-count white">{{ app(\Modules\Ecommerce\Services\CartService::class)->count() }}</span>
                                </a>
                            </div>
                            <div class="header-action-icon-2">
                                <a href="{{ route('ecommerce.login') }}">
