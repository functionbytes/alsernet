            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-header p-3 border-bottom">
                        <h6 class="mb-0 fw-bold">Informacion de la ubicacion</h6>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name"
                                ...
                                value="{{ old('name', $storeLocator->name) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="address" rows="2"
                                ...
                                required>{{ old('address', $storeLocator->address) }}</textarea>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="phone"
                                    ...
                                    value="{{ old('phone', $storeLocator->phone) }}" required>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="email" name="email"
                                    ...
                                    value="{{ old('email', $storeLocator->email) }}">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="city"
                                    ...
                                    value="{{ old('city', $storeLocator->city) }}">
                        ...
                        <div class="row g-3 mb-0">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="state"
                                    ...
                                    value="{{ old('state', $storeLocator->state) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="country"
                                    ...
                                    value="{{ old('country', $storeLocator->country) }}">
            ...
            <div class="col-lg-4">
                <div class="sticky-top" style="top:80px">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <button type="submit" class="btn btn-primary w-100 mb-2">Actualizar ubicacion</button>
                            <a href="{{ route('ecommerce.store-locators.index') }}" class="btn btn-outline-secondary w-100">Cancelar</a>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" name="is_primary" value="1"
                                    id="is_primary" {{ old('is_primary', $storeLocator->is_primary) ? 'checked' : '' }}>
                            ...
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input" type="checkbox" name="is_shipping_location" value="1"
                                    id="is_shipping_location" {{ old('is_shipping_location', $storeLocator->is_shipping_location) ? 'checked' : '' }}>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <dl class="row mb-0 small">
                                ...
                                <dd class="col-7 mb-2">{{ $storeLocator->created_at->translatedFormat('j M, Y') }}</dd>
                                <dt class="col-5 text-muted fw-normal">Actualizado</dt>
                                <dd class="col-7 mb-0">{{ $storeLocator->updated_at->translatedFormat('j M, Y') }}</dd>
                            </dl>
                        </div>
                    </div>
