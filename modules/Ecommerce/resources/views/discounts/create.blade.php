...
@section('content')
    @include('core::components.card', ['title' => 'Ecommerce - Nuevo descuento'])
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="uso-ilimitado" checked>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" name="min_order_price"
                                    ...
                                    value="{{ old('min_order_price') }}" step="0.01" min="0"
                                    placeholder="0.00">
                            </div>
                        ...
                        <div class="mb-0">
                            ...
                            <textarea name="description" rows="3"
                                ...
                                placeholder="Descripcion interna del descuento...">{{ old('description') }}</textarea>
                        ...
                        <div class="row g-3 align-items-end">
                            <div class="col-md-4">
                                ...
                                <select name="type" id="discount-type"
                                    ...
                                    <option value="fixed" {{ old('type', 'fixed') === 'fixed' ? 'selected' : '' }}>$ Monto fijo</option>
                                    <option value="percentage" {{ old('type') === 'percentage' ? 'selected' : '' }}>% Porcentaje</option>
                                    <option value="free_shipping" {{ old('type') === 'free_shipping' ? 'selected' : '' }}>Envio gratis</option>
                                </select>
            ...
            <div class="col-lg-4">
                <div class="sticky-top" style="top:80px">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <button type="submit" class="btn btn-primary w-100 mb-2">Guardar descuento</button>
                        ...
                        <div class="card-body">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="is_active" value="1"
                                    id="is-active" {{ old('is_active', '1') ? 'checked' : '' }}>
...
(function () {
    ...
    // Restaurar estado si hay old()
    @if(old('quantity'))
        $('#uso-ilimitado').prop('checked', false).trigger('change');
        $('#quantity').val('{{ old('quantity') }}');
    @endif
