...
<div class="row g-3 mb-3">
    <div class="col-md-6">
        ...
        <select class="form-select" id="{{ $prefix }}-encryption" name="encryption">
...
<div class="mb-3">
    ...
    <select class="form-select" id="{{ $prefix }}-module_scope" name="module_scope[]" multiple size="4">
...
<div class="mb-0">
    ...
    <select class="form-select" id="{{ $prefix }}-enabled" name="enabled">
