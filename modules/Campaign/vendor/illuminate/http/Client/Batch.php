...
class Batch
{
     ...
     *
     * @var (Closure($this, int|string, Response): void)|null
     */
     ...
     *
     * @var (Closure($this, int|string, Response|\Illuminate\Http\Client\RequestException|ConnectionException): void)|null
     */
     ...
     *
     * @var (Closure($this, array<int|string, Response>): void)|null
     */
     ...
     *
     * @param  (Closure($this, int|string, Response): void)  $callback
     */
     ...
     *
     * @param  (Closure($this, int|string, Response|\Illuminate\Http\Client\RequestException|ConnectionException): void)  $callback
     */
     ...
     *
     * @param  (Closure($this, array<int|string, Response>): void)  $callback
     */
     ...
     *
     * @return array<int|string, Response|\Illuminate\Http\Client\RequestException>
     */
