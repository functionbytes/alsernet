...
class PendingRequest
{
     ...
     *
     * @var Collection<int, (callable(Response): Response|null)>
     */
     ...
     *
     * @param  (callable(Response): Response|null)  $callback
     * @return $this
     */
     ...
     *
     * @param  array|JsonSerializable|Arrayable  $data
     * @return (TAsync is false ?  Response : PromiseInterface)
     *
     * @throws ConnectionException
     */
     ...
     *
     * @param  (callable(Pool): mixed)  $callback
     * @param  non-negative-int|null  $concurrency
     * @return array<array-key, Response|ConnectionException|\Illuminate\Http\Client\RequestException>
     */
     ...
     *
     * @return (TAsync is false ? Response : LazyPromise)
     *
     * @throws Exception
     * @throws ConnectionException
     */
