...
class Factory
{
     ...
     *
     * @var list<array{0: Request, 1: Response|null}>
     */
    protected $recorded = [];
     ...
     *
     * @param  string  $url
     * @param  Response|PromiseInterface|callable|int|string|array|ResponseSequence  $callback
     * @return $this
     */
     ...
     *
     * @param  callable|(Closure(Request, Response|null): bool)  $callback
     * @return void
     */
     ...
     *
     * @param  list<string|(Closure(Request, Response|null): bool)|callable>  $callbacks
     * @return void
     */
     ...
     *
     * @param  (Closure(Request, Response|null): bool)|callable  $callback
