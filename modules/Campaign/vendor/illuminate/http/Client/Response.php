...
{
    use Concerns\DeterminesStatusCode, Macroable, Tappable {
        __call as macroCall;
    }
     ...
     *
     * @param  callable|(\Closure(Response): mixed)  $callback
     * @return $this
     */
     ...
     *
     * @param  int|(\Closure(int, Response): bool)|callable  $statusCode
     * @return $this
     *
     * @throws RequestException
     */
