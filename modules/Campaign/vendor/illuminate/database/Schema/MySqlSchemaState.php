...
class MySqlSchemaState extends SchemaState
{
    ...
    protected function connectionString()
    {
        ...
        if (isset($config['options'][PHP_VERSION_ID >= 80500 ? Mysql::ATTR_SSL_CA : \PDO::MYSQL_ATTR_SSL_CA])) {
    ...
    protected function baseVariables(array $config)
    {
        ...
        return [
            ...
            'LARAVEL_LOAD_SSL_CA' => $config['options'][PHP_VERSION_ID >= 80500 ? Mysql::ATTR_SSL_CA : \PDO::MYSQL_ATTR_SSL_CA] ?? '', // @phpstan-ignore class.notFound
        ];
    }
