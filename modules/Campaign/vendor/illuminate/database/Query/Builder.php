...
class Builder implements BuilderContract
{
     ...
     *
     * @var array<string|ExpressionContract>|null
     */
    public $columns;
     ...
     *
     * @param  ExpressionContract[]|Closure[]|string[]  $columns
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     * @param  ExpressionContract|DateTimeInterface|string|int|float|null  $value
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  int|string  $id
     * @param  string|ExpressionContract|array<string|ExpressionContract>  $columns
     ...
     *
     * @param  mixed  $id
     * @param  (Closure(): TValue)|string|ExpressionContract|array<string|ExpressionContract>  $columns
