...
@if(!$valid || isset($show_all))
    @include('resources.views.helpers.form_control', [
        ...
        'value' => $queue_driver,
        'options' => \Modules\Campaign\Library\Tool::availableSystemBackgroundMethodSelectOptions(),
...
<div class="database-config-box">
    @if(!$valid || isset($show_all))
        @include('resources.views.helpers.form_control', [
            ...
            'value' => $php_bin_path,
            'options' => \Modules\Campaign\Library\Tool::phpPathsSelectOptions($php_paths),
