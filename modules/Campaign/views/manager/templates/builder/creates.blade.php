    ...
    <div class="page-title">
        <ul class="breadcrumb breadcrumb-caret position-right">
            <li class="breadcrumb-item"><a
                    href="{{ action("Settings\HomeController@index") }}">{{ trans('messages.home') }}</a></li>
            <li class="breadcrumb-item"><a
                    href="{{ action("Settings\TemplateController@index") }}">{{ trans('messages.templates') }}</a></li>
        </ul>
        <h1>
...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            <form action="{{ route('Settings\TemplateController@builderCreate') }}" method="POST"
                    ...
                    <div class="subsection pb-4">
                        ...
                        <div id="gallery-{{ $category->id }}" class="pb-4">
                            <div class="listing-form"
                                 data-url="{{ route('Settings\TemplateController@builderTemplates', [
