<div class="mb-20">
    ...
    @php
        ...
        $data = $trigger->getOption('source_uid') ? Modules\Campaign\Models\Source::findByUid($trigger->getOption('source_uid'))->getData() : null;
        $shopinfo = !$data ? [] : Modules\Campaign\Models\Source::findByUid($trigger->getOption('source_uid'))->getData()['data'];
    @endphp
            ...
            <div class="settings">
                ...
                <div class="d-flex my-2 py-1">
                    @if ($trigger->getOption('list_uid'))
                        @php
                            $list = Modules\Campaign\Models\MailList::findByUid($trigger->getOption('list_uid'));
                        @endphp
                        <div class="check-icon mr-4 pt-1">
                            <span class="material-symbols-rounded text-success">check_circle</span>
                        </div>
