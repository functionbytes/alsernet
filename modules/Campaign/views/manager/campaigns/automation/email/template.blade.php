                ...
                <div class="mr-auto pr-5">
                    ...
                    <div class="media-left">
                        <div class="main">
                            ...
                            @if (in_array(Modules\Campaign\Models\Setting::get('builder'), ['both','pro']) && $email->template->builder)
                            ...
                            @endif
                            @if (in_array(Modules\Campaign\Models\Setting::get('builder'), ['both','classic']))
