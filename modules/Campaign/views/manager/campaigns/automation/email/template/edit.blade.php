...
<html>
  <head>
    ...
    @if (Modules\Campaign\Models\Plugin::isInstalled('acelle/chatgpt') && Modules\Campaign\Models\Plugin::getByName('acelle/chatgpt')->isActive())
        <!-- ChatGPT -->
    ...
    <script>
        ...
        $( document ).ready(function() {
            editor = new Editor({
                ...
                saveMethod: 'POST',
                tags: {!! json_encode(Modules\Campaign\Models\Template::builderTags((isset($list) ? $list : null))) !!},
