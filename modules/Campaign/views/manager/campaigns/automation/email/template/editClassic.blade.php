    ...
    <form id="classic-builder-form" action="{{ route('Automation2Controller@templateEditClassic', [
        ...
        <div class="row mr-0 ml-0">
            ...
            <div class="col-md-3 pr-0 pb-0 sidebar pr-4 pt-4 pl-4" style="overflow:auto;background:#f5f5f5">
                @include('elements._tags', ['tags' => Modules\Campaign\Models\Template::tags($automation->mailList)])
            </div>
        </div>
    <form>
            ...
            editor = tinymce.init({
                ...
                setup: function (editor) {
                    ...
                    editor.ui.registry.addMenuButton('acelletags', {
                        ...
                        @foreach(Modules\Campaign\Models\Template::tags($automation->mailList) as $tag)
                            items.push({
                                type: 'menuitem',
                                text: '{{ $tag["name"] }}',
                                onAction: function (_) {
