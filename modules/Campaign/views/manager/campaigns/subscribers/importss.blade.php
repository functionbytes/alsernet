            ...
            <form id="importForm"action="{{ action('SubscriberController@dispatchImportJob', ['list_uid' => $list->uid]) }}" method="POST" class="ajax_upload_form form-validate-jquery">
                ...
                <div class="alert alert-info">
                    {!! trans('messages.list.import.instruction', [
                        ...
                        'size' => \Modules\Campaign\Library\Tool::maxFileUploadInBytes()
                    ]) !!}
                </div>
                ...
                <div class="upload_file before">
                    ...
                    @if (\Modules\Campaign\Models\Setting::get('import_subscribers_commitment'))
                        <div class="mt-5">
                            @include('helpers.form_control', [
                                ...
                                'value' => 'no',
                                'required' => true,
                                'label' => \Modules\Campaign\Models\Setting::get('import_subscribers_commitment'),
                                'options' => ['no','yes'],
                                'rules' => []
                            ])
                        </div>
