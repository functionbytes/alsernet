...
<html lang="en">
<head>
	<title>@yield('title') - {{ \Modules\Campaign\Models\Setting::get("site_name") }}</title>
...
<body class="navbar-top color-scheme-{{ Auth::user()->customer->getColorScheme() }}">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
								@can("admin_access", Auth::user())
									<a class="dropdown-item d-flex align-items-center" href="{{ action("Settings\HomeController@index") }}">
	...
	@include("layouts._modals")
        ...
        {!! \Modules\Campaign\Models\Setting::get('custom_script') !!}
