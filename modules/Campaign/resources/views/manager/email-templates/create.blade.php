...
@section('page-header')
    <div class="mc-page-header">
        ...
        <div class="mc-page-actions">
            <a href="{{ route('manager.email_templates.index') }}" class="mc-btn mc-btn-secondary mc-btn-sm">
...
@section('content')
    <form id="admin-form-template-create-form" method="POST" action="{{ route('manager.email_templates.store') }}">
        @csrf
        ...
        <div class="mc-card mc-card-flush" style="margin-bottom:var(--space-5);">
            ...
            <div id="admin-form-tpl-gallery"
                 data-gallery-url="{{ route('manager.email_templates.gallery') }}"
        ...
        <div class="mc-form-actions" style="display:flex;justify-content:flex-end;gap:var(--space-3);">
            <a href="{{ route('manager.email_templates.index') }}" class="mc-btn mc-btn-secondary">
    ...
    form.addEventListener('submit', function(e) {
        ...
        .then(function(res) {
            if (res.status === 422 && res.data.errors) {
                ...
                window.location.href = res.data.redirect || '{{ route('manager.email_templates.index') }}';
            } else {
                submitBtn.disabled = false;
            }
        })
