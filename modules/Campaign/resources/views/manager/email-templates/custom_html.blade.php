...
@section('title', trans('campaign::email-templates.custom_html.title') . ' — ' . $systemEmailTemplate->name)
...
@section('page-header')
    <div>
        ...
        <p class="mc-section-desc">
            <a href="{{ route('manager.email_templates.index') }}" class="mc-breadcrumb-link">{{ trans('campaign::email-templates.page.title') }}</a>
            <span class="mc-breadcrumb-sep">/</span>
            {{ $systemEmailTemplate->name }}
            <span class="mc-breadcrumb-sep">/</span>
...
@section('content')
    <form id="html-form" method="POST" action="{{ route('manager.email_templates.custom_html', $systemEmailTemplate->uid) }}" data-mc-spinner style="margin-top:var(--space-4)">
        @csrf
        <div class="mc-card">
            <div class="mc-card-header" style="border-bottom:0;margin-bottom:0;padding-bottom:0">
                <div class="mc-tabs">
                    <a href="{{ route('manager.email_templates.builder', $systemEmailTemplate->uid) }}" class="mc-tab mc-tab-link">
            ...
            <div class="mc-wizard-card-body">
                @include('campaign::refactor.partials._custom_html_editor', [
                    ...
                    'firstSwitchWarning' => $systemEmailTemplate->template?->isUploaded() ? null : [
        ...
        <div class="mc-wizard-footer">
            <a href="{{ route('manager.email_templates.index') }}" class="mc-btn mc-btn-secondary" data-mc-spinner>
