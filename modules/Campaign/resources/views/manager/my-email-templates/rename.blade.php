...
@section('content')
<form id="form-template-rename-form" action="{{ route('manager.my_email_templates.update_name', $item->uid) }}" method="POST">
    @csrf
    ...
    <div class="mc-alert mc-alert-teal" style="margin-bottom:var(--space-5);">
        ...
        <div class="mc-alert-content">
            <div class="mc-alert-text">{{ trans('campaign::email-templates.rename.desc') }}</div>
        </div>
    </div>
