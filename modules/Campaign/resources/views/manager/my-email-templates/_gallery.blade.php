...
@else
    <div class="mc-empty-state" style="padding:var(--space-12) var(--space-6);">
        ...
        <div class="mc-empty-state-title">{{ trans('campaign::email-templates.create.no_templates') }}</div>
        <div class="mc-empty-state-text">
            {{ $tab === 'extended'
                ? trans('campaign::email-templates.empty.gallery_extended')
                : trans('campaign::email-templates.empty.gallery_base') }}
        </div>
    </div>
@endif
