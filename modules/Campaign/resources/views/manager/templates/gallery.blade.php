...
@section('content')
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('manager.templates.index') }}" class="btn btn-outline-secondary">← Plantillas</a>
        </div>
        ...
        <div class="row g-4">
            @foreach ($catalog as $key => $meta)
                <div class="col-md-6 col-lg-4">
                    <form method="post" action="{{ route('manager.templates.builder.from-prebuilt', $key) }}">
                        @csrf
            ...
            <div class="col-md-6 col-lg-4">
                <a href="{{ route('manager.templates.create') }}" class="card h-100 text-decoration-none border-2 border-dashed text-muted" style="border-style:dashed!important;">
