...
@section('content')
    <div class="container py-4" style="max-width:680px">
        ...
        <form method="post" action="{{ route('manager.templates.store') }}">
            @csrf
            ...
            <div class="mb-3">
                ...
                @php
                    $defaultHtml = '<h1>Hola ' . '{{' . 'FIRST_NAME' . '}}' . '</h1><p>Tu contenido aquí…</p>';
                @endphp
                <textarea name="html" rows="10" class="form-control font-monospace">{{ old('html', $defaultHtml) }}</textarea>
            </div>
