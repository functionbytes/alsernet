...
@section('content')
    <div class="container py-4" style="max-width:980px">
        ...
        <p class="text-muted">"{{ $campaign->subject }}" · {{ $campaign->from_name }} <code>&lt;{{ $campaign->from_email }}&gt;</code></p>
        ...
        @if ($campaign->last_error)
            <div class="alert alert-danger"><strong>Último error:</strong> <pre class="mb-0 small">{{ Str::limit($campaign->last_error, 1000) }}</pre></div>
        @endif
    </div>
@endsection
