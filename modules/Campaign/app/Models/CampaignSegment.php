...
use Modules\Campaign\Jobs\UpdateSegmentJob;
...
class CampaignSegment extends Model
{
    ...
    protected $fillable = [
        'uid', 'name', 'matching', 'mail_list_id',
    ];
    ...
    {
        return $this->hasMany(CampaignSegmentCondition::class, 'segment_id')->orderBy('order');
    }
    ...
    {
        dispatch(new UpdateSegmentJob($this));
    }
