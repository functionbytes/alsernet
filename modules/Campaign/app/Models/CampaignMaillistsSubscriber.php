 ...
 * @property-read CampaignMaillist|null $CampaignMaillist
...
class CampaignMaillistsSubscriber extends Model
{
    ...
    protected $table = 'campaign_maillists_subscribers';
    ...
    {
        $query = TrackingLog::where('tracking_logs.subscriber_id', '=', $this->id);
    ...
    {
        $query = OpenLog::leftJoin('tracking_logs', 'tracking_logs.message_id', '=', 'open_logs.message_id')
    ...
    {
        $query = ClickLog::leftJoin('tracking_logs', 'tracking_logs.message_id', '=', 'click_logs.message_id')
            ->where('tracking_logs.subscriber_id', '=', $this->id);
