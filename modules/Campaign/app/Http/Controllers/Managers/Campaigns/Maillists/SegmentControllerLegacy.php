...
use Modules\Campaign\Models\Field;
use Modules\Campaign\Models\Segment;
use Modules\Campaign\Models\SegmentCondition;
...
class SegmentController extends Controller
{
    ...
    {
        // authorize
        if (\Gate::denies('list', Segment::class)) {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->isMethod('patch')) {
            ...
            MailListUpdated::dispatch($segment->mailList);
