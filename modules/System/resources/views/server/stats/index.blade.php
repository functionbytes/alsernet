        ...
        <div class="row g-4 align-items-start">
            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                ...
                                <p class="text-muted mb-0">Información en tiempo real del servidor y recursos del sistema</p>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">IP del Servidor</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">Versión de PHP</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">Límite de Memoria</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">Tiempo de Actividad</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <h6 class="fw-bold text-dark mb-1">Información del sistema</h6>
                        <p class="text-muted mb-3">Detalles del servidor y entorno de ejecución</p>
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label text-muted fw-semibold mb-1">IP del Servidor</label>
                                    <p class="fw-semibold mb-0">{{ $stats['server_ip'] ?? 'N/A' }}</p>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label text-muted fw-semibold mb-1">Nombre del Servidor</label>
                                    <p class="fw-semibold mb-0">{{ $stats['server_name'] ?? 'N/A' }}</p>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label text-muted fw-semibold mb-1">Sistema Operativo</label>
                                    <p class="fw-semibold mb-0">{{ $stats['os'] ?? 'N/A' }}</p>
                                </div>
                                <div class="mb-0">
                                    <label class="form-label text-muted fw-semibold mb-1">Versión de PHP</label>
                                    <p class="fw-semibold mb-0">{{ $stats['php_version'] ?? 'N/A' }}</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label text-muted fw-semibold mb-1">Tiempo de Actividad</label>
                                    <p class="fw-semibold mb-0">{{ $stats['uptime'] ?? 'N/A' }}</p>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label text-muted fw-semibold mb-1">Límite de Memoria</label>
                                    <p class="fw-semibold mb-0">{{ $stats['memory_limit'] ?? 'N/A' }}</p>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label text-muted fw-semibold mb-1">Max Execution Time</label>
                                    <p class="fw-semibold mb-0">{{ $stats['max_execution_time'] ?? 'N/A' }}s</p>
                                </div>
                                <div class="mb-0">
                                    <label class="form-label text-muted fw-semibold mb-1">Max Upload Size</label>
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-3">Uso actual del almacenamiento del servidor</p>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">Espacio Total</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">Espacio Libre</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            <label class="form-label text-muted fw-semibold mb-0">Uso de disco</label>
                            <span class="badge {{ $stats['disk_usage_percent'] > 80 ? 'bg-danger-subtle text-danger' : ($stats['disk_usage_percent'] > 60 ? 'bg-warning-subtle text-warning' : 'bg-success-subtle text-success') }}">
            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <h6 class="fw-bold mb-1">Acciones rápidas</h6>
                        <p class="text-muted mb-3">Accesos directos a las funciones más usadas del servidor</p>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <h6 class="fw-bold mb-1">Configuración PHP</h6>
                        <p class="text-muted mb-3">Parámetros activos del intérprete PHP</p>
                        <div class="mb-3">
                            <label class="form-label text-muted fw-semibold mb-1">Max POST Size</label>
                        ...
                        <div class="mb-3">
                            <label class="form-label text-muted fw-semibold mb-1">Upload Max Filesize</label>
                            <p class="fw-semibold mb-0">{{ $stats['upload_max_filesize'] ?? 'N/A' }}</p>
                        </div>
                        <div class="mb-0">
                            <label class="form-label text-muted fw-semibold mb-1">Memory Limit</label>
                            <p class="fw-semibold mb-0">{{ $stats['memory_limit'] ?? 'N/A' }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="form-label text-muted fw-semibold mb-2">Estado del servidor</label>
                            <div>
