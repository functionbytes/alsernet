            ...
            <form action="{{ route('settings.analytics.notifications.update') }}" method="POST">
                ...
                <div class="card">
                    ...
                    <div class="card-header p-4 border-bottom">
                        <h5 class="mb-1 fw-bold">Notificaciones de analytics</h5>
                        <p class="small mb-0 text-muted">Configura los destinatarios para cada tipo de evento de reportes programados</p>
                    </div>
