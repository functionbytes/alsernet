    ...
    <div class="row g-3">
            ...
            <div class="card">
                <form id="formUsers" enctype="multipart/form-data" role="form" onSubmit="return false">
                    ...
                    <div class="card-header border-bottom p-3">
                        ...
                        <small class="text-muted">Actualiza la información del usuario en el sistema</small>
                    </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('settings.users.show', $user->uid) }}" class="btn btn-light w-100">Cancelar</a>
                    </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <hr class="my-0">
                <div class="card-body">
                    <h6 class="card-title mb-3">Cambio de contraseña</h6>
                    <p class="card-text text-muted mb-0">
                        Deja el campo de contraseña <em>en blanco</em> para mantener la actual sin cambios. Solo complétalo si deseas establecer una nueva clave de acceso.
                    </p>
                </div>
                <hr class="my-0">
                <div class="card-body">
                ...
                <hr class="my-0">
                <div class="card-body">
                    <h6 class="card-title mb-3">Último acceso</h6>
                    <p class="card-text text-muted mb-0">
                        Usuario registrado el <strong>{{ $user->created_at->translatedFormat('d \d\e F Y') }}</strong>.
                        @if($user->updated_at->ne($user->created_at))
                            Última actualización el <strong>{{ $user->updated_at->translatedFormat('d \d\e F Y') }}</strong>.
                        @endif
                    </p>
                </div>
            </div>
