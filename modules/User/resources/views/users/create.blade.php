    ...
    <div class="row g-3">
            ...
            <div class="card">
                <form id="formUsers" enctype="multipart/form-data" role="form" onSubmit="return false">
                    ...
                    <div class="card-header border-bottom p-3">
                        <h5 class="mb-0 fw-bold">Nuevo usuario del sistema</h5>
                        <small class="text-muted">Complete la información para crear un nuevo usuario</small>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-4">Datos básicos del usuario como nombre, identificación y contacto</p>
                        ...
                        <p class="text-muted mb-4">Configuración de autenticación, rol y estado de la cuenta</p>
                        ...
                        <p class="text-muted mb-4">Empresa y zona horaria del usuario</p>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary w-100 mb-1">Guardar usuario</button>
                        <a href="{{ route('settings.users.index') }}" class="btn btn-light w-100">Cancelar</a>
                    </div>
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <hr class="my-0">
                <div class="card-body">
                    <h6 class="card-title mb-3">Contraseña segura</h6>
                    <p class="card-text text-muted mb-0">
                        Usa al menos 8 caracteres combinando letras, números y símbolos. El usuario podrá cambiarla desde su perfil una vez que acceda al sistema.
                    </p>
                </div>
                <hr class="my-0">
                <div class="card-body">
                    ...
                    <p class="card-text text-muted mb-0">
                        Una cuenta <em>Inactiva</em> no puede iniciar sesión aunque las credenciales sean correctas. Úsalo para suspender temporalmente el acceso sin eliminar el usuario.
                    </p>
                </div>
                <hr class="my-0">
                <div class="card-body">
                    <h6 class="card-title mb-3">Verificación de email</h6>
                    <p class="card-text text-muted mb-0">
                        Marca como <em>Verificado</em> si el email ya fue confirmado manualmente. De lo contrario el sistema puede requerir verificación antes de permitir el acceso completo.
                    </p>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $("#formUsers").validate({
        ...
        messages: {
            firstname: { required: "El nombre es obligatorio.", minlength: "Mínimo 2 caracteres.", maxlength: "Máximo 100 caracteres." },
        ...
        submitHandler: function(form) {
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    submitBtn.prop('disabled', false).html('Guardar usuario');
