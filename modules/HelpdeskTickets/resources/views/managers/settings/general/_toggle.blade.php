{{--
    Toggle booleano reutilizable para la configuración general de tickets —
    select en vez de checkbox (convención del proyecto). $field, $label y
    $default (bool) llegan del @include.
--}}
