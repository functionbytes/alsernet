...
@section('content')
    ...
    @if($view->is_system)
        ...
        <script>
            setTimeout(function() {
                window.location.href = '{{ route('manager.helpdesk.settings.ticket-views.index') }}';
            }, 2000);
        </script>
    @else
    ...
    <div class="card w-100">
        ...
        <form id="formView" method="POST" action="{{ route('manager.helpdesk.settings.ticket-views.update', $view->id) }}">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="icon" class="form-control" value="{{ old('icon', $view->icon) }}" placeholder="Ej: fas fa-ticket, fas fa-eye, fas fa-filter">
                            <small class="form-text text-muted">
                                Clase de icono Font Awesome 6. Ver: <a href="https://fontawesome.com/icons" target="_blank">fontawesome.com/icons</a>
                            </small>
                            @error('icon')
                                <span class="field-validation-error"><i class="fa fa-circle-exclamation"></i> {{ $message }}</span>
                            @enderror
