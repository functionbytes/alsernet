...
<div class="htk-page-bar">
    ...
    <div class="right">
        ...
        <button type="button" id="htk-bulk-warm" class="htk-btn htk-btn-outline htk-btn-sm"
                title="Pre-cargar contextos ERP/PS de los clientes visibles">
            <i class="fas fa-bolt"></i> Pre-cargar
        </button>
