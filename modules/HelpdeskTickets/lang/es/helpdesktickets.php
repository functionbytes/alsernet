...
return [
    ...
    'inbox_escalate' => [
        ...
        'close' => 'Cerrar',
        'context' => 'Contexto',
        'context_value' => 'Conversación #:id · :count mensaje|Conversación #:id · :count mensajes',
        'subject' => 'Asunto',
        'subject_placeholder' => 'Ej: Error al iniciar sesión',
        'priority' => 'Prioridad',
        'category' => 'Categoría',
        ...
        'description_hint' => 'Pre-llenada con el chat',
        'description_placeholder' => 'Describe el problema...',
        'attach_transcript' => 'Adjuntar transcripción del chat al ticket',
        'notify_customer' => 'Notificar al cliente con el ID del ticket',
        'submit' => 'Crear ticket',
        'submitting' => 'Creando...',
        'duplicate_one' => 'Esta conversación ya tiene un ticket:',
        'duplicate_many' => 'Esta conversación ya tiene :count tickets:',
        'submit_another' => 'Crear otro ticket',
        'agents_available' => 'Disponibles',
        'agents_unavailable' => 'No disponibles',
        'group' => 'Grupo',
        'group_none' => 'Sin grupo',
        'sla_none' => 'Sin categoría no se aplica ningún SLA',
        'sla_prefix' => 'SLA:',
        'cancel' => 'Cancelar',
        'subject_required' => 'El asunto es obligatorio.',
        'no_conversation' => 'No hay conversación activa.',
