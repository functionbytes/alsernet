...
return [
    ...
    'inbox_escalate' => [
        ...
        'close' => 'Close',
        'context' => 'Context',
        'context_value' => 'Conversation #:id · :count message|Conversation #:id · :count messages',
        'subject' => 'Subject',
        'subject_placeholder' => 'e.g. Cannot sign in',
        'priority' => 'Priority',
        'category' => 'Category',
        ...
        'description' => 'Description',
        'description_hint' => 'Pre-filled from the chat',
        'description_placeholder' => 'Describe the issue...',
        'attach_transcript' => 'Attach the chat transcript to the ticket',
        'notify_customer' => 'Notify the customer with the ticket ID',
        'submit' => 'Create ticket',
        'submitting' => 'Creating...',
        'duplicate_one' => 'This conversation already has a ticket:',
        'duplicate_many' => 'This conversation already has :count tickets:',
        'submit_another' => 'Create another ticket',
        'agents_available' => 'Available',
        'agents_unavailable' => 'Unavailable',
        'group' => 'Group',
        'group_none' => 'No group',
        'sla_none' => 'With no category no SLA is applied',
        'sla_prefix' => 'SLA:',
        'cancel' => 'Cancel',
