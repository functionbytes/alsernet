    ...
    private function definitions(): array
    {
        return [
            [
                ...
                'content' => "Hola {{cliente.nombre}},\n\nGracias por escribirnos. Hemos recibido tu consulta y ya la estamos revisando; te responderemos con una solucion lo antes posible.\n\nUn saludo,\n{{agente.nombre}}",
                'html_body' => '<p>Hola {{cliente.nombre}},</p><p>Gracias por escribirnos. Hemos recibido tu consulta y ya la estamos revisando; te responderemos con una solucion lo antes posible.</p><p>Un saludo,<br>{{agente.nombre}}</p>',
                'is_global' => true,
                'is_active' => true,
                'usage_count' => 342,
            ...
            [
                ...
                'html_body' => '<p>Hola {{cliente.nombre}},</p><p>Para diagnosticar el problema necesitamos reproducirlo en nuestro entorno. &iquest;Podrias indicarnos?</p><ol><li>Navegador y version (o app y version, si es movil)</li><li>Los pasos exactos que sigues hasta ver el error</li><li>Si le ocurre solo a un usuario o a todo el equipo</li></ol><p>Con eso lo replicamos y te contamos.</p><p>Un saludo,<br>{{agente.nombre}}</p>',
                'is_global' => true,
                'is_active' => true,
                'usage_count' => 87,
            ...
            [
                ...
                'html_body' => '<p>Hola {{cliente.nombre}},</p><p>Tu caso requiere revision de nuestro equipo tecnico especializado, asi que lo estamos escalando. Un compa&ntilde;ero se pondra en contacto contigo en las proximas 24-48h con mas detalle.</p><p>Gracias por tu paciencia.</p><p>Un saludo,<br>{{agente.nombre}}</p>',
                'is_global' => true,
                'is_active' => true,
                'usage_count' => 41,
                'ticket_categories' => ['Soporte Técnico'],
            ...
            [
                ...
                'content' => "Hola {{cliente.nombre}},\n\nHemos revisado tu cargo y todo esta correcto: {{ticket.resumen}}\n\nTe adjuntamos la factura actualizada. Si tienes cualquier otra duda con la facturacion, escribenos de nuevo.\n\nUn saludo,\n{{agente.nombre}}",
                'html_body' => '<p>Hola {{cliente.nombre}},</p><p>Hemos revisado tu cargo y todo esta correcto: {{ticket.resumen}}</p><p>Te adjuntamos la factura actualizada. Si tienes cualquier otra duda con la facturacion, escribenos de nuevo.</p><p>Un saludo,<br>{{agente.nombre}}</p>',
                'is_global' => true,
                'is_active' => true,
                'usage_count' => 156,
            ...
            [
                ...
                'html_body' => '<p>Hola {{cliente.nombre}},</p><p>Ya hemos tramitado tu reembolso. El importe puede tardar entre 3 y 7 dias habiles en reflejarse en tu medio de pago original, segun tu banco.</p><p>Si pasado ese plazo no lo ves reflejado, contactanos y lo revisamos.</p><p>Un saludo,<br>{{agente.nombre}}</p>',
                'is_global' => true,
                'is_active' => true,
                'usage_count' => 73,
            ...
            [
                ...
                'html_body' => '<p>Hola {{cliente.nombre}},</p><p>Lamentamos el retraso en tu pedido. Hemos contactado con el transportista y nos confirman una nueva fecha estimada de entrega en las proximas 48-72h.</p><p>Te avisaremos en cuanto tengamos el numero de seguimiento actualizado.</p><p>Un saludo,<br>{{agente.nombre}}</p>',
                'is_global' => true,
                'is_active' => true,
                'usage_count' => 214,
            ...
            [
                ...
                'html_body' => '<p>Hola {{cliente.nombre}},</p><p>Por tratarse de datos sensibles de tu cuenta, antes de continuar necesitamos verificar tu identidad. Te hemos enviado un codigo a tu correo/telefono registrado; indicanoslo en tu proxima respuesta.</p><p>Gracias por tu comprension.</p><p>Un saludo,<br>{{agente.nombre}}</p>',
                'is_global' => true,
                'is_active' => true,
                'usage_count' => 29,
            ...
            [
                ...
                'html_body' => '<p>Hola {{cliente.nombre}},</p><p>Ya hemos restablecido el acceso a tu cuenta. Te recomendamos cambiar la contrase&ntilde;a la proxima vez que inicies sesion y activar la verificacion en dos pasos si aun no la tienes.</p><p>&iquest;Necesitas algo mas?</p><p>Un saludo,<br>{{agente.nombre}}</p>',
                'is_global' => true,
                'is_active' => true,
                'usage_count' => 165,
                'ticket_categories' => ['Gestión de Cuenta'],
            ...
            [
                ...
                'html_body' => '<p>Hola {{cliente.nombre}},</p><p>Sentimos mucho la demora en responder tu consulta; hemos tenido un volumen de solicitudes mayor de lo habitual. Seguimos con tu caso ahora mismo.</p><p>Gracias por tu paciencia.</p><p>Un saludo,<br>{{agente.nombre}}</p>',
                'is_global' => true,
                'is_active' => true,
                'usage_count' => 58,
                'ticket_categories' => [],
            ...
            [
                ...
                'html_body' => '<p>Hola {{cliente.nombre}},</p><p>Damos por resuelta tu consulta. Si en los proximos dias detectas que el problema persiste, puedes responder a este mismo ticket y lo reabrimos sin necesidad de crear uno nuevo.</p><p>Gracias por contactarnos.</p><p>Un saludo,<br>{{agente.nombre}}</p>',
                'is_global' => true,
                'is_active' => true,
                'usage_count' => 421,
                'ticket_categories' => [],
            ...
            [
                ...
                'html_body' => '<p>Hola {{cliente.nombre}},</p><p>Gracias por tu mensaje. Nuestro horario de atencion es de lunes a viernes de 9:00 a 18:00; lo hemos recibido fuera de ese horario y lo atenderemos en cuanto abramos.</p><p>Un saludo,<br>Equipo de Soporte</p>',
                'is_global' => true,
                'is_active' => true,
                'usage_count' => 302,
                'ticket_categories' => [],
