...
(function () {
    ...
    var CFG = window.TicketDetailConfig || {};
        ...
        // Real-time via Laravel Echo. Mismo guard que más abajo (colisión de
        // agentes, $(function(){...})): CFG.broadcastingEnabled solo dice que
        // el backend tiene el broadcaster activo, no que window.Echo ya esté
        // inicializado en esta página — sin esto rompía con
        // "Echo is not defined" en cuanto el bundle de Vite tardaba en cargar.
        if (CFG.broadcastingEnabled && typeof window.Echo !== 'undefined') {
            window.Echo.channel('ticket.' + CFG.ticketId)
