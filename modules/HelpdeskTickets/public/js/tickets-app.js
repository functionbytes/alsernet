        ...
        var rows = people.length
            ? people.map(function (pr) {
                return '<div class="tkt-mailitem"><span class="av">' + escapeHtml(initials(pr.name)) + '</span>' +
                    ...
                    '<span class="tkt-live"><span class="dot"></span>' + (pr.typing ? 'escribiendo' : 'viendo') + '</span></div>';
              }).join('')
