...
class UpdateTicketEmailChannelRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // Vacía = conservar la contraseña ya guardada (ver
            // TicketEmailChannelsRepository::update()); por eso no es 'required'.
