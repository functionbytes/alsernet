...
class TicketsController extends Controller
{
    ...
    public function show(string $ticketNumber): JsonResponse
    {
        ...
        $ticket = Ticket::where('ticket_number', $ticketNumber)
            ->with(['customer:id,name,email', 'status:id,name,color,slug', 'category:id,name,slug', 'assignee:id,name'])
            ->firstOrFail();
    ...
    public function update(UpdateTicketApiRequest $request, string $ticketNumber): JsonResponse
    {
        ...
        $ticket->load(['customer:id,name,email', 'status:id,name,color,slug', 'category:id,name,slug', 'assignee:id,name']);
