...
class RunAutomationsOnTicketClosed implements ShouldQueue
{
    ...
    {
        $this->engine->handle('ticket.closed', $event->ticket);
    }

    public function failed(TicketClosed $event, \Throwable $exception): void
    {
        Log::error('Automation listener failed on ticket.closed', [
