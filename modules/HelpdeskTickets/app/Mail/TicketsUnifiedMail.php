...
/**
 * Aviso al cliente de que varias solicitudes suyas pasan a ser un único ticket.
 *
 * Mismo transporte que TicketCreatedMail (asunto y cuerpo ya renderizados por
 * TicketMailRenderer, buzón del canal y Message-ID propio para que su respuesta
 * enganche con el hilo); lo único distinto es la plantilla que lo alimenta,
 * 'helpdesk_tickets.tickets_unified'.
 */
class TicketsUnifiedMail extends Mailable implements ShouldQueue, TracksEmailLog
{
