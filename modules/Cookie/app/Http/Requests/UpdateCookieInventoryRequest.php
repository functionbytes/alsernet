...
class UpdateCookieInventoryRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('cookie.inventory.update') ?? false;
    }

    public function rules(): array
    {
        return [
            'name' => ['required', 'string', 'max:100', Rule::unique('cookie_inventory', 'name')->ignore($this->route('cookieInventory'))],
