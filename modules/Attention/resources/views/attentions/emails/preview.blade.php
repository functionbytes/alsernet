...
@section('title', 'Preview email - ' . $mail->subject)
                ...
                <div class="card-footer bg-light">
                    <div class="d-flex justify-content-between align-items-center">
                        <small class="text-muted">
                            ...
                            Este es el contenido exacto del email que fue enviado al ciudadano.
                        </small>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12 col-lg-4">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <p class="mb-0">
                                ...
                                @else
                                    <span class="badge bg-warning-subtle text-white">
                                        En cola
                                    </span>
                                @endif
                            </p>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('attention.manage', $attention->uid) }}" class="btn btn-primary">
                            Gestionar solicitud
                        </a>
                    </div>
                </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-12">
                            <h6 class="text-muted fw-semibold small mb-1">RADICADO</h6>
                            <p class="mb-0 fw-bold">
                                <a href="{{ route('attention.manage', $attention->uid) }}" class="text-decoration-none">
                                    {{ $attention->radicado }}
                                </a>
                            </p>
                        </div>
                        <div class="col-12">
                            <h6 class="text-muted fw-semibold small mb-1">CIUDADANO</h6>
                            <p class="mb-0">
                                @if($attention->is_anonymous)
                                    <span class="text-muted fst-italic">Anonimo</span>
                                @else
                                    {{ $attention->customer_firstname }} {{ $attention->customer_lastname }}
                                @endif
                            </p>
                        </div>
                        <div class="col-12">
                            ...
                            <p class="mb-0">
                                ...
                                @endphp
                                <span class="badge bg-{{ $statusBootstrap }}-subtle text-{{ $statusBootstrap }}">
            ...
            <div class="card mb-3">
                <div class="card-header p-3 border-bottom">
                    ...
                    <small class="text-muted">Metadata del envio</small>
                </div>
...
<style>
    ...
    .preview-email-container img {
        max-width: 100%;
        height: auto;
    }

    .preview-email-container table {
        width: 100%;
    }
...
$(document).ready(function() {
    ...
    $('#resendEmailBtn').on('click', function() {
        ...
        $.ajax({
            url: '{{ route('attention.emails.resend', [$attention->uid, $mail->uid]) }}',
            method: 'POST',
            headers: {
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    setTimeout(function() {
                        window.location.href = '{{ route('attention.emails.index', $attention->uid) }}';
                    }, 1500);
                } else {
