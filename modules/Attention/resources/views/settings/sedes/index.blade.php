                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li><a class="dropdown-item text-danger delete-btn" data-bs-toggle="modal" data-bs-target="#delete-modal" data-url="{{ route('settings.attention.sedes.destroy', $sede->id) }}" data-title="Eliminar: {{ $sede->name }}">Eliminar</a></li>
                                                </ul>
                                            </div>
                                        </td>
                                    </tr>
