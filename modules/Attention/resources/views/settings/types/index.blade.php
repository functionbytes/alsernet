                    ...
                    <div class="col-md-4">
                        <div class="card bg-light-secondary h-100">
                            <div class="card-body">
                                ...
                                <small class="text-muted">Tipos inactivos</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="d-flex flex-column flex-lg-row gap-3 align-items-stretch">
                        ...
                        <div class="d-flex gap-2 flex-shrink-0">
                            ...
                            @if(request('search') || request('status'))
                                <a href="{{ route('settings.attention.types.index') }}" class="btn btn-outline-secondary" title="Limpiar filtros">
                            ...
                            <tbody>
                                @foreach($types as $type)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-muted">{{ $type->created_at->format('d/m/Y') }}</span>
                                        </td>
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('settings.attention.types.edit', $type->id) }}">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <form action="{{ route('settings.attention.types.toggle', $type->id) }}" method="POST" class="d-inline">
                                                            @csrf
...
$(document).ready(function () {
    ...
    $('#bulk-apply-btn').on('click', function () {
        ...
        $.ajax({
            url: '{{ route('settings.attention.types.bulk-action') }}',
            method: 'POST',
