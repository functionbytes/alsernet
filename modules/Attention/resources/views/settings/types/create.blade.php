                ...
                <form id="formAttentionType" action="{{ route('settings.attention.types.store') }}" method="POST">
                    ...
                    <div class="card-header border-bottom p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="mb-1 fw-bold">Crear tipo de PQRSF</h5>
                                <p class="mb-0 text-muted small">Complete la información para registrar un nuevo tipo de solicitud.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-footer border-top">
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('settings.attention.types.index') }}" class="btn btn-outline-secondary">Cancelar</a>
                        </div>
                    </div>
                </form>
            </div>
