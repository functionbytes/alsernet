...
(function () {
    ...
    function renderSparklines(data) {
        ...
        const sparks = {
            '#spark-total':      { series: (data.spark_total      || []).map(r => parseInt(r.count || 0)), color: '#90bb13', type: 'area' },
    ...
    function renderStatusDonut(data) {
        ...
        chartStatus = new ApexCharts(el, {
            ...
            colors: ['#90bb13', '#333333', '#7b0000', '#555555', '#c41c1c', '#888888'],
    ...
    function renderCategories(data) {
        ...
        const rows = data.map((cat, i) => {
            ...
            return `<tr>
                ...
                <td class="text-end">
                    <span class="badge rounded-pill" style="background:#fce8e8;color:#90bb13;">${fmt(count)}</span>
                </td>
            </tr>`;
        }).join('');
