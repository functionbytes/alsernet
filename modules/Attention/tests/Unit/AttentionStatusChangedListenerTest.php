...
class AttentionStatusChangedListenerTest extends TestCase
{
    ...
    public function it_sends_notification_to_assigned_user()
    {
        ...
        Notification::assertSentTo($user, AttentionStatusChangedNotification::class);
    }
    ...
    public function it_sends_notification_to_department_users()
    {
        ...
        Notification::assertSentTo($user1, AttentionStatusChangedNotification::class);
        Notification::assertSentTo($user2, AttentionStatusChangedNotification::class);
    }
