            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('settings.menus.create') }}" class="btn btn-primary">Nuevo menú</a>
                    </div>
                </div>
            </div>
                                ...
                                <td class="text-center">
                                    <div class="dropdown dropstart">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3" href="{{ route('settings.menus.edit', $menu) }}">
                            ...
                            <tr>
                                <td colspan="5" class="text-center py-5">
                                    <div class="text-muted">
                                        ...
                                        <a href="{{ route('settings.menus.create') }}" class="btn btn-sm btn-primary mt-2">
