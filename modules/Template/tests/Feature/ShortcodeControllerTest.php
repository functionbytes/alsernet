...
class ShortcodeControllerTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // The shared test DB is seeded with shortcodes; clear them so the
        // exact-count assertions in this class are deterministic. Runs inside
        // the DatabaseTransactions rollback, so the pristine DB is untouched.
        Shortcode::query()->delete();
