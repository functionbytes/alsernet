...
@section('content')
    <div class="card w-100">
        <form id="formLabel" action="{{ route('settings.chat.labels.store') }}" method="POST">
            @csrf
            ...
            <div class="card-body">
                ...
                <p class="card-subtitle mb-3 mt-1">
                    Define una nueva etiqueta para organizar y clasificar conversaciones en el chat.
                </p>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="color" name="color" class="form-control form-control-color @error('color') is-invalid @enderror"
                                   value="{{ old('color', '#13C672') }}" required
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                      rows="3" placeholder="Descripción de la etiqueta">{{ old('description') }}</textarea>
                    ...
                    <div class="col-12">
                        <div class="border-bottom pb-3 mb-3">
                            <div class="form-check form-switch">
                                ...
                                <input type="checkbox" name="show_on_sidebar" class="form-check-input" id="showOnSidebarCheck" value="1" {{ old('show_on_sidebar', true) ? 'checked' : '' }}>
