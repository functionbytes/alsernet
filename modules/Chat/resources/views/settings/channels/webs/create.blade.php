...
@section('content')
    ...
    @include('core::components.card', ['title' => 'Crear widget web'])
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="row g-4 align-items-start">
            ...
            {{-- Columna izquierda --}}
            <div class="col-lg-8">
                <form action="{{ route('settings.chat.channels.webs.store') }}" method="POST" id="web-widget-form">
                    @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted mb-3">Configura el nombre y la URL del sitio web donde se mostrará el widget.</p>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control select2 @error('widget_position') is-invalid @enderror"
                                        ...
                                        <option value="right" {{ old('widget_position', 'right') === 'right' ? 'selected' : '' }}>Derecha</option>
                                        <option value="left" {{ old('widget_position') === 'left' ? 'selected' : '' }}>Izquierda</option>
                                    </select>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('welcome_title') is-invalid @enderror"
                                           id="welcome_title" name="welcome_title" value="{{ old('welcome_title', '¡Hola!') }}"
                                           placeholder="¡Hola!">
                                    @error('welcome_title')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('welcome_tagline') is-invalid @enderror"
                                           id="welcome_tagline" name="welcome_tagline" value="{{ old('welcome_tagline') }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12" id="offline-message-wrapper" style="display: none;">
                                    ...
                                    <textarea class="form-control @error('offline_message') is-invalid @enderror"
                                              ...
                                              placeholder="Actualmente no estamos disponibles. Déjanos un mensaje.">{{ old('offline_message') }}</textarea>
            ...
            <div class="col-lg-4">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <h6 class="fw-bold mb-1">Cómo instalar el widget</h6>
                        <p class="text-muted mb-3">Una vez creado el widget, instálalo en tu sitio web con unas pocas líneas de código.</p>
                        <ol class="text-muted ps-3 mb-0">
                            <li class="mb-1">Crea el widget con los datos de tu sitio</li>
                            <li class="mb-1">Copia el código de instalación generado</li>
                            <li class="mb-1">Pega el código antes de <code>&lt;/body&gt;</code> en tu web</li>
                            <li>El chat aparecerá automáticamente</li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-3">Ten en cuenta estos aspectos antes de crear el canal.</p>
                        <ul class="text-muted ps-3 mb-3">
                            <li class="mb-1">Puedes tener <strong>múltiples widgets</strong> para distintos sitios</li>
                            <li class="mb-1">El color y la posición se pueden cambiar en cualquier momento</li>
                            <li>El código de instalación no cambia al editar el widget</li>
                        </ul>
                        <div class="alert alert-info border-0 mb-0">
                            <small>El código de instalación estará disponible en la página de detalle una vez creado el widget.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header border-bottom">
                        <h6 class="mb-0 fw-bold">Opciones de personalización</h6>
                    </div>
                    <div class="card-body">
                        <code class="d-block mb-2"><strong>Posición:</strong> derecha o izquierda</code>
                        <code class="d-block mb-2"><strong>Color:</strong> cualquier color hexadecimal</code>
                        <code class="d-block"><strong>Formulario previo:</strong> nombre, email, teléfono</code>
                    </div>
                </div>
