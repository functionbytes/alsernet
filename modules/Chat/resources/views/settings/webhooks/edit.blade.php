...
@section('content')
    ...
    <div class="card w-100">
        ...
        <form id="formWebhook" action="{{ route('settings.chat.webhooks.update', $webhook) }}" method="POST">
            ...
            <div class="card-body">
                <div class="d-flex no-block align-items-center">
                    <h5 class="mb-0">Editar webhook: {{ $webhook->name }}</h5>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $webhook->name) }}" required placeholder="Ej: Notificación principal">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="url" name="url" class="form-control @error('url') is-invalid @enderror" value="{{ old('url', $webhook->url) }}" required placeholder="https://example.com/webhook">
                    ...
                    <div class="col-12 col-md-6" id="inbox-field">
                        <div class="mb-3">
                    ...
                    @foreach($events as $value => $label)
                        <div class="col-md-6 col-lg-4">
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" name="subscriptions[]" id="event_{{ $value }}" value="{{ $value }}" {{ in_array($value, $selectedEvents) ? 'checked' : '' }}>
