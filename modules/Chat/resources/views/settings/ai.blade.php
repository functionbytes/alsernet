...
@section('title', 'Configuración de IA - Groups')

@section('content')

    @include('Chat::settings.includes.card', ['title' => 'Configuración de IA del Groups'])

    <div class="widget-content searchable-container list">

        @include('settings.components.alerts')

        <form method="POST" action="{{ route('settings.chat.ai.update') }}" id="aiForm">
            @csrf
            @method('PUT')
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-0">
                        ...
                        <select name="llm_provider" class="form-control select2 select2" required id="providerSelect">
                        ...
                        <small class="text-muted">Modelo de lenguaje que se utilizará para generar respuestas automáticas en el chat</small>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <button class="btn btn-secondary" type="button" onclick="togglePassword(this)">
                    ...
                    <div class="mb-0">
                        ...
                        <select name="openai_model" class="form-control select2">
            ...
            <div class="card" id="anthropicConfig" style="display: none;">
                <div class="card-body">
                    ...
                    <div class="mb-0">
                        <label class="form-label fw-semibold">Modelo</label>
                        <select name="anthropic_model" class="form-control select2">
            ...
            <div class="card" id="geminiConfig" style="display: none;">
                <div class="card-body">
                    ...
                    <div class="mb-0">
                        <label class="form-label fw-semibold">Modelo</label>
                        <select name="gemini_model" class="form-control select2">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="embeddings_provider" class="form-control select2" required>
