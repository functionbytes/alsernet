...
@section('title', 'Configuración de Tickets - Groups')
...
<div class="container-fluid">
    ...
    <form method="POST" action="{{ route('settings.chat.tickets.update') }}" id="ticketsForm">
        @csrf
        @method('PUT')
            ...
            <div class="accordion-item mb-3 border rounded">
                <h2 class="accordion-header">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#customer">
                        ...
                        <span class="badge bg-info-subtle text-info ms-2">7 opciones</span>
                    </button>
                </h2>
