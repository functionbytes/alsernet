    ...
    <div class="row">
        <div class="col-lg-12 d-flex align-items-stretch">
            <div class="card w-100">
                <form id="formEmailTemplate" action="{{ route('settings.chat.email.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="card-header border-bottom p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="mb-0 text-muted small">Complete la información para registrar una nueva plantilla de notificación.</p>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('description') is-invalid @enderror"
                                                          ...
                                                          placeholder="Descripción del propósito de esta plantilla">{{ old('description') }}</textarea>
                                                @error('description')
                                                    <span class="field-validation-error"><i class="fa fa-circle-exclamation"></i> {{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('body_html') is-invalid @enderror"
                                                          name="body_html" rows="15" required>{{ old('body_html') }}</textarea>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('body_text') is-invalid @enderror"
                                                          name="body_text" rows="10">{{ old('body_text') }}</textarea>
