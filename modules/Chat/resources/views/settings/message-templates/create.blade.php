...
@section('title', 'Crear plantilla de mensaje')

@section('content')

    <div class="card w-100">

        <form id="formMessageTemplate" method="POST" action="{{ route('settings.chat.message.store') }}">

            @csrf

            <div class="card-body">
                <div class="d-flex no-block align-items-center">
                    <h5 class="mb-0">Crear plantilla de mensaje</h5>
                </div>
                <p class="card-subtitle mb-3 mt-1">
                    Crea una plantilla de mensaje con variables automáticas para agilizar las respuestas en conversaciones.
                </p>
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="content" id="content"
                                      ...
                                      rows="8" required
                                      placeholder="Ingresa el contenido de tu plantilla aquí. Usa las variables disponibles...">{{ old('content') }}</textarea>
