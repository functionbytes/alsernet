...
@section('title', 'Editar rol de equipo')

@section('content')

    <div class="card w-100">

        <form id="formTeamRole" method="POST" action="{{ route('settings.chat.team-roles.update', $teamRole) }}">
            ...
            <div class="card-body">
                <div class="d-flex no-block align-items-center">
                    <h5 class="mb-0">Editar rol: {{ $teamRole->name }}</h5>
                </div>
                <p class="card-subtitle mb-3 mt-1">
                    Modifica los permisos y configuración del rol de equipo.
                </p>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name', $teamRole->name) }}" required placeholder="Ej: Supervisor">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control" rows="2" placeholder="Descripción opcional del rol">{{ old('description', $teamRole->description) }}</textarea>
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                ...
                                <input type="checkbox" name="is_default" class="form-check-input" id="isDefault" value="1" {{ old('is_default', $teamRole->is_default) ? 'checked' : '' }}>
