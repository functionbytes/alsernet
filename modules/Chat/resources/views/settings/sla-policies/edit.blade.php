...
@section('content')
    ...
    <div class="card w-100">
        ...
        <form id="formSlaPolicy" method="POST" action="{{ route('settings.chat.sla-policies.update', $slaPolicy) }}">
            ...
            <div class="card-body">
                ...
                <p class="card-subtitle mb-3 mt-1">
                    Modifica los tiempos de respuesta y configuración de la política SLA para conversaciones.
                </p>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $slaPolicy->name) }}" required placeholder="Ej: SLA Soporte estándar">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="2" placeholder="Descripción opcional de la política">{{ old('description', $slaPolicy->description) }}</textarea>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="first_response_time_minutes" class="form-control time-input @error('first_response_time_minutes') is-invalid @enderror" value="{{ old('first_response_time_minutes', $slaPolicy->first_response_time_minutes) }}" min="1" placeholder="Ej: 60" data-target="first-calc">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="next_response_time_minutes" class="form-control time-input @error('next_response_time_minutes') is-invalid @enderror" value="{{ old('next_response_time_minutes', $slaPolicy->next_response_time_minutes) }}" min="1" placeholder="Ej: 120" data-target="next-calc">
                            <small class="form-text text-muted">
                    ...
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="number" name="resolution_time_minutes" class="form-control time-input @error('resolution_time_minutes') is-invalid @enderror" value="{{ old('resolution_time_minutes', $slaPolicy->resolution_time_minutes) }}" min="1" placeholder="Ej: 1440" data-target="resolution-calc">
                            <small class="form-text text-muted">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                ...
                                <input type="checkbox" name="business_hours_only" class="form-check-input" id="businessHours" value="1" {{ old('business_hours_only', $slaPolicy->business_hours_only) ? 'checked' : '' }}>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="number" name="priority" class="form-control @error('priority') is-invalid @enderror" value="{{ old('priority', $slaPolicy->priority ?? 0) }}" min="0" placeholder="0">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                ...
                                <input type="checkbox" name="is_active" class="form-check-input" id="isActive" value="1" {{ old('is_active', $slaPolicy->is_active) ? 'checked' : '' }}>
