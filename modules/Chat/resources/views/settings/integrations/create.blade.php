...
@section('content')
    ...
    <div class="card w-100">
        ...
        <form id="formIntegration" method="POST" action="{{ route('settings.chat.integrations.store') }}">

            @csrf

            <div class="card-body">
                <div class="d-flex no-block align-items-center">
                    <h5 class="mb-0">Crear integración</h5>
                </div>
                <p class="card-subtitle mb-3 mt-1">
                    Configura una nueva integración para conectar con aplicaciones externas. Las integraciones permiten el flujo bidireccional de datos entre sistemas.
                </p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="app_id" class="form-control @error('app_id') is-invalid @enderror" value="{{ old('app_id') }}" required placeholder="slack, zapier, webhooks">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="hook_type" class="form-control select2 @error('hook_type') is-invalid @enderror" required>
                                ...
                                <option value="0" {{ old('hook_type') == '0' ? 'selected' : '' }}>Entrante</option>
                                <option value="1" {{ old('hook_type') == '1' ? 'selected' : '' }}>Saliente</option>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="reference_id" class="form-control @error('reference_id') is-invalid @enderror" value="{{ old('reference_id') }}" placeholder="ID externo o canal">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="access_token" class="form-control @error('access_token') is-invalid @enderror" value="{{ old('access_token') }}" placeholder="Token de API o clave">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="settings_json" class="form-control font-monospace @error('settings') is-invalid @enderror" rows="5" placeholder='{"clave": "valor"}'>{{ old('settings_json', '{}') }}</textarea>
