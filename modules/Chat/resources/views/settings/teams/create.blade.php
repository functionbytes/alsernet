...
@section('content')
    ...
    <div class="card w-100">
        ...
        <form id="formTeam" method="POST" action="{{ route('settings.chat.teams.store') }}">
            ...
            <div class="card-body">
                ...
                <p class="card-subtitle mb-3 mt-1">
                    Define un nuevo equipo de trabajo. Los equipos ayudan a organizar y distribuir conversaciones de manera eficiente.
                </p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" required placeholder="Ej: Soporte Técnico">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="3" placeholder="Descripción del equipo">{{ old('description') }}</textarea>
                    ...
                    <div class="col-12 col-md-12">
                        <div class="border-bottom pb-3 mb-3">
                            <div class="form-check form-switch">
                                ...
                                <input type="checkbox" name="allow_auto_assign" class="form-check-input" id="autoAssignCheck" value="1" {{ old('allow_auto_assign', true) ? 'checked' : '' }}>
...
$(document).ready(function() {
    ...
    // Inicializar estados de los usuarios previamente seleccionados (old input)
