...
<div class="container-fluid">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="mb-1 fw-bold">Create new status</h4>
                    <p class="text-muted small mb-0">Define a new status for the conversation workflow</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <form id="statusForm" method="POST" action="{{ route('manager.chat.settings.tickets.statuses.store') }}" novalidate>
            @csrf
                ...
                <div class="row g-4">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name') }}" placeholder="e.g., In progress">
                            @error('name')
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="slug" class="form-control" value="{{ old('slug') }}" placeholder="e.g., in_progress">
                            @error('slug')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control" rows="3" placeholder="Optional description of the status">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback d-block">{{ $message }}</div>
                            @enderror
            ...
            <div class="card-footer bg-light border-top d-flex gap-2">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save me-2"></i>Create status
                </button>
    ...
    $('#statusForm').validate({
        ...
        messages: {
            ...
            slug: {
                ...
                pattern: 'Slug can only contain lowercase letters, numbers and underscores'
            },
            description: {
