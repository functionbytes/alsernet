...
@section('title', __('chat.livechat.title'))

@section('content')

    @include('Chat::settings.includes.card', ['title' => __('chat.livechat.title')])
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card mb-3">
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="mb-1 fw-bold">{{ __('chat.livechat.page_title') }}</h5>
                        <p class="small mb-0 text-muted">{{ __('chat.livechat.page_description') }}</p>
                    </div>
                    <div class="d-flex gap-2 align-items-center">
                        <a href="{{ route('settings.chat.configurations.global') }}" class="btn btn-secondary">
                            <i class="fa fa-arrow-left me-1"></i> {{ __('chat.livechat.buttons.back') }}
                        </a>
                        <button type="submit" form="livechatForm" class="btn btn-primary" id="saveBtn" disabled>
                            <i class="fa fa-check me-1"></i> {{ __('chat.livechat.buttons.save_changes') }}
                        </button>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-3">
            <!-- Main Form (left side) -->
            <div class="col-lg-8">
                <form method="POST" action="{{ route('settings.chat.livechat.update') }}" id="livechatForm">
                    @csrf
                    @method('PUT')
                            ...
                            <ul class="nav nav-pills nav-fill" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active" id="widget-tab" data-bs-toggle="tab" data-bs-target="#widget" type="button" role="tab">
                                        <i class="fa fa-palette me-1"></i> {{ __('chat.livechat.tabs.widget') }}
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="timeouts-tab" data-bs-toggle="tab" data-bs-target="#timeouts" type="button" role="tab">
                                        <i class="fa fa-clock me-1"></i> {{ __('chat.livechat.tabs.timeouts') }}
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="install-tab" data-bs-toggle="tab" data-bs-target="#install" type="button" role="tab">
                                        <i class="fa fa-code me-1"></i> {{ __('chat.livechat.tabs.install') }}
                                    </button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="security-tab" data-bs-toggle="tab" data-bs-target="#security" type="button" role="tab">
                                        <i class="fa fa-shield me-1"></i> {{ __('chat.livechat.tabs.security') }}
                                    </button>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div class="accordion-item mb-2">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#homeScreen">
                                            <i class="fa fa-home me-2 text-primary"></i> {{ __('chat.livechat.sections.home_screen') }}
                                        </button>
                                    </h2>
                                            ...
                                            <div class="border-bottom pb-3 mb-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="showAvatars">
                                                        <strong>{{ __('chat.livechat.fields.show_avatars') }}</strong>
                                                        <small class="d-block text-muted">{{ __('chat.livechat.fields.show_avatars_help') }}</small>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="border-bottom pb-3 mb-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="showHelpCenter">
                                                        <strong>{{ __('chat.livechat.fields.show_help_center') }}</strong>
                                                        <small class="d-block text-muted">{{ __('chat.livechat.fields.show_help_center_help') }}</small>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="border-bottom pb-3 mb-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="hideSuggestedArticles">
                                                        <strong>{{ __('chat.livechat.fields.hide_suggested_articles') }}</strong>
                                                        <small class="d-block text-muted">{{ __('chat.livechat.fields.hide_suggested_articles_help') }}</small>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="border-bottom pb-3 mb-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="showTicketsSection">
                                                        <strong>{{ __('chat.livechat.fields.show_tickets_section') }}</strong>
                                                        <small class="d-block text-muted">{{ __('chat.livechat.fields.show_tickets_section_help') }}</small>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="border-bottom pb-3 mb-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="enableSendMessage">
                                                        <strong><i class="fa fa-envelope me-1"></i> {{ __('chat.livechat.fields.enable_send_message') }}</strong>
                                                        <small class="d-block text-muted">{{ __('chat.livechat.fields.enable_send_message_help') }}</small>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="border-bottom pb-3 mb-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="enableCreateTicket">
                                                        <strong><i class="fa fa-ticket me-1"></i> {{ __('chat.livechat.fields.enable_create_ticket') }}</strong>
                                                        <small class="d-block text-muted">{{ __('chat.livechat.fields.enable_create_ticket_help') }}</small>
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="pb-3">
                                                <div class="form-check form-switch">
                                                    ...
                                                    <label class="form-check-label" for="enableSearchHelp">
                                                        <strong><i class="fa fa-search me-1"></i> {{ __('chat.livechat.fields.enable_search_help') }}</strong>
                                                        <small class="d-block text-muted">{{ __('chat.livechat.fields.enable_search_help_help') }}</small>
                                                    </label>
                                                </div>
                                            </div>
                                ...
                                <div class="accordion-item mb-2">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#chatScreen">
                                            <i class="fa fa-comments me-2 text-info"></i> {{ __('chat.livechat.sections.chat_screen') }}
                                        </button>
                                    </h2>
                                ...
                                <div class="accordion-item mb-2">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#style">
                                            <i class="fa fa-palette me-2 text-warning"></i> {{ __('chat.livechat.sections.style') }}
                                        </button>
                                    </h2>
                                        ...
                                        <div class="accordion-body">
                                            <div class="alert alert-info mb-3">
                                                <small>
                                                    ...
                                                    <strong>{{ __('chat.livechat.fields.secondary_color_note') }}</strong>
                                                </small>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-4">
                                                    <label class="form-label fw-semibold">
                                                        <i class="fa fa-star text-warning me-1"></i> {{ __('chat.livechat.fields.primary_color') }}
                                                    </label>
                                                    ...
                                                    <small class="text-muted">{{ __('chat.livechat.fields.primary_color_help') }}</small>
                                                </div>

                                                <!-- Secondary Color -->
                                                <div class="col-md-6 mb-4">
                                                    <label class="form-label fw-semibold">
                                                        <i class="fa fa-star-half-alt text-info me-1"></i> {{ __('chat.livechat.fields.secondary_color') }}
                                                    </label>
                                                    <div class="input-group">
                                                    ...
                                                    <small class="text-muted d-block">{{ __('chat.livechat.fields.secondary_color_help') }}</small>
                                                    ...
                                                    <div class="border-top pt-3 mt-3">
                                                        <div class="form-check form-switch">
                                                            ...
                                                            <label class="form-check-label" for="showDarkModePreview">
                                                                <strong><i class="fa fa-eye me-1"></i> {{ __('chat.livechat.fields.secondary_color_preview') }}</strong>
                                                                <small class="d-block text-muted">{{ __('chat.livechat.fields.secondary_color_preview_help') }}</small>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div id="darkModePreviewBox" class="mt-3 p-3 rounded" style="background-color: #1f2937; color: {{ $settings['secondary_color'] }}; border: 2px solid {{ $settings['primary_color'] }}; {{ !($settings['show_dark_mode_preview'] ?? true) ? 'display: none;' : '' }}">
                                                        <small class="d-block text-center"><strong>{{ __('chat.livechat.sections.chat_screen') }}</strong></small>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- Header Title -->
                                            <div class="mb-0">
                                                <label class="form-label fw-semibold">{{ __('chat.livechat.fields.header_title') }}</label>
                                                <input type="text" name="header_title" class="form-control"
                                                       value="{{ $settings['header_title'] }}" maxlength="100" required>
                                                <small class="text-muted">{{ __('chat.livechat.fields.header_title_help') }}</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="alert alert-info border-start border-4 border-info" role="alert">
                                        ...
                                        <strong>Configuración avanzada:</strong> Si tu chat está en un dominio diferente al del script loader, puedes especificarlo manualmente:
                                    </div>
                ...
                <div class="card sticky-top" style="top: 20px;">
                    <div class="card-header p-4 border-bottom">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                <select id="previewMode" class="form-control select2 form-select-sm" style="width: auto;">
