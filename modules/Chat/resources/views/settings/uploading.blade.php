...
@section('title', 'Configuración de Subida de Archivos - Groups')

@section('content')

    @include('Chat::settings.includes.card', ['title' => 'Configuración de Subida de Archivos'])
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card w-100">
            ...
            <form id="uploadingForm" method="POST" action="{{ route('settings.chat.uploading.update') }}">
                @csrf
                @method('PUT')
