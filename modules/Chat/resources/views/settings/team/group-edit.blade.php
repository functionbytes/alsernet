...
@section('content')
    ...
    <div class="card w-100">
        ...
        <form id="groupForm" method="POST"
              action="{{ route('manager.chat.settings.tickets.team.group.update', $group->id) }}">
            ...
            <div class="card-body">
                ...
                <p class="card-subtitle mb-3 mt-1">
                    Modifica la configuración de este grupo. Los cambios afectarán cómo se asignan las conversaciones a
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ old('name', $group->name) }}"
                                   required placeholder="Ej: Soporte Técnico, Ventas, Atención al Cliente">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <select name="assignment_mode" class="form-control select2 select2" required>
                            ...
                            <small class="form-text text-muted">Define cómo se asignan automáticamente las
                                conversaciones nuevas</small>
                    ...
                    <div class="col-12">
                        <div class="alert alert-info mb-3">
                            ...
                            <div class="mb-2">
                                ...
                                <small class="d-block text-muted">Distribución rotativa equitativa entre miembros del
                                    grupo</small>
                            </div>
                            <div class="mb-2">
                                <strong>Balanceo de Carga:</strong>
                                <small class="d-block text-muted">Asigna conversaciones al agente con menos carga
                                    activa</small>
                            </div>
                            <div class="mb-0">
                                <strong>Manual:</strong>
                                <small class="d-block text-muted">Sin asignación automática, requiere asignación manual
                                    por un supervisor</small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                ...
                                <p class="text-muted small mb-0">Selecciona los agentes que formarán parte de este
                                    equipo</p>
                            </div>
                                        ...
                                        <tr class="member-row">
                                            <td>
                                                <input type="checkbox" class="form-check-input member-checkbox"
                                                       ...
                                                       {{ $isMember ? 'checked' : '' }}
                                                       style="cursor: pointer;">
                                                <input type="hidden" name="members[{{ $index }}][priority]"
                                                       value="{{ $priority }}" class="priority-input">
                                            </td>
                                            <td>
                                                <label for="agent_{{ $agent->id }}" style="cursor: pointer;"
                                                       class="mb-0">
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="rounded-circle d-flex align-items-center justify-content-center"
                                                             style="width: 36px; height: 36px; background-color: #f5f6f8; color: #081A28; font-weight: 600; font-size: 0.85rem;">
                                                            {{ strtoupper(group-edit.blade.phpsubstr($agent->firstname, 0, 1) . substr($agent->lastname, 0, 1)) }}
                                                        </div>
                                            ...
                                            <td class="priority-cell" style="{{ $isMember ? '' : 'display: none;' }}">
                                                <select class="form-control select2 form-select-sm priority-select select2-priority">
                    ...
                    <div class="col-12">
                        <div class="border-bottom pb-3 mb-3">
                            <div class="form-check form-switch">
                                ...
                                <input type="checkbox" name="default" class="form-check-input" id="defaultCheck"
                                       value="1" {{ old('default', $group->default) ? 'checked' : '' }}>
                                <label class="form-check-label" for="defaultCheck">
                                    <strong>Grupo por defecto</strong>
                                    <small class="d-block text-muted">Las conversaciones nuevas sin grupo específico
                                        serán asignadas automáticamente a este grupo</small>
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('manager.chat.settings.tickets.team.groups') }}"
                   class="btn btn-light px-4 waves-effect waves-light mt-2 w-100">
                    Cancelar
                </a>
            </div>
