...
@section('content')
    ...
    <div class="card w-100">
        ...
        <form id="groupForm" method="POST" action="{{ route('manager.chat.settings.tickets.team.group.store') }}">
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('manager.chat.settings.tickets.team.groups') }}" class="btn btn-secondary px-4 waves-effect waves-light mt-2 w-100">
                    Cancelar
                </a>
            </div>
