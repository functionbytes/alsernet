...
@section('content')
    ...
    @include('Chat::settings.includes.card', ['title' => 'Miembros del equipo'])
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card">
            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="small mb-0 text-muted">Gestiona el equipo de soporte, roles y configuraciones de
                            disponibilidad</p>
                    </div>
                    <div class="d-flex gap-2">
                        ...
                        @endif
                        <a href="{{ route('manager.chat.settings.tickets.team.groups') }}" class="btn btn-primary">
                            Ver grupos
                        </a>
                    </div>
                </div>
                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        <div class="text-center p-2 rounded bg-white">
                                            <h6 class="mb-0 fw-bold text-info">{{ $stats['chats'] }}</h6>
            ...
            <!-- Filters -->
            <div class="card-body border-bottom">
                <form method="GET" action="{{ route('manager.chat.settings.tickets.team.members') }}"
                      id="filterForm">
                    <div class="row g-3">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="role" class="form-control select2 select2">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="group_id" class="form-control select2 select2">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="rounded-circle d-flex align-items-center justify-content-center"
                                                ...
                                                {{ strtoupper(members.blade.phpsubstr($member->firstname, 0, 1) . substr($member->lastname, 0, 1)) }}
                                            </div>
                                            <div>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item"
                                                       href="{{ route('manager.chat.settings.tickets.team.member.edit', $member->id) }}">
                                                        Editar
                                                    </a>
                                                </li>
                                            </ul>
                ...
                <div class="card-footer bg-white border-top">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="text-muted small">
                            Mostrando <strong>{{ $members->firstItem() }}</strong> a
