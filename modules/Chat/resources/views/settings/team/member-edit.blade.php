...
@section('content')
    ...
    @include('Chat::settings.includes.card', ['title' => 'Editar Miembro del Equipo'])
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card w-100">
            ...
            <form id="formMember" method="POST" action="{{ route('manager.chat.settings.tickets.team.member.update', $member->id) }}">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center gap-3">
                            <div class="rounded-circle d-flex align-items-center justify-content-center"
                                 style="width: 48px; height: 48px; background-color: #f5f6f8; color: #081A28; font-weight: 600; font-size: 1rem;">
                ...
                <div class="card-body border-bottom">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <select name="role" class="form-control select2 select2 @error('role') is-invalid @enderror" id="role">
                ...
                <div class="card-body border-bottom">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-6">
                            ...
                            <select name="accepts_conversations" class="form-control select2 select2 @error('accepts_conversations') is-invalid @enderror" id="availabilitySelect">
                                                ...
                                                <div class="priority-toggle" style="{{ !$isMember ? 'display: none;' : '' }}">
                                                    <div class="btn-group priority-selector" role="group">
                                                        ...
                                                        <input type="radio" class="btn-check priority-radio"
                                                               ...
                                                               autocomplete="off">
                                                        <label class="btn btn-secondary priority-btn" for="backup_group_{{ $group->id }}">
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted mb-0 small">
                                Primero debes <a href="{{ route('manager.chat.settings.tickets.team.group.create') }}" class="text-decoration-underline">crear un grupo</a>
                            </p>
                        </div>
                    @endif
                </div>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('manager.chat.settings.tickets.team.members') }}" class="btn btn-light w-100">
