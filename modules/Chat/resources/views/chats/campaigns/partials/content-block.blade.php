    ...
    <div class="d-flex align-items-start gap-2">
        ...
        <div class="flex-grow-1">
            <div class="mb-2">
                ...
                <select class="form-control select2 form-select-sm block-type"
                ...
                @elseif($blockType === 'heading')
                    <div class="row g-2">
                        ...
                        <div class="col-4">
                            ...
                            <select class="form-control select2 form-select-sm" name="content[{{ $blockIndex }}][level]">
                ...
                @elseif($blockType === 'button')
                    <div class="row g-2">
                        ...
                        <div class="col-12">
                            ...
                            <select class="form-control select2 form-select-sm" name="content[{{ $blockIndex }}][style]">
