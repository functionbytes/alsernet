    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card" style="border-radius: 12px; border: 1px solid #e0e0e0; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);">
            ...
            <div class="card-header-custom">
                ...
                <div class="d-flex gap-2">
                    @if(request()->hasAny(['search', 'status', 'type']))
                        <a href="{{ route('manager.chats.campaigns.index') }}" class="btn btn-secondary btn-sm">
                            <i class="fas fa-times me-1"></i> Limpiar filtros
                        </a>
                    @endif
                    @can('create', Modules\Chat\Models\Campaigns\Campaign::class)
                        <a href="{{ route('manager.chats.campaigns.create') }}" class="btn-primary-custom">
            ...
            <div class="card-body" style="background: #f8f9fa;">
                <form method="GET" action="{{ route('manager.chats.campaigns.index') }}">
                    <div class="row align-items-end g-2">
                        ...
                        <div class="col-md-2">
                            <select name="status" class="form-control select2" style="border-color: #e0e0e0;">
                        ...
                        <div class="col-md-2">
                            <div class="btn-group w-100" role="group">
                                ...
                                <label class="btn btn-secondary" for="view-grid">
                                    <i class="fas fa-th"></i>
                                </label>

                                <input type="radio" class="btn-check" name="view" id="view-list" value="list">
                                <label class="btn btn-secondary" for="view-list">
                            ...
                            <div class="col-md-4 mb-4">
                                <div class="card h-100 campaign-card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-start mb-2">
                                            <h5 class="card-title mb-0">
                                                <a href="{{ route('manager.chats.campaigns.edit', $campaign) }}" class="text-dark text-decoration-none">
                                    ...
                                    <div class="card-footer bg-white border-top">
                                        <div class="d-flex gap-2">
                                            @can('update', $campaign)
                                                <a href="{{ route('manager.chats.campaigns.edit', $campaign) }}" class="btn btn-sm btn-primary flex-fill">
                                                    <i class="fas fa-edit"></i> Editar
                                                </a>
                                            @endcan

                                            <a href="{{ route('manager.chats.campaigns.show', $campaign) }}" class="btn btn-sm btn-light flex-fill">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    @if($campaign->status === 'draft')
                                                        <li>
                                                            <form method="POST" action="{{ route('manager.chats.campaigns.publish', $campaign) }}" class="d-inline">
                                                                @csrf
                                                    ...
                                                    @elseif($campaign->status === 'active')
                                                        <li>
                                                            <form method="POST" action="{{ route('manager.chats.campaigns.pause', $campaign) }}" class="d-inline">
                                                                @csrf
                                                                <button type="submit" class="dropdown-item">
                                                    ...
                                                    @elseif($campaign->status === 'paused')
                                                        <li>
                                                            <form method="POST" action="{{ route('manager.chats.campaigns.resume', $campaign) }}" class="d-inline">
                                                                @csrf
                                                                <button type="submit" class="dropdown-item">
                                                    ...
                                                    <li>
                                                        <form method="POST" action="{{ route('manager.chats.campaigns.duplicate', $campaign) }}" class="d-inline">
                                                            @csrf
                                                            <button type="submit" class="dropdown-item">
                                                    ...
                                                    @can('delete', $campaign)
                                                        <li>
                                                            <form method="POST" action="{{ route('manager.chats.campaigns.destroy', $campaign) }}" class="d-inline">
                                                                @csrf
                                                                @method('DELETE')
                ...
                @else
                    <div class="text-center py-5">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            @if(!request()->hasAny(['search', 'status', 'type']))
                                @can('create', Modules\Chat\Models\Campaigns\Campaign::class)
                                    <a href="{{ route('manager.chats.campaigns.create') }}" class="btn btn-sm btn-primary">
