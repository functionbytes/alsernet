...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('manager.chats.campaigns.store') }}">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <select name="type" class="form-control select2 @error('type') is-invalid @enderror" required>
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('manager.chats.campaigns.index') }}" class="btn btn-secondary">
