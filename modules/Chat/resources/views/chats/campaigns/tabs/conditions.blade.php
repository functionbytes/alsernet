...
<form method="POST" action="{{ route('manager.chats.campaigns.update', $campaign) }}" id="conditions-form">
    @csrf
    @method('PUT')
    ...
    <div class="mb-4">
        ...
        <div id="conditions-container" class="mb-3">
            @foreach($conditions as $index => $condition)
                @include('settings.views.chats.campaigns.partials.condition-block', [
                    'condition' => $condition,
                    'index' => $index
                ])
            @endforeach
    ...
    <div class="d-flex justify-content-between border-top pt-3">
        <a href="{{ route('manager.chats.campaigns.edit', ['campaign' => $campaign, 'tab' => 'appearance']) }}" class="btn btn-light">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('manager.chats.campaigns.show', $campaign) }}" class="btn btn-success">
        ...
        <div class="card-body p-3">
            <div class="row g-2 align-items-end">
                <div class="col-md-4">
                    ...
                    <select class="form-control select2 form-select-sm condition-field" name="conditions[][field]" onchange="updateConditionOperators(this)">
                ...
                <div class="col-md-3">
                    ...
                    <select class="form-control select2 form-select-sm condition-operator" name="conditions[][operator]">
