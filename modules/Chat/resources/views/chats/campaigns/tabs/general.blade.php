{{-- General Campaigns Settings Tab --}}
<form method="POST" action="{{ route('manager.chats.campaigns.update', $campaign) }}" id="general-form">
    @csrf
    @method('PUT')
    ...
    <div class="d-flex justify-content-between border-top pt-3 mt-4">
        <a href="{{ route('manager.chats.campaigns.index') }}" class="btn btn-light">
