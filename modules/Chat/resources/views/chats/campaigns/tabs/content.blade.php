{{-- Content Editor Tab --}}
<form method="POST" action="{{ route('manager.chats.campaigns.update', $campaign) }}" id="content-form">
    @csrf
    @method('PUT')
    ...
    <div class="mb-4">
        ...
        <div id="content-blocks-container" class="mb-3">
            @foreach($content as $index => $block)
                @include('settings.views.chats.campaigns.partials.content-block', [
                    'block' => $block,
                    'index' => $index
                ])
            @endforeach
    ...
    <div class="d-flex justify-content-between border-top pt-3">
        <a href="{{ route('manager.chats.campaigns.edit', ['campaign' => $campaign, 'tab' => 'general']) }}" class="btn btn-light">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('manager.chats.campaigns.edit', ['campaign' => $campaign, 'tab' => 'appearance']) }}" class="btn btn-success">
        ...
        <div class="d-flex align-items-start gap-2">
            ...
            <div class="flex-grow-1">
                <div class="mb-2">
                    ...
                    <select class="form-control select2 form-select-sm block-type" name="content[][type]" onchange="updateBlockFields(this)">
            ...
            html = `
                <div class="row g-2">
                    ...
                    <div class="col-4">
                        ...
                        <select class="form-control select2 form-select-sm" name="content[${index}][level]">
            ...
            html = `
                <div class="row g-2">
                    ...
                    <div class="col-12">
                        ...
                        <select class="form-control select2 form-select-sm" name="content[${index}][style]">
