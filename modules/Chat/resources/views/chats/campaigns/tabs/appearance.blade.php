...
<form method="POST" action="{{ route('manager.chats.campaigns.update', $campaign) }}" id="appearance-form">
    @csrf
    @method('PUT')
    ...
    @php
        ...
        $primaryColor = $appearance['primary_color'] ?? '#081A28';
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select name="appearance[font_size]" class="form-control select2">
                ...
                <div class="col-md-6">
                    ...
                    <select name="appearance[font_family]" class="form-control select2">
        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <select name="appearance[position]" class="form-control select2" id="position-select">
    ...
    <div class="d-flex justify-content-between border-top pt-3">
        <a href="{{ route('manager.chats.campaigns.edit', ['campaign' => $campaign, 'tab' => 'content']) }}" class="btn btn-light">
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('manager.chats.campaigns.edit', ['campaign' => $campaign, 'tab' => 'conditions']) }}" class="btn btn-success">
