...
@section('title', 'Clientes - Groups')

@section('content')

    @include('core::components.card', ['title' => 'Clientes del Groups', 'icon' => 'fa-user-friends'])
        ...
        <div class="card">
            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        @if(request('search'))
                            <a href="{{ route('chat.customers.index', ['tab' => request('tab', 'all')]) }}"
                               class="btn btn-light">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown">
                                <i class="fa fa-tools me-1"></i> Herramientas
                            </button>
                            <ul class="dropdown-menu dropdown-menu-end">
                                <li>
                                    <a class="dropdown-item" href="{{ route('chat.customers.merge.index') }}">
                                        <i class="fa fa-users me-1"></i> Combinar duplicados
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('chat.customers.import') }}">
                                        <i class="fa fa-file-import me-1"></i> Importar clientes
                                    </a>
                                </li>
                                <li>
                                    <a class="dropdown-item" href="{{ route('chat.customers.export') }}">
                                        <i class="fa fa-file-export me-1"></i> Exportar clientes
                                    </a>
                                </li>
                            </ul>
                        </div>
                        <a href="{{ route('chat.customers.create') }}" class="btn btn-primary">
                ...
                <ul class="nav nav-pills gap-2 mb-0" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ !request('tab') || request('tab') === 'all' ? 'active' : '' }}"
                           href="{{ route('chat.customers.index', array_merge(request()->except('tab'), ['tab' => 'all'])) }}">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ request('tab') === 'active' ? 'active' : '' }}"
                           href="{{ route('chat.customers.index', array_merge(request()->except('tab'), ['tab' => 'active'])) }}">
            ...
            <div class="card-body">
                <div class="mb-3 d-flex justify-content-between align-items-center">
                    ...
                    <div class="col-md-4">
                        <form method="GET" action="{{ route('chat.customers.index') }}">
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <h6 class="mb-0 fw-semibold">
                                                <a href="{{ route('chat.customers.show', $customer->id) }}" class="text-dark text-decoration-none">
                                                    {{ $customer->name }}
                                                </a>
                                            </h6>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            @if(!$customer->is_banned)
                                                ...
                                                <li>
                                                    <form method="POST" action="{{ route('chat.customers.ban', $customer->id) }}">
                                                        @csrf
                                            ...
                                            @else
                                                <li><hr class="dropdown-divider"></li>
                                                <li>
                                                    <form method="POST" action="{{ route('chat.customers.unban', $customer->id) }}">
                                                        @csrf
...
@push('scripts')
<!-- Customer Search AJAX Dropdown -->
<script src="{{ asset('chat-module/js/chat/ui/customer-search.js') }}"></script>
