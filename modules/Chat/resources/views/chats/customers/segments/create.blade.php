...
@section('title', 'Crear Segmento de Clientes')

@section('content')

    @include('core::components.card', ['title' => 'Crear Segmento'])

    <div class="widget-content searchable-container list">

        @include('core::components.alerts')

        <form id="segmentForm" method="POST" action="{{ route('chat.customers.segments.store') }}">
            @csrf
            ...
            <div class="card">
                ...
                <div class="card-header p-4 border-bottom border-light">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="mb-1 fw-bold">Crear nuevo segmento</h5>
                            <p class="small mb-0 text-muted">Define criterios para agrupar clientes automáticamente</p>
                        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea id="description"
                                      ...
                                      rows="3"
                                      placeholder="Describe el propósito de este segmento...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @else
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="criteria" id="criteriaInput" value="{{ old('criteria', '[]') }}">
                    @error('criteria')
                    ...
                    <div class="alert alert-secondary">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span id="previewCount" class="badge bg-primary ms-2">0</span>
                            </div>
                ...
                <div class="card-footer bg-light">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-1"></i> Crear segmento
                        </button>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    // Load existing filters if editing
    try {
