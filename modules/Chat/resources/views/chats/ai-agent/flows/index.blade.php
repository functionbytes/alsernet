            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <form method="GET" class="row g-2">
                        ...
                        <div class="col-auto">
                            <select name="status" class="form-control select2 form-select-sm">
                        ...
                        <div class="col-auto">
                            <select name="trigger" class="form-control select2 form-select-sm">
                        ...
                        <div class="col-auto">
                            ...
                            <a href="{{ route('manager.chats.ai-agent.flows.index') }}" class="btn btn-sm btn-outline-secondary">
                ...
                <div class="col-md-6 text-end">
                    <a href="{{ route('manager.chats.ai-agent.flows.create') }}" class="btn btn-primary">
        ...
        <div class="table-responsive">
                    ...
                    <tbody>
                        @foreach ($flows as $flow)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('manager.chats.ai-agent.flows.edit', $flow) }}" class="btn btn-sm btn-light-primary me-1" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>

                                    @if ($flow->status === 'draft')
                                        <form action="{{ route('manager.chats.ai-agent.flows.publish', $flow) }}" method="POST" style="display: inline">
                                            @csrf
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a class="dropdown-item" href="{{ route('manager.chats.ai-agent.flows.duplicate', $flow) }}">
                                                    <i class="fas fa-copy"></i> Duplicar
                                                </a>
                                            </li>
                                            @if ($flow->status !== 'archived')
                                                <li>
                                                    <form action="{{ route('manager.chats.ai-agent.flows.archive', $flow) }}" method="POST" style="display: inline">
                                                        @csrf
                                            ...
                                            <li>
                                                <form action="{{ route('manager.chats.ai-agent.flows.destroy', $flow) }}" method="POST"
            ...
            @else
                <div class="text-center py-5">
                    ...
                    <a href="{{ route('manager.chats.ai-agent.flows.create') }}" class="btn btn-primary">
                        <i class="fas fa-plus"></i> Crear flujo
                    </a>
                </div>
            @endif
        </div>
