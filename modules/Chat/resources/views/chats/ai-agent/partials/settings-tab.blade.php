<div class="row">
    <!-- Main Settings Form -->
    <div class="col-lg-8">
        <form method="POST" action="{{ route('manager.chats.ai.settings.update') }}" id="settingsForm">
            @csrf
            @method('PUT')
            ...
            <div class="card mb-3">
                <div class="card-header bg-light-info">
                    <h5 class="mb-0"><i class="fas fa-comment me-2"></i>Personalidad</h5>
                </div>
                <div class="card-body">
            ...
            <div class="card mb-3">
                <div class="card-header bg-light-success">
                    <h5 class="mb-0"><i class="fas fa-microchip me-2"></i>Proveedor LLM</h5>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <label class="form-label fw-semibold">Proveedor <span class="text-danger">*</span></label>
                        <select name="provider" id="provider" class="form-control select2 @error('provider') is-invalid @enderror" required>
            ...
            <div class="card mb-3">
                <div class="card-header bg-light-warning">
                    <h5 class="mb-0"><i class="fas fa-sliders-h me-2"></i>Parámetros avanzados</h5>
                </div>
                <div class="card-body">
                    <div class="row">
            ...
            <div class="d-grid gap-2">
                <button type="submit" class="btn btn-primary btn-lg">
                    <i class="fas fa-check me-2"></i>Guardar Configuración
                </button>
            </div>
        </form>
    </div>
    ...
    <div class="col-lg-4">
        ...
        <div class="card mb-3">
            <div class="card-header bg-light-secondary">
                <h5 class="mb-0"><i class="fas fa-chart-pie me-2"></i>Estado del agente</h5>
            </div>
            <div class="card-body">
                @if ($hasAgent ?? false)
                    <div class="text-center">
                        <div class="mb-3">
                            <span class="badge bg-{{ $agent->status === 'active' ? 'success' : 'secondary' }} p-3" style="font-size: 16px">
                                <i class="fas fa-robot me-1"></i>{{ $agent->status_label }}
                            </span>
                        </div>
                        ...
                        @if ($agent->enabled_at)
                            <div class="alert alert-info py-2">
                                <small><i class="fas fa-calendar me-1"></i>Activado: {{ $agent->enabled_at->format('d/m/Y H:i') }}</small>
                            </div>
                        @endif
                    </div>
                @else
        ...
        <div class="card">
            <div class="card-header bg-light-info">
                <h5 class="mb-0"><i class="fas fa-question-circle me-2"></i>Ayuda rápida</h5>
            </div>
            <div class="card-body">
                <h6 class="mb-2">¿Cómo obtener API Keys?</h6>
                <ul class="small mb-3">
                    <li><a href="https://platform.openai.com/api-keys" target="_blank" class="text-decoration-none">OpenAI <i class="fas fa-external-link-alt"></i></a></li>
                    <li><a href="https://console.anthropic.com/" target="_blank" class="text-decoration-none">Anthropic <i class="fas fa-external-link-alt"></i></a></li>
                    <li><a href="https://aistudio.google.com/" target="_blank" class="text-decoration-none">Google Gemini <i class="fas fa-external-link-alt"></i></a></li>
                    <li><a href="https://ollama.ai/" target="_blank" class="text-decoration-none">Ollama (Local) <i class="fas fa-external-link-alt"></i></a></li>
                </ul>
...
document.getElementById('testConnection')?.addEventListener('click', function(e) {
    ...
    fetch('{{ route("manager.chats.ai.settings.test") }}', {
        method: 'POST',
        headers: {
