    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-3"><i class="fas fa-robot me-2"></i>Configuración del Agente IA</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('manager.dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('manager.chats.conversation.index') }}">Helpdesk</a></li>
                ...
                <div class="col-3">
                    <div class="text-center mb-n5">
                        <img src="{{ asset('chats/images/breadcrumb/ChatBc.png') }}" alt="" class="img-fluid mb-n4" style="max-height: 150px;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-pills user-profile-tab justify-content-start mt-2 bg-light-info rounded-2" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6" data-bs-toggle="tab" href="#tab-tags" role="tab" aria-selected="false">
                        <i class="fas fa-tags me-2 fs-6"></i>
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6" data-bs-toggle="tab" href="#tab-tools" role="tab" aria-selected="false">
                        <i class="fas fa-tools me-2 fs-6"></i>
                        <span class="d-none d-md-block">Herramientas</span>
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6" data-bs-toggle="tab" href="#tab-knowledge" role="tab" aria-selected="false">
                        <i class="fas fa-brain me-2 fs-6"></i>
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6" data-bs-toggle="tab" href="#tab-flows" role="tab" aria-selected="false">
                        <i class="fas fa-code-branch me-2 fs-6"></i>
                        <span class="d-none d-md-block">Flujos</span>
            ...
            <div class="tab-content mt-4" id="aiAgentTabContent">
                ...
                <div class="tab-pane fade show active" id="tab-settings" role="tabpanel">
                    @include('settings.views.chats.ai-agent.partials.settings-tab', ['agent' => $agent, 'providers' => $providers, 'statuses' => $statuses])
                </div>
...
<!-- Modals -->
@include('settings.views.chats.ai-agent.modals.tag-modal')
@include('settings.views.chats.ai-agent.modals.tool-modal')
@include('settings.views.chats.ai-agent.modals.knowledge-modal')
...
$(document).ready(function() {
    ...
    function loadTabContent(tabName) {
        ...
        switch(tabName) {
            case 'tags':
                url = '{{ route("manager.chats.ai.tags.index") }}';
                break;
            case 'tools':
                url = '{{ route("manager.chats.ai.tools.index") }}';
                break;
            case 'knowledge':
                url = '{{ route("manager.chats.ai.knowledge.index") }}';
                break;
            case 'flows':
                url = '{{ route("manager.chats.ai.flows.index") }}';
                break;
        }
