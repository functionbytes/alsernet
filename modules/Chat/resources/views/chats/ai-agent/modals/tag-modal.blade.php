        ...
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="tagModalLabel">
                    <i class="fas fa-tag me-2"></i><span id="tagModalTitle">Nuevo tag</span>
                </h5>
            ...
            <form id="tagForm">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="color" class="form-control form-control-color" id="tag_color" name="color" value="#081A28">
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-semibold">Icono (Font Awesome)</label>
                            <div class="input-group">
                                <span class="input-group-text"><i class="fas fa-icons" id="tag_icon_preview"></i></span>
                                <input type="text" class="form-control" id="tag_icon" name="icon" placeholder="fas fa-star">
                            </div>
                            <small class="text-muted">Ej: fas fa-star, fas fa-flag, fas fa-exclamation-circle</small>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="saveTagBtn">
                        <i class="fas fa-check me-2"></i>Guardar tag
                    </button>
                </div>
            </form>
        </div>
