        ...
        <div class="modal-content">
            <div class="modal-header bg-warning text-dark">
                <h5 class="modal-title" id="knowledgeModalLabel">
                    <i class="fas fa-book me-2"></i><span id="knowledgeModalTitle">Nuevo documento</span>
                </h5>
            ...
            <form id="knowledgeForm">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-control select2" id="knowledge_type" name="type" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control select2" id="knowledge_source_type" name="source_type">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-info" id="generateEmbeddingBtn">
                        <i class="fas fa-project-diagram me-2"></i>Generar embedding
                    </button>
                    <button type="submit" class="btn btn-warning" id="saveKnowledgeBtn">
                        <i class="fas fa-check me-2"></i>Guardar documento
                    </button>
                </div>
            </form>
        </div>
