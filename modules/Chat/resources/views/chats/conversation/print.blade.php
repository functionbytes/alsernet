...
<body>
    <a href="{{ route('chat.conversations.show', $conversation) }}" class="back-button no-print">← Volver</a>
    ...
    <div class="container">
        ...
        <div class="info-grid avoid-break">
            @include('Chat::chats.conversation.partials.conversation-info', compact('conversation'))
        </div>
