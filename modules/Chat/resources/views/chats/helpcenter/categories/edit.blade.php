            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <select class="form-control select2" id="visible_to_role" name="visible_to_role">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <select class="form-control select2" id="managed_by_role" name="managed_by_role">
              ...
              <div class="col-12">
                <div class="border-top pt-1 mt-4">
                  <a href="{{ route('manager.chats.helpcenter.categories') }}"
    ...
    $(document).ready(function () {
      ...
      $("#formCategory").validate({
        ...
        submitHandler: function (form, event) {
          ...
          $.ajax({
            type: 'POST',
            url: "{{ route('manager.chats.helpcenter.categories.update') }}",
            data: $(form).serialize(),
            dataType: 'json',
