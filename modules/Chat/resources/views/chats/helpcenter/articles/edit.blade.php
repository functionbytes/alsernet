            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <select class="form-control select2 select2" id="section_id" name="section_id">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <select class="form-control select2 select2-tags" id="tags" name="tags[]" multiple>
              ...
              <div class="col-12">
                <div class="border-top pt-1 mt-4">
                  <a href="{{ route('manager.chats.helpcenter.articles') }}"
    ...
    $(document).ready(function () {
      ...
      $("#formArticle").validate({
        ...
        submitHandler: function (form, event) {
          ...
          $.ajax({
            type: 'POST',
            url: "{{ route('manager.chats.helpcenter.articles.update') }}",
            data: formData,
            processData: false,
            contentType: false,
            dataType: 'json',
