...
@section('content')
  ...
  @include('Chat::settings.includes.card', ['title' => 'Centro de Ayuda - Artículos'])
        ...
        <div class="col-md-12 col-xl-12">
          <form class="position-relative form-search" action="{{ request()->fullUrl() }}" method="GET">
            <div class="row justify-content-between g-2">
              ...
              <div class="col-auto">
                <select class="form-control select2" name="draft" onchange="this.form.submit()">
              ...
              <div class="col-auto">
                <a href="{{ route('manager.chats.helpcenter.articles.create') }}" class="btn btn-primary">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton{{ $article->id }}">
                      <li>
                        <a class="dropdown-item d-flex align-items-center gap-3"
                           href="{{ route('manager.chats.helpcenter.articles.edit', $article->id) }}">
                          <i class="fa-duotone fa-edit"></i> Editar
                        </a>
                      </li>
                      <li>
                        <button type="button" class="dropdown-item d-flex align-items-center gap-3"
                           onclick="deleteItem('{{ route('manager.chats.helpcenter.articles.destroy', $article->id) }}')">
