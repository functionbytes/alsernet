...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <!-- Date Range Filter -->
        <form method="GET" action="{{ route('settings.chat.reports.analytics.index') }}" class="d-flex gap-2">
...
$(document).ready(function() {
    ...
    $('#export-btn').on('click', function() {
        ...
        $.ajax({
            url: '{{ route("settings.reports.analytics.export") }}',
            method: 'GET',
            data: {
            ...
            error: function(xhr) {
                const message = xhr.responseJSON?.message || 'Error al exportar los datos';
