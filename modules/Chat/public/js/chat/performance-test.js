...
(function() {
    ...
    function runAll() {
        console.clear();
        console.log('%c=== Chat Performance Test Suite ===', 'font-size:16px;font-weight:bold;color:#b10100');
    ...
    console.log('%c[ChatPerformanceTest] Loaded successfully', 'color:#b10100;font-weight:bold');
