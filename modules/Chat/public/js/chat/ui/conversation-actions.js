(function ($) {
    ...
    function executeMacro() {
        ...
        $.ajax({
            url:    (window.ChatConfig && window.ChatConfig.baseUrl || '/helpdesk/conversations') + '/' + convId + '/macros/' + macroId + '/execute',
            method: 'POST',
            data:   { _token: csrfToken },
            success: function () {
    ...
    function initSidebarSelects() {
        ...
        $('select[name="status"]').select2({
            ...
            updateConversation(
                (window.ChatConfig && window.ChatConfig.baseUrl || '/helpdesk/conversations') + '/' + convId + '/status',
                { status: $(this).val() },
        ...
        $('select[name="team_id"]').select2({
            ...
            updateConversation(
                (window.ChatConfig && window.ChatConfig.baseUrl || '/helpdesk/conversations') + '/' + convId + '/team',
                { team_id: $(this).val() || '' },
        ...
        $('select[name="assignee_id"]').select2({
            ...
            updateConversation(
                (window.ChatConfig && window.ChatConfig.baseUrl || '/helpdesk/conversations') + '/' + convId + '/assign',
        ...
        $('select[name="priority"]').select2({
            ...
            updateConversation(
                (window.ChatConfig && window.ChatConfig.baseUrl || '/helpdesk/conversations') + '/' + convId + '/priority',
                { priority: $(this).val() },
        ...
        $('select[name="labels[]"]').select2({
            ...
            updateConversation(
                (window.ChatConfig && window.ChatConfig.baseUrl || '/helpdesk/conversations') + '/' + convId + '/labels',
                { labels: $(this).val() || [] },
