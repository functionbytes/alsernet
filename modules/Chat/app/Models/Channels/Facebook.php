...
{
    protected $table = 'chat_channel_facebooks';
    ...
    {
        $baseUrl = env('WEBHOOK_URL', config('app.url'));

        return $baseUrl.'/api/chat/webhooks/facebook';
    }
    ...
    {
        return url('/chats/channels/facebook-pages/callback');
    }
}
