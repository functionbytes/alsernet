...
use Modules\Chat\Database\Factories\CampaignFactory;
...
class Campaign extends Model
{
    ...
    /**
     * Campaigns impressions (page views/interactions)
     */
    ...
    /**
     * Campaigns templates (reusable content blocks)
     */
    ...
    public function getAppearanceCssAttribute()
    {
        ...
        $primaryColor = $this->appearance['primary_color'] ?? '#081A28';
    ...
    /**
     * Get device statistics for the campaign
     */
    ...
    /**
     * Get country statistics for the campaign
     */
    public function getCountryStatistics(int $limit = 10)
    {
        return $this->impressions()
    ...
    /**
     * Get daily impressions trend
     */
    public function getDailyImpressionsTrend(int $days = 30)
    {
        return $this->impressions()
     ...
     */
    public function getDailyClicksTrend(int $days = 30)
    {
        return $this->impressions()
            ->whereNotNull('clicked_at')
    ...
    /**
     * Get average time to click in seconds
     */
    public function getAverageTimeToClick(): ?float
    {
        $avg = $this->impressions()
            ->clicked()
            ->get()
            ->avg(fn ($impression) => $impression->time_to_click);
