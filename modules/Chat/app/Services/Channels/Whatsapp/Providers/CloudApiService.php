...
class CloudApiService
{
     ...
     */
    public function sendMediaMessage(string $accessToken, string $phoneNumberId, string $to, string $mediaUrl, string $mediaType, ?string $caption = null): array
    {
        $typeMap = [
            'image' => 'image',
            'video' => 'video',
        ...
        if ($response->failed()) {
            throw new \Exception('Failed to send WhatsApp media message: '.$response->body());
        }
