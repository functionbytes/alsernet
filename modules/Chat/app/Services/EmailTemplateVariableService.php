...
class EmailTemplateVariableService
{
    ...
    protected static function replaceConversationVariables(string $template, Conversation $conversation): string
    {
        $replacements = [
            ...
            '{{conversation_url}}' => route('chat.conversations.show', $conversation),
            ...
            '{{contact_name}}' => $conversation->customer->name ?? '',
            '{{contact_email}}' => $conversation->customer->email ?? '',
            '{{contact_phone}}' => $conversation->customer->phone_number ?? '',
     ...
     */
    protected static function replaceContactVariables(string $template, Customer $contact): string
    {
        $replacements = [
