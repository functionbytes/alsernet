...
class MessageTemplateController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('Chat::settings.message-templates.index', compact('templates', 'categories'));
    }
    ...
    public function create(): View
    {
        ...
        return view('Chat::settings.message-templates.create', compact('categories', 'availableVariables'));
    }
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'shortcut' => 'nullable|string|max:50|unique:chat_message_templates,shortcut,NULL,id,account_id,'.auth()->user()->account_id,
        ...
        return redirect()
            ->route('settings.chat.message.index')
    ...
    public function show(MessageTemplate $messageTemplate): View
    {
        ...
        return view('Chat::settings.message-templates.show', compact('template', 'usedVariables', 'categories'));
    }
    ...
    public function edit(MessageTemplate $messageTemplate): View
    {
        ...
        return view('Chat::settings.message-templates.edit', compact('template', 'categories', 'availableVariables'));
    }
    ...
    public function update(Request $request, MessageTemplate $messageTemplate)
    {
        ...
        $validated = $request->validate([
            'name' => 'required|string|max:255',
            'content' => 'required|string',
            'shortcut' => 'nullable|string|max:50|unique:chat_message_templates,shortcut,'.$messageTemplate->id.',id,account_id,'.auth()->user()->account_id,
            'category' => 'nullable|string|max:100',
            'is_public' => 'boolean',
        ]);
    ...
    public function search(Request $request): JsonResponse
    {
        ...
        return response()->json($templates->map(fn ($t) => [
            ...
            'name' => $t->name,
            'content' => $t->content,
            'short_code' => $t->shortcut,
            'shortcut' => $t->shortcut,
            'category' => $t->category,
            'visibility' => $t->is_public ? 'everyone' : 'personal',
