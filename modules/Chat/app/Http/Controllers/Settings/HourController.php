...
use Modules\Chat\Services\HourService;
...
class HourController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $businessHours = InboxHour::forAccount($accountId)
            ->whereNull('inbox_id')
            ->orderBy('day_of_week')
            ->get()
            ->groupBy('day_of_week');
        ...
        $daysOfWeek = InboxHour::$daysOfWeek;

        return view('Chat::settings.hours.index', compact('businessHours', 'daysOfWeek'));
    }
    ...
    public function update(Request $request)
    {
        $validated = $request->validate([
            ...
            'business_hours.*.id' => 'required|exists:chat_hours,id',
        ...
        foreach ($validated['business_hours'] as $hourData) {
            $businessHour = InboxHour::find($hourData['id']);
    ...
    public function reset(Request $request)
    {
        ...
        InboxHour::forAccount($accountId)->whereNull('inbox_id')->delete();
