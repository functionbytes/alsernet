...
use Modules\Chat\Services\Sms\SmsService;
...
class SmsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Chat::settings.channels.sms.index', compact('smsChannels'));
    }
    ...
    {
        return view('Chat::settings.channels.sms.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()
                ->route('settings.chat.channels.sms.index')
    ...
    public function show(Sms $sms)
    {
        ...
        return view('Chat::settings.channels.sms.show', compact('sms', 'webhookUrl'));
    }
    ...
    {
        return view('Chat::settings.channels.sms.edit', compact('sms'));
    }
