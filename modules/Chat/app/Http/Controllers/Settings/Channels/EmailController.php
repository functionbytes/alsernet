...
class EmailController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Chat::settings.channels.emails.index', compact('emails'));
    }
    ...
    {
        return view('Chat::settings.channels.emails.create');
    }
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'email' => 'required|email|unique:chat_channel_emails,email',
        ...
        return redirect()->route('settings.chat.channels.emails.index')
    ...
    public function show(Email $email)
    {
        ...
        return view('Chat::settings.channels.emails.show', compact('email'));
    }
    ...
    {
        return view('Chat::settings.channels.emails.edit', compact('email'));
    }
    ...
    {
        $validated = $request->validate([
            'email' => 'required|email|unique:chat_channel_emails,email,'.$email->id,
            'provider' => 'nullable|in:google,microsoft,zoho,custom',
