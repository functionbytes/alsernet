...
class BulkAddLabelRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'label_ids.required' => 'Debe seleccionar al menos una etiqueta.',
            'label_ids.array' => 'Los IDs de etiqueta deben ser un arreglo.',
            'label_ids.min' => 'Debe seleccionar al menos una etiqueta.',
