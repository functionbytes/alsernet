...
<style>
    ...
    .visitor-card { padding: .75rem 1rem; border-left: 3px solid #90bb13; background: #f5f6f8; margin-bottom: .5rem; border-radius: 0 8px 8px 0; }
</style>
@endpush
...
$(function() {
    ...
    if (typeof Echo !== 'undefined') {
        Echo.channel('engagement.visitors')
            .listen('.visitor.activity', (e) => {
                refresh();
            });
    }
    @endif
