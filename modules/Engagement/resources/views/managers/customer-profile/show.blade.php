...
<style>
    ...
    .seg-cold { color: #6c757d } .seg-warm { color: #ffa500 } .seg-hot { color: #b10100 }
    .event-row { padding: .5rem .75rem; border-left: 3px solid #b10100; background: #fafafa; margin-bottom: .25rem; border-radius: 0 6px 6px 0; }
</style>
@endpush
