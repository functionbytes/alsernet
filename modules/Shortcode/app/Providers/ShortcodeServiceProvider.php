...
class ShortcodeServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton('shortcode', function ($app) {
            return new \Modules\Shortcode\Compiler\ShortcodeCompiler;
        });
    }
        ...
        $shortcode->register('image', function ($attrs, $content) {
            ...
            try {
                if (class_exists('\Modules\Media\Models\Media')) {
                    $media = \Modules\Media\Models\Media::find($id);
                    if ($media) {
    ...
    {
        $this->commands([
            \Modules\Shortcode\Console\ShortcodeListCommand::class,
            \Modules\Shortcode\Console\ShortcodeClearCommand::class,
            \Modules\Shortcode\Console\ShortcodeCompileCommand::class,
        ]);
    }
