...
/**
 * Auditoría de cambios sobre la configuración de un AlsernetForm (helpdesk_forms).
 ...
 *
 * form_id es nullOnDelete (no cascade): si se elimina el AlsernetForm, su historial
...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::connection($this->connection)->create('helpdesk_form_changes', function (Blueprint $table) {
            ...
            $table->string('form_key'); // denormalizado a propósito: sigue siendo legible si el AlsernetForm se borra
