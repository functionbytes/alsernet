...
class UpdateFormRequest extends FormRequest
{
    ...
    /**
     * ConvertEmptyStringsToNull deja en null cualquier select que llegue vacío.
     * `success_animation`, `progress_bar_style` y los `button_*` son columnas
     * NOT NULL con valor por defecto: un null ahí no es "usa el default", es un
     * error 500 de MySQL. Se rellenan antes de validar.
     */
