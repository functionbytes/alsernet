...
@section('content')
    ...
    <div class="row g-3">
                            ...
                            <tbody class="border-top">
                                @forelse ($topForms as $i => $item)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <span class="badge rounded-pill" style="background:#fce8e8;color:#90bb13;">
        ...
        <div class="col-lg-4">
            @php
                $statusItems = [
                    ['key' => 'new',       'label' => 'Nuevas',      'sub' => 'Sin revisar',       'icon' => 'fas fa-inbox',        'bg' => '#fce8e8', 'txt' => '#90bb13', 'color' => '#90bb13'],
...
(function () {
    ...
    const sparks = [
        { id: 'spark-total', color: '#90bb13', type: 'area' },
