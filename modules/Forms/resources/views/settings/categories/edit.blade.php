...
@section('content')
    ...
    <div class="row g-3">
        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                <form action="{{ route('settings.forms.categories.update', $category) }}" method="POST" id="categoryForm">
                    @csrf
                    @method('PATCH')
                    <div class="card-header border-bottom p-3">
                        <h5 class="mb-0 fw-bold">Editar categoría</h5>
                        <small class="text-muted">Actualice la información de la categoría.</small>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="color" id="color" name="color"
                                       ...
                                       value="{{ old('color', $category->color ?? '#F5B754') }}">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    @if($category->forms_count > 0)
                        <div class="alert alert-warning mt-3 mb-0 py-2 small">
                            ...
                            Esta categoría no puede eliminarse mientras tenga formularios asignados.
                        </div>
                    @endif
                </div>
                <hr class="my-0">
                <div class="card-body">
                    ...
                    <p class="card-text text-muted mb-0">
                        El slug es el identificador único en URL. Modificarlo puede romper enlaces existentes.
                    </p>
                </div>
                <hr class="my-0">
                <div class="card-body">
