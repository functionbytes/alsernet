<script src="{{ url('others/filemanager/js/jquery-ui-1.12.1/jquery-ui.min.js') }}" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/lib/codemirror.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/mode/css/css.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/mode/javascript/javascript.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/mode/xml/xml.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/mode/htmlmixed/htmlmixed.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/addon/fold/xml-fold.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/js-beautify@1.14.9/js/lib/beautify-html.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/addon/edit/closebrackets.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/addon/edit/matchbrackets.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/addon/fold/foldcode.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/addon/fold/foldgutter.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/addon/fold/brace-fold.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/addon/display/fullscreen.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/addon/search/searchcursor.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/addon/search/search.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/addon/dialog/dialog.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/addon/selection/active-line.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/codemirror@5.65.2/addon/comment/comment.min.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/js-beautify@1.14.9/js/lib/beautify-css.js" data-pagespeed-no-defer></script>
<script src="https://cdn.jsdelivr.net/npm/js-beautify@1.14.9/js/lib/beautify.js" data-pagespeed-no-defer></script>
<script>
    ...
    $('#saveField').on('click', function () {
        ...
        const payload = {
            ...
            exclude_from_helpdesk:parseInt($('#fieldExcludeHelpdesk').val()) || 0,
    ...
    function populateFieldModal(field) {
        ...
        $('#fieldExcludeHelpdesk').val(field.exclude_from_helpdesk ? '1' : '0');
    ...
    $(document).on('click', '#btnAutoTranslate', function () {
        ...
        $.ajax({
            url: urls.fieldEditBase + '/' + fieldId + '/translate',
            method: 'POST',
