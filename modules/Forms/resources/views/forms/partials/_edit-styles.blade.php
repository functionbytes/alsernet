<style>
    ...
    .field-type-tile:hover { background: var(--bs-primary-bg-subtle); border-color: var(--bs-primary); color: var(--bs-primary); }
    ...
    .formula-chip code { font-size: .7rem; color: var(--bs-primary); }
    ...
    .nav-tabs-modal .nav-link:hover { color: var(--bs-primary); border-bottom-color: var(--bs-primary-border-subtle); }
    ...
    /* Step header rows */
    .step-header-row td { background: var(--bs-primary-bg-subtle); padding: .3rem .75rem; font-size: .78rem; font-weight: 600; color: var(--bs-primary); border-top: 2px solid var(--bs-primary-border-subtle); letter-spacing: .02em; }
    .step-badge { display: inline-flex; align-items: center; justify-content: center; width: 18px; height: 18px; border-radius: 50%; background: var(--bs-primary); color: #fff; font-size: .7rem; font-weight: 700; margin-right: .35rem; }
    ...
    .field-sort-placeholder td { background: var(--bs-primary-bg-subtle) !important; }
    ...
    /* Acento por estado: solo los campos requeridos se marcan */
    .field-item.field-required td:first-child { border-left-color: var(--bs-primary); }
    ...
    .field-type-icon-required { background: var(--bs-primary); color: #fff; }

    .field-required-badge { background: #dceed3; color: var(--bs-primary); }
    ...
    .field-actions-btn:hover { background: #f1f3f5; color: #212529; }
