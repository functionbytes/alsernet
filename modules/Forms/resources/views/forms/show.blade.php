        ...
        <div class="row g-4 align-items-start">
            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    {{-- Publicación --}}
                    <div class="card-body">
                        <h6 class="fw-bold text-dark mb-1">Publicación</h6>
                        {{-- No hay CMS que interprete shortcodes [form ...] en este
                             proyecto: lo que publica el formulario es su URL propia
                             o el iframe de /forms/embed/{slug}. --}}
                        <p class="text-muted mb-3">Comparte el formulario con su enlace propio o incrústalo en otra web.</p>

                        <div class="row g-3">
                            <div class="col-md-12">
                                <label class="form-label fw-semibold text-muted">Enlace público</label>
                                <div class="input-group">
                                    <input type="text" class="form-control font-monospace"
                                           value="{{ route('forms.public.show', $form->slug) }}" readonly>
                            ...
                            <div class="col-md-12">
                                <label class="form-label fw-semibold text-muted">Código de inserción (iframe)</label>
                                <div class="input-group">
                                    <input type="text" class="form-control font-monospace"
                                           value='<iframe src="{{ route('forms.public.embed', $form->slug) }}" width="100%" height="600" frameborder="0"></iframe>' readonly>
                                    <button type="button" class="btn btn-info btn-copy-shortcode"
