        ...
        <tr>
            <td align="center" style="padding:40px 16px;">
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0"
                    ...
                    <!-- Header -->
                    <tr>
                        <td style="background-color:#F5B754;padding:32px 40px;text-align:center;">
                    ...
                    <tr>
                        <td style="padding:40px;">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto;">
                                <tr>
                                    <td style="border-radius:6px;background-color:#F5B754;">
                                        <a href="{{ $restoreUrl }}"
                            ...
                            <p style="margin:32px 0 0;color:#888888;font-size:13px;line-height:1.6;">
                                ...
                                <a href="{{ $restoreUrl }}" style="color:#F5B754;word-break:break-all;">{{ $restoreUrl }}</a>
                            </p>
                        </td>
                    </tr>
