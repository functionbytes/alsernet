        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                    ...
                    {{-- Header --}}
                    <tr>
                        <td style="background-color:#F5B754;padding:24px 32px;">
                    ...
                    <tr>
                        <td style="padding:0 32px 32px;" align="center">
                            <a href="{{ route('settings.forms.submissions.show', ['form' => $form->id, 'submission' => $submission->id]) }}"
                               style="display:inline-block;background-color:#F5B754;color:#ffffff;text-decoration:none;padding:12px 28px;border-radius:6px;font-size:14px;font-weight:bold;">
                                Ver en el panel
                            </a>
                        </td>
                    </tr>
