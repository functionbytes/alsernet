...
use Modules\Forms\Http\Controllers\FormPublicationController;
...
Route::middleware(['web', 'auth'])->group(function () {
    ...
    Route::prefix('panel/settings/forms')
        ...
        ->group(function () {
            ...
            // Publicación en la tienda (PrestaShop). Publicar es lo único que
            // hace llegar un cambio al sitio: guardar en el editor no lo toca.
            Route::prefix('/{form}/publication')->name('publication.')->group(function () {
                Route::get('/available-keys', [FormPublicationController::class, 'availableKeys'])->name('available-keys');
                Route::post('/link', [FormPublicationController::class, 'link'])->name('link');
                Route::post('/publish', [FormPublicationController::class, 'publish'])->name('publish');
                Route::post('/republish', [FormPublicationController::class, 'republish'])->name('republish');
                Route::post('/unpublish', [FormPublicationController::class, 'unpublish'])->name('unpublish');
                Route::post('/override', [FormPublicationController::class, 'override'])->name('override');
            });
