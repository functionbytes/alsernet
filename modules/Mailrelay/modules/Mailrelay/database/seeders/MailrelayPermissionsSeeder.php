...
class MailrelayPermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $permissions = [
            ...
            // Mail Providers (Multi-provider system)
            'mailrelay.providers.view' => 'Ver proveedores de email',
            'mailrelay.providers.create' => 'Crear proveedores de email',
            'mailrelay.providers.edit' => 'Editar proveedores de email',
            'mailrelay.providers.delete' => 'Eliminar proveedores de email',
