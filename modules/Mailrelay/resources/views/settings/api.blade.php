...
@section('title', 'Configuración de API de Mailrelay')
        ...
        <form method="POST" action="{{ route('settings.mailrelay.api.update') }}" id="formMailrelayApi">
            ...
            <div class="card mb-3">
                <div class="card-header border-bottom p-3">
                    <h5 class="mb-0 fw-bold">Credenciales de API</h5>
                    <small class="text-muted">Conecta tu cuenta de Mailrelay mediante API para sincronizar suscriptores y enviar campañas.</small>
                </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('settings.mailrelay.index') }}" class="btn btn-light w-100">
                        Volver
                    </a>
                </div>
            </div>
