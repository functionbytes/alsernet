...
@section('content')
    @include('core::components.card', ['title' => 'Categorías del blog'])
            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="small mb-0 text-muted">Organiza los posts por categorias tematicas</p>
                    </div>
            ...
            <div class="card-body border-bottom">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <div class="card bg-light-secondary h-100">
                            <div class="card-body">
                                <h6 class="card-title mb-2">Destacadas</h6>
                                <h4 class="mb-1 fw-bold">{{ $stats['featured'] }}</h4>
                                <small class="text-muted">Marcadas como destacadas</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="d-flex flex-column flex-lg-row gap-3 align-items-stretch">
                        ...
                        <div class="d-flex gap-2 flex-shrink-0">
                            ...
                            @if(request('search') || request('status'))
                                <a href="{{ route('blog.categories.index') }}" class="btn btn-outline-secondary" title="Limpiar filtros">
                                ...
                                @foreach($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            <span class="{{ $category->parent_id == 0 ? 'fw-semibold' : '' }}">
                                                @if($category->icon)
                                        ...
                                        <td class="text-center">
                                            @if($category->status === \Modules\Blog\Enums\PostStatus::Published)
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('blog.categories.edit', $category->id) }}">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item delete-btn"
                                                           ...
                                                           data-url="{{ route('blog.categories.destroy', $category->id) }}"
                    ...
                    <div class="text-center py-5">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <p class="text-muted mb-3">
                                ...
                                @else
                                    Crea la primera categoria para organizar los posts
                                @endif
                            </p>
                            @if(!request('search') && !request('status'))
                                <a href="{{ route('blog.categories.create') }}" class="btn btn-sm btn-primary">
                                    <i class="fas fa-plus me-1"></i> Nueva categoria
                                </a>
                            @endif
                        </div>
...
$(document).ready(function () {
    ...
    $('#bulk-apply-btn').on('click', function () {
        ...
        $.ajax({
            url: '{{ route('blog.categories.bulk-action') }}',
            method: 'POST',
