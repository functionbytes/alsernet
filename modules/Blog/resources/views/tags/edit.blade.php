                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="tab-content" id="tagTabsContent">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea id="description" name="description" rows="3"
                                                  ...
                                                  placeholder="Descripción breve del tag (opcional)">{{ old('description', $tag->description) }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            @if(!empty($availableLocales))
                                @foreach($availableLocales as $locale => $label)
                                    @php $trans = $tag->translation($locale); @endphp
                ...
                <div class="card-body">
                    ...
                    @if($tag->posts()->count())
                        <div class="d-flex justify-content-between">
                            <span class="text-muted">Posts asociados</span>
                            <span class="fw-bold">{{ $tag->posts()->count() }}</span>
                        </div>
                    @endif
                </div>
            </div>
...
$(document).ready(function () {
    ...
    $('#btn-regenerate-slug').on('click', function () {
        ...
        $.ajax({
            ...
            data: { name: name, ignoreId: {{ $tag->id }} },
