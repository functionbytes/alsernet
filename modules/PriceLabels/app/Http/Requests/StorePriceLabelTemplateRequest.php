...
class StorePriceLabelTemplateRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()->can('pricelabels.create');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'fields.*.font_family' => ['nullable', 'string', Rule::in(['helvetica', 'times', 'courier'])],
            'fields.*.font_size' => ['nullable', 'integer', 'min:6', 'max:72'],
            'fields.*.bold' => ['boolean'],
            'fields.*.italic' => ['boolean'],
            'fields.*.font_family_h' => ['nullable', 'string', Rule::in(['helvetica', 'times', 'courier'])],
