...
class StorePriceLabelFontRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()->can('pricelabels.settings.update');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'family' => [
                ...
                'string',
                'max:100',
                Rule::notIn(array_keys(PriceLabelFontService::BUILTIN_LABELS)),
            ],
