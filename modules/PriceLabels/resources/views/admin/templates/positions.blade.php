        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header border-bottom p-3">
                    <h5 class="mb-0 fw-bold">Estilo por campo</h5>
                    <small class="text-muted">Color, fuente, tamano y caja de cada campo. Los cambios se ven al instante en el lienzo de abajo.</small>
                </div>
                <div class="card-body">
                    @include('pricelabels::admin.templates.partials.style-table', ['showFieldActions' => false])
                </div>
            </div>
        </div>
