...
$(document).ready(function () {
    // El select del modal de filtros declara su dropdownParent en un data-*;
    // select2 no lo lee solo, y sin el el desplegable se abre pegado al body y
    // queda por debajo del backdrop del modal.
    $('.select2').each(function () {
        var parent = $(this).data('dropdown-parent');
