...
Route::prefix('ai')->group(function () {
    ...
    Route::post('settings/test-connection', [AiAgentSettingsController::class, 'testConnection'])->middleware('throttle:60,1')->name('manager.helpdesk.ai.settings.test');
    Route::post('settings/get-models', [AiAgentSettingsController::class, 'getModels'])->middleware('throttle:60,1')->name('manager.helpdesk.ai.settings.get-models');
    Route::get('settings/statistics', [AiAgentSettingsController::class, 'statistics'])->middleware('throttle:60,1')->name('manager.helpdesk.ai.settings.statistics');
