            ...
            <form id="toolForm">
                <div class="modal-body">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-muted small mb-3">Nombre y descripción del tool</p>
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label" for="tool_name">Nombre de la función <span class="ais-required">· obligatorio</span></label>
                                <input type="text" class="form-control" id="tool_name" name="name"
                                       placeholder="get_weather, search_database" required>
                                <div class="invalid-feedback"></div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label" for="tool_type">Tipo <span class="ais-required">· obligatorio</span></label>
                            ...
                            <div class="col-12">
                                <label class="form-label" for="tool_description">Descripción <span class="ais-required">· obligatorio</span></label>
                                <textarea class="form-control" id="tool_description" name="description" rows="2"
                                          placeholder="Describe qué hace esta herramienta..." required></textarea>
                                <div class="form-text">Esta descripción ayudará al LLM a decidir cuándo usar esta herramienta</div>
                                <div class="invalid-feedback"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-muted small mb-3">Cómo se llama a la herramienta</p>
                        <div class="row g-3">
                            <div class="col-12">
                                <label class="form-label" for="tool_parameters">Parámetros (JSON Schema)</label>
                                ...
                                <div class="form-text">Define los parámetros que acepta esta función en formato JSON Schema</div>
                            </div>
                            <div class="col-12">
                                <label class="form-label" for="tool_implementation">Implementación (código/endpoint)</label>
                                <textarea class="form-control font-monospace" id="tool_implementation" name="implementation" rows="3"
                                          placeholder="URL del endpoint, código PHP, o referencia a clase/método"></textarea>
                                <div class="form-text">URL de API, código ejecutable, o ruta a método PHP</div>
                            </div>
                            <div class="col-12">
                                <label class="form-label" for="tool_auth_config">Configuración de autenticación (JSON)</label>
                    ...
                    <div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label" for="tool_requires_approval">Requiere aprobación</label>
                                <select class="form-select" id="tool_requires_approval" name="requires_approval">
                                    <option value="0">No requiere aprobación</option>
                                    <option value="1">Requiere aprobación</option>
                                </select>
                                <div class="form-text">El agente pedirá permiso antes de ejecutar esta herramienta</div>
                            </div>
                            <div class="col-md-6">
