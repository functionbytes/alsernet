...
@section('content')
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card">
            ...
            {{-- Search --}}
            <div class="card-body border-bottom">
                <form method="GET" action="{{ route('helpdesk.ai.flows.index') }}" id="filterForm">
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <select name="trigger" class="form-select w-auto flex-shrink-0">
                        ...
                        @if(request('search') || request('status') || request('trigger'))
                            <a href="{{ route('helpdesk.ai.flows.index') }}"
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('helpdesk.ai.flows.edit', $flow) }}">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    ...
                                                    @if($flow->status !== 'archived')
                                                        <li>
                                                            <form action="{{ route('helpdesk.ai.flows.archive', $flow) }}" method="POST">
                                                                @csrf
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item delete-btn" href="#"
                                                           ...
                                                           data-url="{{ route('helpdesk.ai.flows.destroy', $flow) }}"
