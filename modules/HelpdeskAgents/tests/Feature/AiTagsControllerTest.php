...
class AiTagsControllerTest extends TestCase
{
    ...
    {
        $this->assertTrue(Route::has('manager.helpdesk.ai.tags.index'));
    }

    public function test_store_route_registered(): void
    {
        $this->assertTrue(Route::has('manager.helpdesk.ai.tags.store'));
    }

    public function test_destroy_route_registered(): void
    {
        $this->assertTrue(Route::has('manager.helpdesk.ai.tags.destroy'));
    }
}
