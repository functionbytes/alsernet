...
class AiFlowsControllerTest extends TestCase
{
    ...
    {
        $this->assertTrue(Route::has('manager.helpdesk.ai.flows.index'));
    }

    public function test_store_route_registered(): void
    {
        $this->assertTrue(Route::has('manager.helpdesk.ai.flows.store'));
    }

    public function test_destroy_route_registered(): void
    {
        $this->assertTrue(Route::has('manager.helpdesk.ai.flows.destroy'));
    }
}
