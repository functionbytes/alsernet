...
class AiKnowledgeControllerTest extends TestCase
{
    ...
    {
        $this->assertTrue(Route::has('manager.helpdesk.ai.knowledge.index'));
    }

    public function test_store_route_registered(): void
    {
        $this->assertTrue(Route::has('manager.helpdesk.ai.knowledge.store'));
    }

    public function test_destroy_route_registered(): void
    {
        $this->assertTrue(Route::has('manager.helpdesk.ai.knowledge.destroy'));
    }
}
