...
class AiToolsControllerTest extends TestCase
{
    ...
    {
        $this->assertTrue(Route::has('manager.helpdesk.ai.tools.index'));
    }

    public function test_store_route_registered(): void
    {
        $this->assertTrue(Route::has('manager.helpdesk.ai.tools.store'));
    }

    public function test_destroy_route_registered(): void
    {
        $this->assertTrue(Route::has('manager.helpdesk.ai.tools.destroy'));
    }
}
