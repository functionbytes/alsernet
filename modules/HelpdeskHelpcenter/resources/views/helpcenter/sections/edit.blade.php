...
@section('page_header')
    @include('core::components.card', ['title' => 'Centro de ayuda — Editar sección'])
@endsection
...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-header p-4 border-bottom border-light">
      <h5 class="mb-1 fw-bold">Editar sección</h5>
      <p class="small mb-0 text-muted">{{ $section->name }}</p>
    </div>
    ...
    $(document).ready(function () {
      ...
      $("#formSection").validate({
        ...
        submitHandler: function (form) {
          ...
          $.ajax({
            type: 'POST',
            url: "{{ route('manager.helpcenter.sections.update') }}",
            data: $(form).serialize(),
            dataType: 'json',
