...
@section('page_header')
    @include('core::components.card', ['title' => 'Centro de ayuda — Nuevo artículo'])
@endsection
...
@section('content')
  ...
  <div class="card">
    ...
    <div class="card-header p-4 border-bottom border-light">
      <h5 class="mb-1 fw-bold">Nuevo artículo</h5>
      <p class="small mb-0 text-muted">Crea contenido publicable en el centro de ayuda</p>
    </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  ...
                  <small class="form-text text-muted">
                    Si lo desmarcas, el artículo se publicará y será visible en el centro de ayuda público.
                  </small>
                </div>
              </div>
    ...
    $(document).ready(function () {
      ...
      $("#formArticle").validate({
        ...
        submitHandler: function (form, event) {
          ...
          $.ajax({
            type: 'POST',
            url: "{{ route('manager.helpcenter.articles.store') }}",
            data: formData,
            processData: false,
            contentType: false,
            dataType: 'json',
