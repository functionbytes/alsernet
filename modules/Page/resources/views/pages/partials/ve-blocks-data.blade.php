...
window.veBlocks = [
      ...
      <div class="col-lg-8">
        <div class="d-flex mb-4">
          <div class="me-3 text-center" style="min-width: 60px;">
            ...
            <div class=" border-2 border-primary ms-3" style="height: 40px;"></div>
          </div>
        ...
        <div class="d-flex mb-4">
          <div class="me-3 text-center" style="min-width: 60px;">
            ...
            <div class=" border-2 border-success ms-3" style="height: 40px;"></div>
          </div>
  ...
  <div class="container">
    ...
    },
    {
        ...
        html: `<blockquote class="blockquote   border-primary ps-4 my-4">
