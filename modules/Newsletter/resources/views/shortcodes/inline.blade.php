                ...
                <form method="POST" action="{{ route('newsletter.subscribe') }}" class="bb-newsletter-inline-form" novalidate>
                    ...
                    <div class="newsletter-form-fields">
                        <div class="form-group">
                            <input class="form-control mb-3" placeholder="{{ __('newsletter_placeholder_name') }}" name="name" type="text" autocomplete="name">
                        </div>
                        <div class="form-group">
                            <input class="form-control mb-3" placeholder="{{ __('newsletter_placeholder_email') }}" required name="email" type="email" autocomplete="email" aria-required="true">
                        </div>
