    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="card bg-light-secondary h-100">
                            <div class="card-body">
                                <h6 class="card-title mb-2">Total suscriptores</h6>
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-3">
                            <select name="status" class="form-select">
                                ...
                                <option value="1" {{ request('status') === '1' ? 'selected' : '' }}>Suscrito</option>
                                <option value="0" {{ request('status') === '0' ? 'selected' : '' }}>Desuscrito</option>
                            </select>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="card-body">
                @if ($subscribers->isEmpty())
                    <div class="text-center py-5">
                        <h6 class="mb-1">No hay suscriptores registrados</h6>
                        <p class="text-muted mb-0">Los suscriptores apareceran aqui una vez que alguien se registre.</p>
                    </div>
                @else
                            ...
                            <tbody>
                                @foreach ($subscribers as $subscriber)
                                    <tr>
                                        ...
                                        <td class="text-muted">{{ $subscriber->id }}</td>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @else
                                                <span class="badge bg-secondary-subtle text-secondary">Desuscrito</span>
                                            @endif
                                        </td>
                                        <td class="text-center">
                                            <div class="dropdown">
            ...
            @if ($subscribers->hasPages())
                <div class="card-footer">{{ $subscribers->withQueryString()->links() }}</div>
            @endif
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-muted mb-3">Se aplicará la acción sobre <strong><span data-bulk-count>0</span> suscriptor(es)</strong>.</p>
                    <div class="mb-3">
...
$(document).ready(function () {
    ...
    $('#bulk-apply-btn').on('click', function () {
        ...
        if (action === 'delete' && !confirm('¿Eliminar los ' + ids.length + ' suscriptor(es) seleccionados?')) { return; }
