...
Route::prefix('helpdesk/social')->middleware(['auth:sanctum', 'log.social.api', 'throttle:helpdesk-social-api'])->group(function () {
    ...
    // Tags
    Route::apiResource('tags', SocialTagsController::class)->names('helpdesksocial.tags');
    ...
    // SLA Policies
    Route::apiResource('sla-policies', SocialSlaPoliciesController::class)->parameters(['sla-policies' => 'policy'])->names('helpdesksocial.sla-policies');

    // Conversations
    Route::apiResource('conversations', SocialConversationsController::class)->only(['index', 'show', 'update', 'destroy'])->names('helpdesksocial.conversations');

    // Assignment Rules
    Route::apiResource('assignment-rules', SocialAssignmentRulesController::class)->parameters(['assignment-rules' => 'rule'])->names('helpdesksocial.assignment-rules');
    ...
    // Mentions
    Route::apiResource('mentions', SocialMentionsController::class)->only(['index', 'show', 'update', 'destroy'])->names('helpdesksocial.mentions');
    ...
    // Competitors
    Route::apiResource('competitors', SocialCompetitorsController::class)->names('helpdesksocial.competitors');

    // Rules
    Route::apiResource('rules', SocialRulesController::class)->names('helpdesksocial.rules');
    ...
    // Templates
    Route::apiResource('templates', SocialTemplatesController::class)->names('helpdesksocial.templates');
