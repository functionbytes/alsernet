    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card bg-primary text-white">
                <div class="card-body">
                    <h4 class="mb-1">{{ $overview['total_comments'] }}</h4>
        ...
        <div class="col-md-3">
            <div class="card bg-success text-white">
                <div class="card-body">
                    <h4 class="mb-1">{{ $overview['total_replied'] }}</h4>
        ...
        <div class="col-md-3">
            <div class="card bg-info text-white">
                <div class="card-body">
                    <h4 class="mb-1">{{ $overview['avg_response_time'] ? round($overview['avg_response_time'] / 60, 1) . ' min' : '-' }}</h4>
        ...
        <div class="col-md-3">
            <div class="card bg-warning text-dark">
                <div class="card-body">
                    <h4 class="mb-1">{{ $overview['total_comments'] > 0 ? round(($overview['total_replied'] / $overview['total_comments']) * 100, 1) : 0 }}%</h4>
