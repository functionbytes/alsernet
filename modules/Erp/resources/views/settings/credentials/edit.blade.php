...
@section('content')
    ...
    <div class="card w-100">
        ...
        <form method="POST" action="{{ route('settings.erp.credentials.update', $credential) }}">
            ...
            <div class="card-body">
                <div class="d-flex no-block align-items-center">
                    <h5 class="mb-0">Editar credencial: {{ $credential->name }}</h5>
                </div>
                <p class="card-subtitle mb-3 mt-1">
                    Modifica la configuración de la credencial de autenticación.
                </p>
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                   value="{{ old('name', $credential->name) }}" required placeholder="Ej: Gestión - Basic Auth">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror"
                                      rows="2" placeholder="Descripción opcional de la credencial">{{ old('description', $credential->description) }}</textarea>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="username" class="form-control @error('username') is-invalid @enderror"
                                       value="{{ old('username', $credential->username) }}" placeholder="usuario">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea name="token" class="form-control @error('token') is-invalid @enderror"
                                          rows="3" placeholder="Dejar vacío para no cambiar">{{ old('token') }}</textarea>
                                <small class="form-text text-muted">Dejar vacío para mantener el token actual</small>
                                @error('token')
                                    <span class="field-validation-error"><i class="fa fa-circle-exclamation"></i> {{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" name="api_key" class="form-control @error('api_key') is-invalid @enderror"
                                       placeholder="Dejar vacío para no cambiar">
                                <small class="form-text text-muted">Dejar vacío para mantener la API key actual</small>
                                @error('api_key')
                                    <span class="field-validation-error"><i class="fa fa-circle-exclamation"></i> {{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="api_key_header" class="form-control @error('api_key_header') is-invalid @enderror"
                                       value="{{ old('api_key_header', $credential->api_key_header) }}" placeholder="X-API-Key">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea name="custom_headers_json" id="custom_headers_json" class="form-control @error('custom_headers') is-invalid @enderror"
                                          rows="4">{{ old('custom_headers_json', json_encode($credential->custom_headers ?? [], JSON_PRETTY_PRINT)) }}</textarea>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" name="expires_at" class="form-control @error('expires_at') is-invalid @enderror"
                                   value="{{ old('expires_at', $credential->expires_at?->format('Y-m-d\TH:i')) }}">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="is_active" class="form-control select2 @error('is_active') is-invalid @enderror" required>
                                <option value="1" {{ old('is_active', $credential->is_active) == '1' ? 'selected' : '' }}>Activa</option>
                                <option value="0" {{ old('is_active', $credential->is_active) == '0' ? 'selected' : '' }}>Inactiva</option>
                            </select>
