                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h5 class="mb-1 fw-bold">
                            <i class="fas fa-inbox me-2"></i>Mensajes Archivados
                        </h5>
                        <p class="small mb-0 text-muted">Mensajes archivados de tus redes sociales</p>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between">
                                    <div>
                                        ...
                                        <h4 class="mb-1 fw-bold">{{ $stats['total'] ?? $stats['archived'] ?? 0 }}</h4>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between">
                                    <div>
                                        ...
                                        <h4 class="mb-1 fw-bold">{{ $stats['replied'] ?? 0 }}</h4>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between">
                                    <div>
                                        ...
                                        <h4 class="mb-1 fw-bold">{{ $stats['not_replied'] ?? 0 }}</h4>
