    ...
    public function getWidgetConfig(): array
    {
        return Cache::remember("widget_config_{$this->id}", 300, function () {
            return [
                ...
                'primary_color' => $this->widget_color ?? '#90bb13',
                ...
                'widgetColor' => $this->widget_color ?? '#90bb13',
                'widgetPosition' => $this->widget_position ?? 'bottom-right',
                ...
                // Launcher
                'position' => $this->widget_position ?? 'bottom-right',
