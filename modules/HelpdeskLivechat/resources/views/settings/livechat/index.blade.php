                                        ...
                                        <div class="lc-toggle-item">
                                            ...
                                            <label class="form-check-label mb-0 w-100" for="{{ $field }}">
                                                <span class="fw-semibold d-block">
                                                    <i class="fas {{ $meta['icon'] }} hd-icon-fw text-muted me-1"></i>{{ $meta['label'] }}
                                                </span>
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="lc-toggle-item">
                                            ...
                                            <label class="form-check-label mb-0 w-100" for="hide_launcher">
                                                <span class="fw-semibold d-block"><i class="fas fa-eye-slash hd-icon-fw text-muted me-1"></i>Ocultar lanzador</span>
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="lc-toggle-item">
                                            ...
                                            <label class="form-check-label mb-0 w-100" for="show_dark_mode_preview">
                                                <span class="fw-semibold d-block"><i class="fas fa-moon hd-icon-fw text-muted me-1"></i>Vista previa en modo oscuro</span>
                                ...
                                <div id="acc-screens" class="accordion-collapse collapse">
                                    <div class="accordion-body">
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                ...
                                                <input class="form-check-input lc-sync" type="checkbox" role="switch"
                                                       ...
                                                       @checked($backups['enable_file_upload'] ?? true)>
                                        ...
                                        <div id="file-types-section" class="ms-2 mb-3">
                                            ...
                                            @php
                                                $allowedTypes = $backups['allowed_file_types'] ?? ['images', 'documents'];
                                            @endphp
                                            @foreach([
                                        ...
                                        <div class="mb-3">
                                            <div class="form-check form-switch">
                                                ...
                                                <input class="form-check-input lc-sync" type="checkbox" role="switch"
                                                       ...
                                                       @checked($backups['enable_emoji'] ?? true)>
                                        ...
                                        <div class="flex-grow-1 {{ !($backups['enable_auto_transfer'] ?? false) ? 'opacity-50' : '' }}" id="body-transfer">
                                            <div class="mb-1">
                                                ...
                                                <input type="number" class="form-control form-control-sm d-inline-block" id="auto_transfer_minutes" name="auto_transfer_minutes"
                                                    ...
                                                    class="hd-num-input-sm" onclick="event.stopPropagation()">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="position-relative mb-4">
                                    <div class="lc-code-block" id="installCodeBlock"><pre class="mb-0 hd-code-pre">&lt;script&gt;
  window.HelpdeskSettings = {
    websiteToken: "{{ $websiteToken ?? 'TU_WEBSITE_TOKEN' }}",
    baseUrl: "{{ url('/') }}"
  };
...
&lt;script src="{{ url('/hd/widget-loader.js') }}"&gt;&lt;/script&gt;</pre>
                                ...
                                <div class="alert alert-info d-flex gap-2 align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <div class="lc-code-block mt-2 position-relative hd-code-sm">
<pre class="mb-0 hd-code-pre">&lt;script&gt;
  window.HelpdeskSettings = {
    websiteToken: "{{ $websiteToken ?? 'TU_WEBSITE_TOKEN' }}",
                                ...
                                <div class="border-top pt-4 mb-4">
                                    <div class="lc-toggle-item">
                                        ...
                                        <label class="form-check-label mb-0 w-100" for="enforce_identity_verification">
                                            <span class="fw-semibold d-block"><i class="fas fa-user-shield hd-icon-fw text-muted me-1"></i>Forzar verificación de identidad</span>
