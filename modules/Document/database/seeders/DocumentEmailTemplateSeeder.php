    ...
    public function run(): void
    {
        ...
        $templates = [
            [
                ...
                'subject' => 'Solicitud de documentación - pedido {ORDER_ID}',
            ...
            [
                ...
                'subject' => 'Documentación faltante - pedido {ORDER_ID}',
            ...
            [
                ...
                'subject' => 'Recordatorio: documentación pendiente - pedido {ORDER_ID}',
            ...
            [
                ...
                'subject' => 'Documentos aprobados - pedido {ORDER_ID}',
            ...
            [
                ...
                'subject' => 'Documentos rechazados - acción requerida - pedido {ORDER_ID}',
            ...
            [
                ...
                'subject' => 'Documentación completa - pedido {ORDER_ID}',
...
<div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
    ...
    <p>Gracias por realizar su compra en nuestro sitio. Para poder procesar su pedido <strong>(pedido {ORDER_ID})</strong>, necesitamos que cargue los siguientes documentos:</p>
...
<div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
    ...
    <p>Hemos revisado su solicitud de documentos para la pedido <strong>{ORDER_ID}</strong> y detectamos que aún faltan los siguientes documentos:</p>
...
<div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
    ...
    <p>Le recordamos que aún no ha cargado los documentos requeridos para su pedido <strong>{ORDER_ID}</strong>.</p>
...
<div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
    ...
    <p>Su pedido <strong>{ORDER_ID}</strong> está siendo procesada y será completada en breve.</p>
...
<div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
    ...
    <p style="background-color: #f8d7da; padding: 12px; border-radius: 5px; border-left: 4px solid #dc3545;">
        <strong>⚠ Acción Requerida:</strong> Hemos revisado los documentos enviados para su pedido <strong>{ORDER_ID}</strong> y necesitamos que realice algunas correcciones.
    </p>
...
<div style="font-family: Arial, sans-serif; color: #333; line-height: 1.6;">
    ...
    <p>Nos complace informarle que su pedido <strong>{ORDER_ID}</strong> está lista para ser procesada.</p>
