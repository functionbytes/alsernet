                                        ...
                                        @if($document->status->label = "pending")
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center gap-3 cursor-pointer"
                                                   ...
                                                   onclick="copyToClipboardDocument(event)">
                                                    <span class="copy-text">Solicitud</span>
                                                </a>
                                            </li>
                                        @endif
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    navigator.clipboard.writeText(data.url).then(() => {
                        toastr.success('URL copiada al portapapeles', 'Éxito', {
                            closeButton: true,
                            progressBar: true,
                            positionClass: "toast-bottom-right"
                        });
                    }).catch(() => {
                        toastr.error('Error al copiar la URL', 'Error', {
                            closeButton: true,
                            progressBar: true,
                            positionClass: "toast-bottom-right"
                        });
                ...
                error: function(error) {
                    ...
                    toastr.error('Error al obtener la URL', 'Error', {
                        closeButton: true,
                        progressBar: true,
                        positionClass: "toast-bottom-right"
                    });
