 ...
 *
 * Fuente del módulo (source of truth). Se sirve publicado en
 * public/vendor/helpdeskintegration/verify-customer-identity.js — tras
 * editar este archivo hay que copiarlo ahí a mano (no hay build step):
 *   cp modules/HelpdeskIntegration/resources/js/verify-customer-identity.js \
 *      public/vendor/helpdeskintegration/verify-customer-identity.js
 */
(function () {
    'use strict';
