 ...
 * 'helpdesk.tickets.emails.view' a 'helpdeskemailactivity.view'.
 *
 * La ruta 'manager.helpdesk.tickets.emails.index' hoy es solo un redirect
 * hacia helpdeskemailactivity.index (TicketMailsController::index()), y la
 * autorización real la impone el destino
 * (EmailLogController::index() -> authorize('viewAny', EmailLog::class) ->
 * EmailLogPolicy::viewAny(), que exige 'helpdeskemailactivity.view'). Cualquier
 * rol o usuario que ya tuviera 'helpdesk.tickets.emails.view' pero NO
 * 'helpdeskemailactivity.view' se quedaría, tras ese cambio de menú, viendo un
 ...
 *      da HelpdeskTicketsPermissionsSeeder), pero HelpdeskEmailActivityPermissionsSeeder
 *      solo asignó 'helpdeskemailactivity.view' a ['admin', 'super-admin',
 ...
 *      (no heredado de un rol): se les da 'helpdeskemailactivity.view' también
 ...
 *      caso rol en (a), y super-admin ya tenía 'helpdeskemailactivity.view' de
...
return new class extends Migration
{
    ...
    private const NEW_PERMISSION = 'helpdeskemailactivity.view';
    ...
    public function up(): void
    {
        ...
        try {
            ...
            // en un entorno donde HelpdeskEmailActivity todavía no sembró sus
            ...
            Log::info('[HelpdeskEmailActivity] Backfill de helpdeskemailactivity.view completado', [
            ...
            Log::warning('[HelpdeskEmailActivity] Fallo el backfill de helpdeskemailactivity.view', [
                'error' => $e->getMessage(),
                'roles_updated' => $rolesUpdated,
                'users_updated' => $usersUpdated,
            ]);
        ...
        try {
            ...
            Log::warning('[HelpdeskEmailActivity] No se pudo limpiar la caché de permisos tras el backfill', [
                'error' => $e->getMessage(),
            ]);
        }
    }
     ...
     * lectura ('helpdeskemailactivity.view') a quien ya podía ver la bandeja de
