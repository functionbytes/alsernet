 ...
 * config('helpdeskemailactivity.webhook_payload_max_bytes'/'webhook_payload_redact_keys')
...
class WebhookPayloadRedactor
{
    ...
    public static function redact(array $payload): array
    {
        ...
        $maxBytes = (int) Setting::get('helpdeskemailactivity.webhook_payload_max_bytes', config('helpdeskemailactivity.webhook_payload_max_bytes'));
    ...
    {
        return (array) Setting::get('helpdeskemailactivity.webhook_payload_redact_keys', config('helpdeskemailactivity.webhook_payload_redact_keys', []));
    }
