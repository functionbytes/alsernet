 ...
 * HelpdeskEmailActivityServiceProvider::registerListeners()) — Illuminate\Events\
...
class EnforceEmailSuppression
{
    ...
    public function handle(MessageSending $event): bool
    {
        ...
        try {
            ...
            Log::warning('HelpdeskEmailActivity: fallo marcando envío suprimido', ['exception' => $e]);
        }
    ...
    private function logSuppressedAttempt(Email $message, array $suppressed): void
    {
        try {
            ...
            Log::warning('HelpdeskEmailActivity: fallo registrando destinatarios suprimidos parcialmente', ['exception' => $e]);
        }
    }
}
