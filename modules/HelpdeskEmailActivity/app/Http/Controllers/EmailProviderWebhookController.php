...
use Modules\HelpdeskEmailActivity\Services\ProviderWebhooks\MailgunWebhookAdapter;
use Modules\HelpdeskEmailActivity\Services\ProviderWebhooks\MailrelayWebhookAdapter;
use Modules\HelpdeskEmailActivity\Services\ProviderWebhooks\PostmarkWebhookAdapter;
use Modules\HelpdeskEmailActivity\Services\ProviderWebhooks\SesSnsWebhookAdapter;
...
use Modules\HelpdeskEmailActivity\Support\WebhookPayloadRedactor;
...
class EmailProviderWebhookController extends Controller
{
    ...
    public function receive(
        ...
        if (! $adapter->verify($request, (string) $config['secret'])) {
            Log::warning('helpdeskemailactivity: webhook de proveedor con firma/token inválido', ['provider' => $provider]);
