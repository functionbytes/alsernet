 ...
 *   GET /panel/helpdeskemailactivity/analytics  ->  name('helpdeskemailactivity.analytics.index')
 *   middleware ['auth'], mismo grupo/prefix que el resto de
 *   panel/helpdeskemailactivity (ver routes/web.php).
 */
class EmailLogAnalyticsController extends Controller
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('helpdeskemailactivity::emails.analytics', [
            'from' => $from,
            'to' => $to,
