...
class EmailClickTrackingTest extends TestCase
{
    ...
    public function test_click_route_records_a_click_and_redirects_to_the_real_url(): void
    {
        ...
        $response = $this->get(route('helpdeskemailactivity.click', ['emailLog' => $link->emailLog, 'token' => $link->token]));
    ...
    public function test_click_route_requires_no_authentication(): void
    {
        ...
        $this->get(route('helpdeskemailactivity.click', ['emailLog' => $link->emailLog, 'token' => $link->token]))
    ...
    public function test_unknown_token_returns_404(): void
    {
        ...
        $this->get(route('helpdeskemailactivity.click', ['emailLog' => $log, 'token' => 'doesnotexist12345']))
            ->assertNotFound();
    }
    ...
    public function test_a_link_belonging_to_a_different_email_log_is_rejected(): void
    {
        ...
        $this->get(route('helpdeskemailactivity.click', ['emailLog' => $otherLog, 'token' => $link->token]))
            ->assertNotFound();
    }
