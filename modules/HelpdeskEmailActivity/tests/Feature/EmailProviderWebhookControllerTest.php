...
class EmailProviderWebhookControllerTest extends TestCase
{
    ...
    public function test_unknown_provider_returns_404(): void
    {
        ...
        $this->postJson(route('helpdeskemailactivity.webhooks.receive', ['provider' => 'not-a-real-provider']))
            ->assertNotFound();
    }
    ...
    public function test_request_for_a_provider_that_is_not_the_active_one_returns_404(): void
    {
        ...
        $this->postJson(route('helpdeskemailactivity.webhooks.receive', ['provider' => 'postmark']), [], [
    ...
    public function test_mailrelay_processing_the_same_event_twice_stays_idempotent(): void
    {
        ...
        $this->postJson(route('helpdeskemailactivity.webhooks.receive', ['provider' => 'mailrelay']), $payload, $headers)->assertOk();
    ...
    public function test_mailgun_rejects_an_invalid_hmac_signature(): void
    {
        ...
        $this->postJson(route('helpdeskemailactivity.webhooks.receive', ['provider' => 'mailgun']), [
    ...
    private function generateSigningKeyPair(): array
    {
        ...
        $csr = openssl_csr_new(['commonName' => 'helpdeskemailactivity-test'], $privateKey);
    ...
    public function test_ses_rejects_a_signing_cert_url_on_a_non_amazon_host(): void
    {
        ...
        $this->postJson(route('helpdeskemailactivity.webhooks.receive', ['provider' => 'ses']), $payload)
            ->assertStatus(401);
    }
    ...
    {
        config(['helpdeskemailactivity.webhook_payload_max_bytes' => 100]);
        $this->configureProvider('mailrelay', 'shared-secret');
