...
class EmailLogAnalyticsTest extends TestCase
{
    ...
    public function test_controller_requires_view_permission(): void
    {
        ...
        Route::middleware('web')->get('/__test/helpdeskemailactivity/analytics', [EmailLogAnalyticsController::class, 'index']);

        $outsider = User::factory()->create();

        $this->actingAs($outsider)
            ->get('/__test/helpdeskemailactivity/analytics')
            ->assertForbidden();
    }
    ...
    public function test_controller_renders_for_a_viewer(): void
    {
        ...
        $this->actingAs($this->viewer())
            ->get('/__test/helpdeskemailactivity/analytics')
            ->assertOk()
            ->assertViewIs('helpdeskemailactivity::emails.analytics')
