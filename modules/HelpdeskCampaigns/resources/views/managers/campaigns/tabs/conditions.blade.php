...
@push('scripts')
<script>
    window.HcmConditionsTab = { conditionCounter: {{ count($conditions) }} };
</script>
<script src="{{ asset('modules/helpdeskcampaigns/js/campaign-form-conditions.js') }}?v={{ @filemtime(public_path('modules/helpdeskcampaigns/js/campaign-form-conditions.js')) }}" defer></script>
@endpush
