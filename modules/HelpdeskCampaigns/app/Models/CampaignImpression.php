...
use Modules\HelpdeskCampaigns\Database\Factories\CampaignImpressionFactory;

class CampaignImpression extends Model
{
    use HasFactory;

    protected static function newFactory(): CampaignImpressionFactory
    {
        return CampaignImpressionFactory::new();
    }
