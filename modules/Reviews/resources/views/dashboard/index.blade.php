...
<style>
    ...
    .pagination .page-item.active .page-link { background-color: #90bb13; border-color: #90bb13; color: #fff; }
    .pagination .page-link { color: #90bb13; }
...
$(document).ready(function () {
    ...
    function renderCharts(data) {
        ...
        if (data.reviewsByDay && data.reviewsByDay.dailyData) {
            ...
            renderSpark('spark-total',      d.dailyData.map(r => r.count || 0), '#90bb13', 'area', d.currTotal,      d.prevTotal);
