...
(function () {
    ...
    function renderBarChart(dates, counts) {
        ...
        last14dates.forEach(function (date, i) {
            ...
            var color = count === 0 ? '#e9ecef' : '#b10100';
    ...
    function renderPeakDays(peakDays) {
        ...
        Object.entries(peakDays).forEach(function (entry) {
            ...
            var barColor   = isBest ? '#b10100' : '#e8e8e8';
            var labelStyle = isBest ? 'color:#b10100;font-weight:700;' : '';
            var crown      = isBest ? ' <i class="fas fa-crown" style="color:#b10100;font-size:0.7rem;"></i>' : '';
    ...
    function loadVelocity() {
        ...
        $.get(velocityUrl, { days: 90 }, function (res) {
            ...
            changeEl.style.color = isUp ? '#b10100' : (isDown ? '#333333' : '#9aa4b0');
            ...
            renderMiniBars('velocity-mini-current',  allCounts, '#b10100');
