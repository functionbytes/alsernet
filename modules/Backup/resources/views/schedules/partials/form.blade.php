...
<div class="row g-3">
    <div class="col-lg-8">
        <form action="{{ isset($schedule) ? route('settings.backup.schedules.update', $schedule->id) : route('settings.backup.schedules.store') }}"
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-0">
                            ...
                            <div class="col-md-12">
                                <div class="form-check form-switch">
                                    ...
                                    <input class="form-check-input" type="checkbox" id="enabled" name="enabled"
                                           value="1" {{ old('enabled', $schedule->enabled ?? true) ? 'checked' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label for="frequency" class="form-label fw-semibold">Frecuencia <span
                                                class="text-danger">*</span></label>
                                    <select class="form-select @error('frequency') is-invalid @enderror select2"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <input type="time"
                                           ...
                                           value="{{ old('scheduled_time', isset($schedule) ? $schedule->scheduled_time->format('H:i') : '02:00') }}"
                                           required>
                                    <small class="text-muted d-block mt-1">
                                ...
                                <!-- Monthly Options -->
                                <div class="col-md-12 mb-3" id="monthlyOptions" style="display: none;">
                        ...
                        <div class="mb-0">
                            <h6 class="fw-semibold mb-1">Tipos de backup</h6>
                        ...
                        @isset($schedule)
                            ...
                            <div class="mb-0">
                                <h6 class="fw-semibold mb-1">Información de ejecución</h6>
                                <p class="text-muted mb-3">Historial y próxima ejecución programada de este schedule</p>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <p class="mb-0 fw-semibold">
                                            @if ($schedule->last_run_at)
                                                {{ $schedule->last_run_at->format('d/m/Y H:i:s') }}
                                            @else
                                                <span class="text-muted fw-normal">Nunca ejecutado</span>
                                            @endif
                                        </p>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <p class="mb-0 fw-semibold">
                                            @if ($schedule->next_run_at)
                                                {{ $schedule->next_run_at->format('d/m/Y H:i:s') }}
                                            @else
                                                <span class="text-muted fw-normal">Pendiente de cálculo</span>
                                            @endif
                                        </p>
                                    </div>
                                </div>
