...
.status-pill.ok     { background: rgba(177,1,0,.1);  color: #b10100; }
...
.health-strip.ok     .health-icon { background: #b10100; color: #fff; }
.health-strip.ok     .health-title { color: #b10100; }
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card">
            ...
            <div id="status-loading" class="card-body text-center py-5">
                <div class="spinner-border mb-3" role="status" style="color:#b10100; width:2rem; height:2rem;"></div>
