...
class Alserneteventmanager extends Module implements WidgetInterface
{
    ...
    public function removeFeatureFromProduct($id_product, $feature_id, $feature_value_id)
    {
    ...
    public function productHasFeature($id_product, $feature_id, $feature_value_id)
    {
    ...
    public function removeFeaturesFromProducts($productIds, $feature_id, $feature_value_id)
    {
    ...
    public function addFeaturesFromProducts($productIds, $id_feature, $id_feature_value, $cust = 0)
    {
    ...
    public function checkUrlAndReIndex($url)
    {
        $ch = curl_init();
