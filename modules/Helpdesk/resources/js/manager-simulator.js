$(function () {
    ...
    const urls = window.HelpdeskSimulatorUrls;
    let selected = null;
    ...
    function searchCustomers(q) {
        ...
        $.get(urls.customers, { q })
            ...
            .fail(() => $('#simResults').html('<div class="text-dark small py-3">Error al buscar en PrestaShop.</div>'));
    }
    ...
    function loadOrders(c) {
        ...
        $.get(urls.orders, { email: c.email, prestashop_id: c.prestashop_id })
            ...
            .fail(() => $('#simOrdersBody').html('<tr><td colspan="4" class="text-dark small py-3">Error al cargar pedidos.</td></tr>'));
    }
        ...
        $.ajax({
            ...
            $('#simResultBody').html(
                `<div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="${res.url}" class="btn btn-success btn-sm" target="_blank">Abrir conversación</a>
                </div>`
            );
        }).fail(xhr => {
