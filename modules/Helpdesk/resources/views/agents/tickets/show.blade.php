        ...
        <div class="col-lg-8">
            ...
            <div class="card shadow-sm mb-2 {{ $item->is_internal ? 'border-warning' : '' }}">
                <div class="card-body">
                    ...
                    <div>{!! $item->html_body ?? nl2br(e($item->body)) !!}</div>
                </div>
            </div>
            @endforeach
        ...
        .listen('.ticket.message.new', function(data) {
            const messageHtml = `
                <div class="card shadow-sm mb-2">
                    <div class="card-body">
                        <div class="d-flex align-items-center gap-2 mb-2">
                            <strong class="small">${data.message.author}</strong>
                            <small class="text-muted ms-auto">${new Date(data.message.created_at).toLocaleTimeString()}</small>
                        </div>
