...
<div class="bv-page">
    ...
    {{-- Topbar --}}
    @include('helpdesk::helpdesk.customers.partials.topbar')
    ...
    <div class="bv-page-body">
        ...
        <div class="bv-page-list">
            ...
            <div class="bv-page-list-head">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="{{ route('manager.helpdesk.exports.customers', request()->query()) }}" class="btn btn-outline-secondary btn-sm">
            ...
            <div class="bv-page-list-scroll">
                @include('helpdesk::helpdesk.customers.partials.list')
        ...
        <div class="bv-page-detail">
            @if($selected)
                @include('helpdesk::helpdesk.customers.partials.detail')
            @else
                @include('helpdesk::helpdesk.customers.partials.detail-empty')
            @endif
        </div>
