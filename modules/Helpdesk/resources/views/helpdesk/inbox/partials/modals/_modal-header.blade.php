...
<div class="modal-header border-bottom gap-3 py-3 align-items-start">
    <div class="d-flex align-items-center gap-3 flex-grow-1 bv-x8">
        <div class="rounded-circle d-flex align-items-center justify-content-center bg-{{ $iconVariant }}-subtle flex-shrink-0 bv-x9">
        ...
        <div class="bv-x8">
            ...
            <div class="fw-semibold lh-sm bv-x8">
                @isset($titleId)
    ...
    <button type="button" class="btn-close flex-shrink-0 mt-1" data-bs-dismiss="modal" aria-label="{{ __('helpdesk::helpdesk.inbox.modals.modal_header_close') }}"></button>
</div>
