    ...
    <div class="bv-modal-dialog md">
        <div class="bv-modal-head bv-modal-head--with-icon">
            ...
            <div class="bv-modal-title-wrap">
                <span class="bv-modal-label">COMPOSER · ADJUNTAR</span>
                <div class="bv-modal-title">Adjuntar archivo</div>
            </div>
        ...
        <div class="bv-modal-body">
            ...
            <div class="bv-dropzone" id="bvAttachDropzone">
                ...
                <div class="bv-dropzone__title">Arrastra archivos aquí</div>
                <div class="bv-dropzone__hint">o <span class="bv-dropzone__link" id="bvAttachBrowse">selecciona desde tu equipo</span></div>
                <div class="bv-dropzone__types">Máx 25 MB · PDF, IMG, DOC, XLS, ZIP</div>
            ...
            <div id="bvAttachList" style="display:none;margin-top:10px">
                <div class="bv-form-label" id="bvAttachListLabel">Archivos seleccionados</div>
                <div id="bvAttachItems" style="display:flex;flex-direction:column;gap:5px;margin-top:6px"></div>
            </div>

            {{-- Extra sources --}}
            <div style="display:flex;gap:6px;margin-top:12px">
                <button type="button" class="btn-secondary bv-attach-ext" data-source="drive" style="flex:1;font-size:12px">
                    <i class="fas fa-cloud me-1"></i> Desde Drive
                </button>
                <button type="button" class="btn-secondary bv-attach-ext" data-source="screenshot" style="flex:1;font-size:12px">
                    <i class="fas fa-image me-1"></i> Captura
                </button>
            </div>
