    ...
    <div class="bv-modal-dialog md">
        ...
        <div class="bv-modal-body">
            ...
            <div id="ncwStep1">
                ...
                <div class="bv-warn-callout d-none" id="ncwChannelWarning">
            ...
            <div id="ncwStep2" class="d-none">
                ...
                <div id="ncwHsmSection" class="d-none">
                    <div class="bv-form-field">
                    ...
                    <div class="bv-form-field d-none" id="ncwHsmPreview">
        ...
        <div class="bv-modal-foot">
            ...
            <button class="btn-secondary d-none" id="bv-ncw-back">{{ __('helpdesk::helpdesk.inbox.modals.newconv_back') }}</button>
