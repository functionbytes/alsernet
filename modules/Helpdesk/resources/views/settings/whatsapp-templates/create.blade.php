    ...
    <div class="card">
        ...
        <div class="card-body p-4">
            ...
            <form method="POST" action="{{ route('settings.helpdesk.whatsapp-templates.store') }}">
                ...
                <div class="mb-3">
                    <label for="name" class="form-label fw-semibold">Nombre técnico <span class="text-brand">*</span></label>
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                        <label for="category" class="form-label fw-semibold">Categoría <span class="text-brand">*</span></label>
                ...
                <div class="mb-3">
                    <label for="body" class="form-label fw-semibold">Cuerpo del mensaje <span class="text-brand">*</span></label>
...
@push('scripts')
<script>
window.WhatsappTemplateFormConfig = {
...
<script src="{{ asset('vendor/helpdesk/settings/whatsapp-templates-form.js') }}?v={{ @filemtime(public_path('vendor/helpdesk/settings/whatsapp-templates-form.js')) }}" defer></script>
@endpush
