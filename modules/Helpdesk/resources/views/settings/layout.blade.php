...
<style>
    ...
    .settings-card:hover {
        border-color: var(--primary);
        box-shadow: 0 2px 8px rgba(144, 187, 19, 0.1);
    }
    ...
    .alert-info {
        background: rgba(144, 187, 19, 0.1);
        border: 1px solid rgba(144, 187, 19, 0.3);
        border-radius: 8px;
        color: #7a9e10;
        padding: 1rem;
...
@section('content')
    ...
    <nav aria-label="breadcrumb" class="mb-3">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ safe_route('manager.helpdesk.tickets.index') }}">Helpdesk</a>
            </li>
