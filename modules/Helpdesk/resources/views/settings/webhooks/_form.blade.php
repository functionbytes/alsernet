<div class="row g-3">
    ...
    <div class="col-12 col-md-6">
        ...
        <input type="password" name="secret" class="form-control @error('secret') is-invalid @enderror"
            ...
            placeholder="{{ isset($webhook) && $webhook->getAttributes()['secret'] ? '••••••••••••' : 'Clave secreta opcional' }}">
        @if(isset($webhook) && $webhook->getAttributes()['secret'])
            <div class="form-text text-warning">
                <i class="fas fa-lock me-1"></i>Hay un secreto guardado. Deja vacío para conservarlo.
            </div>
        @else
