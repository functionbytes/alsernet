...
@section('page_header')
    @include('core::components.card', ['title' => $broadcast->name])
@endsection
                        ...
                        <div class="d-flex gap-2">
                            @if($broadcast->isDraft())
                                <form action="{{ route('settings.helpdesk.broadcasts.dispatch', $broadcast) }}" method="POST"
                                      class="needs-confirm"
                                      data-confirm-msg="¿Confirmas el envío de este broadcast a todos los destinatarios?">
                                    @csrf
                        ...
                        @if($broadcast->body)
                            <div class="col-12">
                                ...
                                <div class="bg-light rounded p-3 mt-1">
                                    <p class="mb-0 small text-prewrap">{{ $broadcast->body }}</p>
                                </div>
                            </div>
                        @endif
...
@push('styles')
<style>.text-prewrap { white-space: pre-wrap; }</style>
@endpush
