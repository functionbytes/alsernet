...
@section('content')
    ...
    <div class="card w-100">
        ...
        <form id="groupForm" method="POST" action="{{ route('settings.helpdesk.team.group.update', $group->id) }}">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <p class="text-muted mb-3">Datos principales del grupo</p>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                                ...
                                <p class="text-muted mb-0">Selecciona los agentes que formarán parte de este equipo</p>
                            </div>
                                    ...
                                    <thead class="table-light">
                                        <tr>
                                            <th scope="col" width="5%">
                                                <input type="checkbox" class="form-check-input cursor-pointer" id="selectAll">
                                            </th>
                                            <th scope="col" width="45%">Agente</th>
                                    ...
                                    <tbody>
                                        @foreach($agents as $index => $agent)
                                            ...
                                            <tr class="member-row">
                                                ...
                                                <td class="priority-cell" @class(['d-none' => ! $isMember])>
                    ...
                    <div class="col-12">
                        ...
                        <p class="text-muted mb-3">Configuración adicional del grupo</p>
                    </div>
            ...
            <div class="card-footer">
                ...
                <a href="{{ route('settings.helpdesk.team.groups') }}" class="btn btn-light px-4 waves-effect waves-light mt-2 w-100">
                    Cancelar
                </a>
            </div>
