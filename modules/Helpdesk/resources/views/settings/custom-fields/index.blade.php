...
@push('styles')
<style>
.hd-conversation-title { color: #6f42c1; }
.hd-badge-conversation { background-color: #f3eeff !important; color: #6f42c1 !important; }
</style>
@endpush
            ...
            <div class="card-body border-bottom">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <div class="card bg-light-secondary stat-card h-100">
                            <div class="card-body">
                                <h6 class="card-title mb-2 hd-conversation-title">Conversaciones</h6>
                                ...
                                @foreach($fields as $field)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="badge hd-badge-conversation">Conversacion</span>
                                            @endif
                                        </td>
                                        <td>
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item delete-btn" href="#"
                                                            ...
                                                            data-title="Eliminar campo: {{ $field->label }}">
                                                            Eliminar
                                                        </a>
                                                    </li>
                                                </ul>
