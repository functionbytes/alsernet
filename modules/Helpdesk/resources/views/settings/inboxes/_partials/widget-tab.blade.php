                ...
                <div class="border-top pt-4">
                    ...
                    <div class="input-group">
                        ...
                        <button type="button" class="btn btn-outline-secondary" onclick="copyWidgetHmacToken()">
                            <span id="wt_copy_hmac_label">Copiar</span>
                        </button>
                    </div>
                </div>
                @endif
                ...
                @foreach($snippetSamples as $cms => $snippet)
                    <div class="position-relative mb-3 wt-install-snippet @if($cms !== $currentCmsType) d-none @endif"
                        ...
                        <button type="button"
                            ...
                            <span class="wt-copy-label">Copiar</span>
                        </button>
                    </div>
                @endforeach
...
@push('scripts')
<script src="{{ asset('vendor/helpdesk/settings/widget-tab.js') }}?v={{ @filemtime(public_path('vendor/helpdesk/settings/widget-tab.js')) }}" defer></script>
@endpush
@endunless
