                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select name="is_public" class="form-select @error('is_public') is-invalid @enderror">
                                    <option value="0" {{ old('is_public', $view->is_public ? '1' : '0') === '0' ? 'selected' : '' }}>Privada — solo visible para mi</option>
                                    <option value="1" {{ old('is_public', $view->is_public ? '1' : '0') === '1' ? 'selected' : '' }}>Compartida — visible para todo el equipo</option>
                                </select>
                                @error('is_public')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
