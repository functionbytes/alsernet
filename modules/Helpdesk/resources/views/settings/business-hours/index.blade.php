    ...
    <form action="{{ route('settings.helpdesk.business-hours.update') }}" method="POST">
            ...
            <div class="card">
                ...
                <div class="card-header p-4 border-bottom border-light">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('settings.helpdesk.business-hours.reset') }}"
                            ...
                            onclick="return confirm('¿Restablecer los horarios a los valores predeterminados?')">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    <th class="ps-3" style="width: 160px">Día</th>
                                    <th class="text-center" style="width: 100px">Abierto</th>
                ...
                <div class="card-footer bg-white border-top p-3">
                    ...
                    <a href="{{ route('settings.helpdesk.tickets') }}" class="btn btn-light w-100">
                        Cancelar
                    </a>
                </div>
