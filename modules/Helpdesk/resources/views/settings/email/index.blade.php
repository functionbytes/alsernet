        ...
        <form method="POST" action="{{ route('settings.helpdesk.email.update') }}" id="emailSettingsForm">
            ...
            <div class="card mb-4">
                ...
                <div class="card-header p-4 border-bottom">
                    <h5 class="mb-1 fw-bold">Configuración de email</h5>
                    <p class="small mb-0 text-muted">Configura el remitente y las conexiones SMTP e IMAP del helpdesk</p>
                </div>
                ...
                <div class="card-body">
                    ...
                    {{-- Remitente --}}
                    <div class="mb-4">
                        <h6 class="fw-bold mb-1">Remitente</h6>
                    ...
                    {{-- SMTP --}}
                    <div class="mb-4">
                        <h6 class="fw-bold mb-1">Email saliente (SMTP)</h6>
                    ...
                    {{-- IMAP --}}
                    <div>
                        <h6 class="fw-bold mb-1">Email entrante (IMAP)</h6>
