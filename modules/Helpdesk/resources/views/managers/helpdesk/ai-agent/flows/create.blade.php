        ...
        <div class="col-lg-8 mx-auto">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('manager.helpdesk.ai-agent.flows.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-muted mb-3">¿Cuándo se debe activar este flujo?</p>
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    ...
                    <p class="text-muted mt-3">Después de crear el flujo, podrás diseñar los nodos de forma visual.</p>
                </div>
            </div>
        </div>
    </div>
