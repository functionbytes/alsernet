...
<div class="bv-modal" data-bv-modal-name="newconv">
    <div class="bv-modal-dialog">
        ...
        <div class="bv-modal-body">
            ...
            {{-- Step 1: Canal --}}
            <div id="ncStep1">
                <div class="mv4-sec-title" style="margin-bottom:10px">Elige un canal</div>
                <div class="nc-grid">
                ...
                <div id="ncHsmWarning" style="margin-top:14px;padding:10px 12px;background:#fffbeb;border:1px solid #fde68a;border-radius:9px;font-size:11.5px;color:#78350f;display:flex;gap:8px;align-items:flex-start">
            ...
            <div id="ncStep2" style="display:none">
                <div class="nc-field">
                    ...
                    <div class="mv4-search" style="margin-bottom:0">
                ...
                <button style="width:100%;padding:10px;border-radius:10px;border:1px dashed var(--bv-border);background:transparent;color:var(--bv-text-muted);font-size:12px;font-weight:500;display:flex;align-items:center;justify-content:center;gap:6px;margin-bottom:14px;cursor:pointer">
                    <i class="fas fa-user-plus"></i>Añadir contacto nuevo
                </button>

                <div class="nc-field">
                    <div class="lbl">Asignar a</div>
                    <select>
                        <option>María López (yo)</option>
                        <option>Carlos Ruiz</option>
                        <option>Ana Torres</option>
                        <option>Equipo · Soporte N1</option>
                    </select>
                </div>

                <div class="nc-field">
                    <div class="lbl">Primer mensaje</div>
                    <textarea placeholder="Hola, soy María del equipo de soporte. ¿En qué puedo ayudarte?"></textarea>
                </div>
            </div>
        ...
        <div class="bv-modal-foot">
            ...
            <div style="margin-left:auto;display:flex;gap:8px">
                <button class="btn-secondary" id="ncBtnBack" style="display:none"><i class="fas fa-chevron-left"></i> Atrás</button>
...
(function() {
    ...
    $(document).on('click', '#ncBtnNext', function() {
        if (step === 1) {
            ...
            window.BvModal && window.BvModal.close('newconv');
            toastr.success('Conversación iniciada');
        }
    });
    ...
    $(document).on('click', '.nc-contact-card', function() {
        ...
        $('.nc-contact-card').css('border-color', 'transparent');
        $(this).css('border-color', 'var(--bv-border-strong)');
    });
