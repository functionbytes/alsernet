            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <p class="text-muted mb-3">Define el nombre y las características básicas del tag. El nombre será visible para los usuarios.</p>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <p class="text-muted mb-3">El color ayuda a identificar visualmente el tag en la interfaz. Selecciona un color distintivo para facilitar su reconocimiento.</p>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <p class="text-muted mb-3">Configura la disponibilidad del tag en el sistema.</p>
                    </div>
