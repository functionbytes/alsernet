        ...
        <div class="card">
            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('manager.helpdesk.settings.webhooks.create') }}" class="btn btn-primary">
                        Nuevo webhook
                    </a>
                </div>
            </div>
            ...
            {{-- Search --}}
            <div class="card-body border-bottom">
                <form method="GET" action="{{ route('manager.helpdesk.settings.webhooks.index') }}">
                                        ...
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('manager.helpdesk.settings.webhooks.edit', $webhook) }}">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <button class="dropdown-item btn-delete"
                                                            data-id="{{ $webhook->id }}"
                                                            data-url="{{ route('manager.helpdesk.settings.webhooks.destroy', $webhook) }}"
                    ...
                    <div class="text-center py-5">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            @unless(request('search'))
                                <a href="{{ route('manager.helpdesk.settings.webhooks.create') }}" class="btn btn-sm btn-primary">
