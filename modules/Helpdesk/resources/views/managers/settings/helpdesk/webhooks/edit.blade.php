...
@section('content')
    ...
    <div class="row g-3">
        <div class="col-12 col-lg-8">
            <div class="card">
                <form action="{{ route('manager.helpdesk.settings.webhooks.update', $webhook) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        @include('helpdesk::managers.settings.helpdesk.webhooks._form')
                    </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('manager.helpdesk.settings.webhooks.index') }}" class="btn btn-light w-100">
                            Cancelar
                        </a>
                    </div>
                </form>
