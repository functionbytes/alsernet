        ...
        <div class="card">
            <div class="card-header bg-light d-flex justify-content-between align-items-center p-4">
                <div>
                    ...
                    <p class="text-muted mb-0 mt-1">Arrastra para reordenar</p>
                </div>
            ...
            <div class="card-body p-4">
                ...
                <!-- Empty State -->
                <div id="empty-state" class="text-center py-5 bv-hidden">
                    <div class="mb-3">
                        <i class="fa fa-folder-open text-muted bv-text-4xl"></i>
                    </div>
                ...
                <!-- Items List -->
                <div id="items-container" class="bv-hidden">
