        ...
        <div class="col-auto">
          <div class="d-flex gap-2 align-items-center">
            <span class="badge bg-light-info text-info rounded-3 py-2 px-3 fs-3">
              <i class="far fa-folder me-1"></i> {{ $category->sections_count }} Secciones
            </span>
            <span class="badge bg-light-success text-success rounded-3 py-2 px-3 fs-3">
              <i class="far fa-file-lines me-1"></i> {{ $category->articles_count }} Artículos
            </span>
          </div>
        </div>
        <div class="col-auto">
    ...
    <div class="card card-body">
                ...
                <tr class="search-items">
                  ...
                  <td>
                    <span class="badge bg-light-secondary text-secondary rounded-3 py-2 px-3">
                      <i class="far fa-file-lines"></i> {{ $section->articles_count }}
                    </span>
                  </td>
                  <td>
                      ...
                      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <li>
                          <a class="dropdown-item d-flex align-items-center gap-3"
                            ...
                            <i class="far fa-eye"></i> Ver Sección
                          </a>
                        </li>
                        <li>
                          <a class="dropdown-item d-flex align-items-center gap-3"
      ...
      @else
        <div class="text-center py-5">
          <i class="far fa-folder-open text-muted bv-text-4xl bv-opacity-30"></i>
