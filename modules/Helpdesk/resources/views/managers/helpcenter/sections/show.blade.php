      ...
      <div class="row align-items-center">
        ...
        <div class="col-3">
          <div class="text-center mb-n5">
            <img src="/managers/images/breadcrumb/ChatBc.png" alt="" class="img-fluid mb-n4 bv-max-h-120">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="card-body">
        <div class="d-flex align-items-center gap-3">
          <div class="flex-shrink-0">
            <i class="fas fa-circle-info text-info fs-7"></i>
          </div>
        ...
        <div class="col-auto">
          <div class="d-flex gap-2 align-items-center">
            <span class="badge bg-light-info text-info rounded-3 py-2 px-3 fs-3">
              <i class="far fa-file-lines me-1"></i> {{ $section->articles_count }} Artículos
            </span>
            <span class="badge bg-light-success text-success rounded-3 py-2 px-3 fs-3">
              <i class="fas fa-check me-1"></i> {{ $section->articles->where('draft', false)->count() }} Publicados
            </span>
            <span class="badge bg-light-warning text-warning rounded-3 py-2 px-3 fs-3">
              <i class="far fa-file-pen me-1"></i> {{ $section->articles->where('draft', true)->count() }} Borradores
            </span>
          </div>
        </div>
        <div class="col-auto">
    ...
    <div class="card card-body">
                  ...
                  <td>
                    @if($article->draft)
                      <span class="badge bg-light-warning text-warning rounded-3 py-2 px-3">
                        <i class="far fa-file-pen"></i> Borrador
                      </span>
                    @else
                      <span class="badge bg-light-success text-success rounded-3 py-2 px-3">
                        <i class="fas fa-check"></i> Publicado
                      </span>
                    @endif
                  </td>
                  <td>
      ...
      @else
        <div class="text-center py-5">
          <i class="far fa-file-circle-question text-muted bv-text-4xl bv-opacity-30"></i>
