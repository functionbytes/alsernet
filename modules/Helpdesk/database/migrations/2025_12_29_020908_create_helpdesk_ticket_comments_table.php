...
return new class extends Migration
{
    ...
    {
        Schema::connection($this->connection)->create('helpdesk_ticket_comments', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection($this->connection)->dropIfExists('helpdesk_ticket_comments');
    }
};
