...
return new class extends Migration
{
    ...
    {
        Schema::table('helpdesk_ticket_comments', function (Blueprint $table): void {
            $table->index('user_id');
        });

        Schema::table('helpdesk_ticket_notes', function (Blueprint $table): void {
            $table->index('user_id');
        });

        Schema::table('helpdesk_conversation_items', function (Blueprint $table): void {
            $table->index('user_id');
