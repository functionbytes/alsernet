...
class WidgetConversationSecurityTest extends TestCase
{
    ...
    {
        $this->getJson(route('conversations.show', $this->conversation->id))
            ->assertForbidden()
    ...
    {
        $this->getJson(route('conversations.show', $this->conversation->id).'?customer_email='.urlencode($this->customer->email))
            ->assertOk()
    ...
    {
        $this->getJson(route('conversations.messages.index', $this->conversation->id))
            ->assertForbidden()
    ...
    {
        $this->getJson(route('conversations.messages.index', $this->conversation->id).'?customer_email='.urlencode($this->customer->email))
            ->assertOk()
