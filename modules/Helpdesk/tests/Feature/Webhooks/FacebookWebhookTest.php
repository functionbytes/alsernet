...
class FacebookWebhookTest extends TestCase
{
    ...
    public function test_facebook_webhook_skips_signature_check_when_no_secret_configured(): void
    {
        Queue::fake();
        ...
        // No signature header — should still pass because app_secret is empty
        $this->postJson(route('webhooks.facebook.handle'), $payload)
            ->assertOk();

        Queue::assertPushed(ProcessSocialWebhookJob::class);
    }
