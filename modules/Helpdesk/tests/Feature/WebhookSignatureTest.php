...
class WebhookSignatureTest extends TestCase
{
    ...
    public function test_signature_rejected_when_no_secret_configured(): void
    {
        config(['helpdesk.integrations.whatsapp.app_secret' => '']);

        // Fail-closed: sin secreto configurado (fuera de entorno local) la
        // verificación de firma se rechaza en lugar de omitirse.
        $this->assertFalse($this->makeService()->verifySignature('any body', 'sha256=anything'));
    }
