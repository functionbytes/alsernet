...
class Workflow extends Model
{
    ...
    public const ACTION_TYPES = [
        ...
        // 'send_email' retirado: WorkflowEngine::executeAction() no implementa handler
        // para esta accion (caia en el `default` no-op), por lo que la UI ofrecia una
        // accion que el motor ignoraba silenciosamente. Reintroducir solo cuando exista
        // un handler real en WorkflowEngine.
