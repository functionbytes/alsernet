...
class RouteServiceProvider extends ServiceProvider
{
    ...
    protected function mapWebRoutes(): void
    {
        ...
        // Manager routes: acceso a cualquier usuario con permiso helpdesk.view
        // (cada controller/policy aplica su propio permiso granular)
        // Require2FA is a no-op unless helpdesk.require_2fa[_for_admins] is enabled;
        // it self-exempts the manager.helpdesk.2fa.* routes to avoid a redirect loop.
