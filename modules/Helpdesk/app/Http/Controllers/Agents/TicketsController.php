...
class TicketsController extends Controller
{
    public function index(Request $request): View
    {
        ...
        return view('helpdesk::agents.tickets.index', compact('tickets', 'statuses'));
    }
    ...
    public function create(): View
    {
        ...
        return view('helpdesk::agents.tickets.create', compact('categories', 'customers'));
    }
    ...
    public function show(Ticket $ticket): View
    {
        ...
        return view('helpdesk::agents.tickets.show', compact('ticket', 'statuses'));
    }
    ...
    public function edit(Ticket $ticket): View
    {
        ...
        return view('helpdesk::agents.tickets.edit', compact('ticket', 'categories', 'statuses'));
    }
