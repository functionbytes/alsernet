...
class AgentsController extends Controller
{
    public function index(): View
    {
        ...
        return view('helpdesk::helpdesk.agents.index', compact('agents'));
    }
    ...
    public function show(User $agent, TicketServiceContract $tickets): View
    {
        $this->authorize('helpdesk.manage');

        $data = $tickets->getAgentDashboardData($agent->id);

        return view('helpdesk::helpdesk.agents.show', [
            'agent' => $agent,
            'stats' => $data['stats'],
    ...
    public function edit(User $agent): View
    {
        ...
        return view('helpdesk::helpdesk.agents.edit', compact('agent', 'agentSettings'));
    }
