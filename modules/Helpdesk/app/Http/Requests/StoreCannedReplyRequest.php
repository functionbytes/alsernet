...
class StoreCannedReplyRequest extends FormRequest
{
    ...
    {
        return $this->user()->can('helpdesk.canned-replies.create');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'shortcut' => ['nullable', 'string', 'max:50', Rule::unique('helpdesk.helpdesk_canned_replies', 'shortcut')->whereNull('deleted_at')],
