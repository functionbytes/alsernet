                ...
                <form id="formRedirect" action="{{ route('settings.seo.redirects.update', $redirect) }}" method="POST" novalidate>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('is_active') is-invalid @enderror select2"
                                    id="isActive"
                                    name="is_active"
                                    required>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="is_regex" id="is_regex" value="1"
                                       {{ old('is_regex', $redirect->is_regex) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" name="is_wildcard" id="is_wildcard" value="1"
                                       {{ old('is_wildcard', $redirect->is_wildcard) ? 'checked' : '' }}>
                    ...
                    <div class="col-12">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label class="control-label col-form-label">
                                    Activo desde <small class="text-muted">(opcional)</small>
                                </label>
                                <input type="datetime-local" name="active_from"
                                       class="form-control @error('active_from') is-invalid @enderror"
                                       value="{{ old('active_from', $redirect->active_from?->format('Y-m-d\TH:i')) }}">
                                @error('active_from')
                                    <span class="field-validation-error"><i class="fa fa-circle-exclamation"></i> {{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <label class="control-label col-form-label">
                                    Activo hasta <small class="text-muted">(opcional)</small>
                                </label>
                                <input type="datetime-local" name="active_until"
                                       class="form-control @error('active_until') is-invalid @enderror"
                                       value="{{ old('active_until', $redirect->active_until?->format('Y-m-d\TH:i')) }}">
                                @error('active_until')
                                    <span class="field-validation-error"><i class="fa fa-circle-exclamation"></i> {{ $message }}</span>
                                @else
                                    <small class="form-text text-muted">Si se establece, la redirección expirará automáticamente</small>
                                @enderror
                            </div>
                        </div>
                    </div>
