...
@section('content')
    ...
    <div class="widget-content">
        <form id="form-menu" action="{{ route('menu.update', $menu) }}" method="POST">
            @csrf
            @method('PUT')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <div class="dd nestable-menu" id="nestable" data-depth="3">
                                @include('menu::partials.menu', ['menu_nodes' => $menu->items, 'menu' => $menu])
                            </div>
...
class MenuNestable {
    constructor() {
        ...
        this.nodeUrl    = '{{ route("menu.get-node", $menu) }}';
    }
