...
<head>
    ...
    {{-- Fix global: dropdowns de acciones dentro de tablas se despliegan hacia ARRIBA
         y no los recorta la tabla/card. Acotado a celdas (td) para NO afectar al
         navbar, filtros, select2 u otros dropdowns. transform:none anula Popper. --}}
    <style>
        .table-responsive { overflow: visible !important; }
        td .dropdown { position: relative !important; }
        ...
        /* La columna de acciones suele ir a la derecha → alinear el menú a la derecha. */
        td .dropdown .dropdown-menu.dropdown-menu-end { left: auto !important; right: 0 !important; }
    </style>
...
<script src="{{ themeAsset('js/theme/sidebarmenu.js') }}?v=2"></script>
