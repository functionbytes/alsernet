...
@section('title', 'Editar política SLA: ' . $policy->name)
...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <div>
            <h4 class="mb-0 fw-bold">Editar: {{ $policy->name }}</h4>
            <p class="text-muted mb-0">Modifica los parámetros de la política SLA</p>
        </div>
    </div>
    ...
    <div class="card">
        <form method="POST" action="{{ route('manager.helpdesk.backups.tickets.sla-policies.update', $policy->id) }}">
            @csrf
            @method('PUT')
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="timezone" class="form-select @error('timezone') is-invalid @enderror" required>
                            @foreach(timezone_identifiers_list() as $tz)
                                <option value="{{ $tz }}" {{ old('timezone', $policy->timezone) === $tz ? 'selected' : '' }}>
                                    {{ $tz }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-check form-switch">
                            ...
                            <input type="checkbox" name="enable_escalation" class="form-check-input" id="enableEscalation"
                                   value="1" {{ old('enable_escalation', $policy->enable_escalation) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6" id="escalationThresholdWrap"
                         style="{{ old('enable_escalation', $policy->enable_escalation) ? '' : 'display:none;' }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-check form-switch">
                            ...
                            <input type="checkbox" name="business_hours_only" class="form-check-input" id="businessHours"
                                   value="1" {{ old('business_hours_only', $policy->business_hours_only) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        <div class="form-check form-switch">
                            ...
                            <input type="checkbox" name="active" class="form-check-input" id="active"
                                   value="1" {{ old('active', $policy->active) ? 'checked' : '' }}>
