...
@section('title', 'Nueva prioridad de ticket')

@section('page_header')
    @include('core::components.card', ['title' => 'Nueva prioridad de ticket'])
@endsection
            ...
            <div class="card">
                <form id="priorityForm" action="{{ route('manager.helpdesk.settings.ticket-priorities.store') }}" method="POST">
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="response_time_hours" min="1"
                                           ...
                                           value="{{ old('response_time_hours', 24) }}"
                                           required>
                            ...
                            <div class="col-12 col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="resolution_time_hours" min="1"
                                           ...
                                           value="{{ old('resolution_time_hours', 72) }}"
                                           required>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary w-100 mb-1">Guardar prioridad</button>
