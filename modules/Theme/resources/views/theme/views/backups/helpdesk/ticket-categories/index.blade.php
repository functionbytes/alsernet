...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">Organiza los tickets por categoría para un mejor seguimiento</p>
        </div>
        <div class="d-flex gap-2">
            @if(request('search'))
                <a href="{{ route('manager.helpdesk.backups.tickets.categories.index') }}" class="btn btn-outline-secondary">
                    <i class="fas fa-times me-1"></i> Limpiar
                </a>
            @endif
            <a href="{{ route('manager.helpdesk.backups.tickets.categories.create') }}" class="btn btn-primary">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-6 col-md-3">
            <div class="card h-100">
                <div class="card-body">
                    <p class="text-info small mb-1">Con SLA</p>
                    <h4 class="fw-bold mb-0">{{ $stats['with_sla'] }}</h4>
                    ...
                    <div class="col-md-9">
                        <div class="input-group">
                            ...
                            <input type="search" name="search" class="form-control border-start-0"
                                   placeholder="Buscar por nombre, slug o descripción..." value="{{ request('search') }}">
                        </div>
                    </div>
                    <div class="col-md-3">
        ...
        <div class="card-body p-0">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            @if($category->icon)
                                                <i class="{{ $category->icon }}"
                                                   style="color:{{ $category->color ?? '#90bb13' }}; font-size:1.1rem;"></i>
                                            @else
                                    ...
                                    <td class="text-center align-middle">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li>
                                                    <form method="POST" action="{{ route('manager.helpdesk.backups.tickets.categories.toggle', $category->id) }}">
                                                        @csrf
                                                        @method('PATCH')
                                                        <button type="submit" class="dropdown-item">
                                                            <i class="fas fa-toggle-{{ $category->active ? 'off' : 'on' }} me-2"></i>
            ...
            @else
                <div class="text-center py-5">
                    ...
                    @if(!request('search'))
                        <a href="{{ route('manager.helpdesk.backups.tickets.categories.create') }}" class="btn btn-primary btn-sm mt-2">
