    ...
    private static function welcome(): array
    {
        return [
            ...
            'html_content' => self::wrap('¡Bienvenido/a, <strong>{{firstName}}</strong>!',
                ...
                <p><a href="{{storeDomain}}" style="display:inline-block;background:#90bb13;color:#fff;padding:12px 28px;border-radius:4px;text-decoration:none;font-weight:600;">Ver tienda</a></p>
    ...
    private static function abandonedCart(): array
    {
        return [
            ...
            'html_content' => self::wrap('Tu carrito te echa de menos',
                ...
                <p><a href="{{cartUrl}}" style="display:inline-block;background:#90bb13;color:#fff;padding:12px 28px;border-radius:4px;text-decoration:none;font-weight:600;">Completar compra</a></p>
    ...
    private static function winBack(): array
    {
        return [
            ...
            'html_content' => self::wrap('¡Cuánto tiempo, {{firstName}}!',
                ...
                <p style="font-size:28px;font-weight:700;color:#90bb13;text-align:center;letter-spacing:4px;">BIENVENIDO10</p>
                <p style="text-align:center;"><a href="{{storeDomain}}" style="display:inline-block;background:#90bb13;color:#fff;padding:12px 28px;border-radius:4px;text-decoration:none;font-weight:600;">Volver a la tienda</a></p>
                <p style="font-size:12px;color:#999;"><a href="{{unsubscribeUrl}}" style="color:#999;">Cancelar suscripción</a></p>'),
        ];
    }
    ...
    private static function promotional(): array
    {
        return [
            ...
            'html_content' => self::wrap('¡Oferta exclusiva!',
                ...
                <p style="text-align:center;"><a href="{{storeDomain}}" style="display:inline-block;background:#90bb13;color:#fff;padding:12px 28px;border-radius:4px;text-decoration:none;font-weight:600;">Ver oferta</a></p>
                <p style="font-size:12px;color:#999;"><a href="{{unsubscribeUrl}}" style="color:#999;">Cancelar suscripción</a></p>'),
        ];
    }
