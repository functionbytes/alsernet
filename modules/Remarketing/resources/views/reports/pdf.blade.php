...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        h1 { font-size: 18px; color: #90bb13; margin: 0 0 4px; }
        .subtitle { color: #666; font-size: 10px; margin-bottom: 20px; }
        h2 { font-size: 13px; color: #444; border-bottom: 2px solid #90bb13; padding-bottom: 4px; margin: 20px 0 10px; }
        ...
        .kpi-value { font-size: 16px; font-weight: bold; color: #90bb13; display: block; margin-bottom: 2px; }
        .kpi-label { font-size: 9px; color: #777; }
        table { width: 100%; border-collapse: collapse; }
        thead th { background: #90bb13; color: #fff; padding: 6px 8px; text-align: left; font-size: 10px; }
