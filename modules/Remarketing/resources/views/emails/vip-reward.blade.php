...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #333333;">
    ...
    <div style="border: 2px solid #90bb13; border-radius: 6px; padding: 24px; margin-bottom: 24px; text-align: center;">
        <div style="font-size: 48px; margin-bottom: 12px;">&#127942;</div>
        <p style="margin: 0 0 8px; font-size: 18px; font-weight: bold; color: #90bb13;">
