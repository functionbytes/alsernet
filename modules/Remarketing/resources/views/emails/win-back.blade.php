...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #333333;">
    ...
    <div style="border: 2px dashed #b10100; border-radius: 6px; padding: 24px; margin-bottom: 24px; text-align: center;">
        ...
        <div style="font-size: 36px; font-weight: bold; color: #b10100; letter-spacing: 2px;">
            VUELVE10
        </div>
