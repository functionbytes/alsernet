                    ...
                    <div class="list-group-item bg-transparent border-0 px-0">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <a href="{{ route('admin.conversation.show', $conversation) }}" class="text-decoration-none">
            ...
            <div class="card mb-4">
                ...
                @if($activePolicies->count() > 0)
                    <div class="card-footer">
                        <a href="{{ route('admin.sla-policies.index') }}" class="btn btn-sm btn-outline-primary w-100">
                            Manage Policies
                        </a>
                    </div>
                @endif
