...
@section('content')
    ...
    @include('helpdeskchat::includes.card', ['title' => 'Clientes del Groups', 'icon' => 'fa-user-friends'])
            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        @if(request('search'))
                            <a href="{{ route('admin.customers.index', ['tab' => request('tab', 'all')]) }}"
                               class="btn btn-light">
                ...
                <ul class="nav nav-pills gap-2 mb-0" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ !request('tab') || request('tab') === 'all' ? 'active' : '' }}"
                           href="{{ route('admin.customers.index', array_merge(request()->except('tab'), ['tab' => 'all'])) }}">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ request('tab') === 'verified' ? 'active' : '' }}"
                           href="{{ route('admin.customers.index', array_merge(request()->except('tab'), ['tab' => 'verified'])) }}">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ request('tab') === 'active' ? 'active' : '' }}"
                           href="{{ route('admin.customers.index', array_merge(request()->except('tab'), ['tab' => 'active'])) }}">
                    ...
                    <li class="nav-item" role="presentation">
                        <a class="nav-link {{ request('tab') === 'banned' ? 'active' : '' }}"
                           href="{{ route('admin.customers.index', array_merge(request()->except('tab'), ['tab' => 'banned'])) }}">
                            <i class="fa fa-ban"></i>
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            <h6 class="mb-0 fw-semibold">
                                                <a href="{{ route('admin.customers.show', $customer->id) }}" class="text-dark text-decoration-none">
                                                    {{ $customer->name }}
                                                </a>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            @if(!$customer->is_banned)
                                                ...
                                                <li>
                                                    <form method="POST" action="{{ route('admin.customers.ban', $customer->id) }}">
                                                        @csrf
                                            ...
                                            @else
                                                <li><hr class="dropdown-divider"></li>
                                                <li>
                                                    <form method="POST" action="{{ route('admin.customers.unban', $customer->id) }}">
                                                        @csrf
