            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @if($currentTab === 'general')
                        @include('admin.views.helpdesk.campaigns.tabs.general', ['campaign' => $campaign])
                    @endif

                    {{-- Content Tab --}}
                    @if($currentTab === 'content')
                        @include('admin.views.helpdesk.campaigns.tabs.content', ['campaign' => $campaign])
                    @endif

                    {{-- Appearance Tab --}}
                    @if($currentTab === 'appearance')
                        @include('admin.views.helpdesk.campaigns.tabs.appearance', ['campaign' => $campaign])
                    @endif

                    {{-- Conditions Tab --}}
                    @if($currentTab === 'conditions')
                        @include('admin.views.helpdesk.campaigns.tabs.conditions', ['campaign' => $campaign])
                    @endif
                </div>
            </div>
        </div>
