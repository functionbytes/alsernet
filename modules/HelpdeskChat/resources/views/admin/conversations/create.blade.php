...
@section('title', 'Crear Conversación - Groups')

@section('content')

    @include('admin.includes.card', ['title' => 'Crear Conversación'])

    <div class="widget-content searchable-container list">

        @include('admin.components.alerts')

        <form method="POST" action="{{ route('manager.helpdesk.conversation.store') }}">
            @csrf
            ...
            <div class="card">
                ...
                <div class="card-footer d-flex justify-content-between align-items-center p-4">
                    <a href="{{ route('manager.helpdesk.conversation.index') }}" class="btn btn-light">
