...
@section('title', 'Editar Conversación - Groups')

@section('content')

    @include('admin.includes.card', ['title' => 'Editar Conversación'])

    <div class="widget-content searchable-container list">

        @include('admin.components.alerts')

        <form method="POST" action="{{ route('manager.helpdesk.conversation.update', $conversation) }}">
            @csrf
            @method('PUT')
                ...
                <div class="card-header p-4 border-bottom border-light">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex gap-2">
                            <a href="{{ route('manager.helpdesk.conversation.show', $conversation) }}" class="btn btn-light">
                ...
                <div class="card-footer d-flex justify-content-between align-items-center p-4">
                    <div class="d-flex gap-2">
                        ...
                        @if($conversation->isOpen())
                            <form action="{{ route('manager.helpdesk.conversation.close', $conversation) }}" method="POST" class="d-inline">
                                @csrf
                        ...
                        @else
                            <form action="{{ route('manager.helpdesk.conversation.reopen', $conversation) }}" method="POST" class="d-inline">
                                @csrf
                    ...
                    <div class="d-flex gap-2">
                        <form action="{{ route('manager.helpdesk.conversation.destroy', $conversation) }}"
                              method="POST"
                              class="d-inline"
