...
@section('content')
    ...
    @include('admin.includes.card', ['title' => 'Miembros del equipo'])
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card">
            ...
            <!-- Filters -->
            <div class="card-body border-bottom">
                <form method="GET" action="{{ route('manager.helpdesk.settings.tickets.team.members') }}"
                      id="filterForm">
                    <div class="row g-3">
                        <div class="col-md-6">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item"
                                                       href="{{ route('manager.helpdesk.settings.tickets.team.member.edit', $member->id) }}">
                                                        Editar
                                                    </a>
                                                </li>
                                            </ul>
