...
@section('content')
    ...
    @include('admin.includes.card', ['title' => 'Grupos de Equipo'])
            ...
            <div class="card-header p-4 border-bottom border-light">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('manager.helpdesk.settings.tickets.team.members') }}"
                           class="btn btn-secondary">
                            Ver miembros
                        </a>
                        <a href="{{ route('manager.helpdesk.settings.tickets.team.group.create') }}"
            ...
            <div class="card-body">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                <li>
                                                    <a class="dropdown-item"
                                                       href="{{ route('manager.helpdesk.settings.tickets.team.group.edit', $group->id) }}">
                                                        Editar
                                                    </a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <form method="POST"
                                                          action="{{ route('manager.helpdesk.settings.tickets.team.group.destroy', $group->id) }}"
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        @else
                            <a href="{{ route('manager.helpdesk.settings.tickets.team.groups') }}"
                               class="btn btn-secondary">
                                Limpiar búsqueda
                            </a>
                        @endif
