...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.webhooks.store') }}" method="POST">
                        ...
                        <!-- Inbox (conditional) -->
                        <div class="mb-3" id="inbox-field" style="display: none;">
                            ...
                            @foreach($events as $value => $label)
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="subscriptions[]"
                                           ...
                                           {{ in_array($value, old('subscriptions', [])) ? 'checked' : '' }}>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="fa fa-save me-1"></i> Create Webhook
                            </button>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mt-3">
                <div class="card-header bg-light">
                    <h6 class="mb-0">Webhook Types</h6>
                </div>
                <div class="card-body">
                    <small>
                        <strong>Account Level:</strong> Receives events from all inboxes in your account<br><br>
                        <strong>Inbox Level:</strong> Only receives events from a specific inbox
                    </small>
                </div>
            </div>
        </div>
