...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        ...
        <div class="col-12 col-md-6 col-lg-3 mb-3 mb-md-0">
            <div class="card bg-light">
                <div class="card-body">
                    <h6 class="card-title text-success mb-2">Public</h6>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        @if(request('search') || request('scope'))
                            <a href="{{ route('manager.helpdesk.settings.tickets.views.index') }}" class="btn btn-secondary w-100 mt-2">
                                Clear
                            </a>
                        @endif
                    </div>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            @if($view->canEdit(Auth::id()))
                                                <a href="{{ route('manager.helpdesk.settings.tickets.views.edit', $view->id) }}" class="btn btn-outline-secondary" title="Edit">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                            @endif
                                            @if($view->canDelete())
                                                <button type="button" class="btn btn-outline-danger" title="Delete"
                                                    onclick="confirmDelete('{{ route('manager.helpdesk.settings.tickets.views.destroy', $view->id) }}')">
