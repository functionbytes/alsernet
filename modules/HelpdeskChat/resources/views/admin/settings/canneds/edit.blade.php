...
<div class="container-fluid">
    <div class="row mb-3">
        <div class="col">
            <h1 class="h3">Edit canned response</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.canneds.index') }}">Canned responses</a></li>
                    <li class="breadcrumb-item active">Edit: /{{ $cannedResponse->short_code }}</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 col-lg-8">
            <div class="card">
                <div class="card-body">
                    <form id="cannedForm" action="{{ route('admin.canneds.update', $cannedResponse) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                    id="title" name="title" value="{{ old('title', $cannedResponse->title) }}"
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control @error('short_code') is-invalid @enderror"
                                        id="short_code" name="short_code" value="{{ old('short_code', $cannedResponse->short_code) }}"
                            ...
                            <div class="col-12 col-md-6 mb-3">
                                ...
                                <select class="form-select @error('visibility') is-invalid @enderror" id="visibility" name="visibility">
                                    <option value="personal" {{ old('visibility', $cannedResponse->visibility) === 'personal' ? 'selected' : '' }}>
                                        Personal - Only visible to me
                                    </option>
                                    <option value="team" {{ old('visibility', $cannedResponse->visibility) === 'team' ? 'selected' : '' }}>
                                        Team - Visible to my team members
                                    </option>
                                    <option value="everyone" {{ old('visibility', $cannedResponse->visibility) === 'everyone' ? 'selected' : '' }}>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <input type="text" class="form-control @error('description') is-invalid @enderror"
                                    id="description" name="description" value="{{ old('description', $cannedResponse->description) }}"
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('content') is-invalid @enderror"
                                    id="content" name="content" rows="8">{{ old('content', $cannedResponse->content) }}</textarea>
                                @error('content')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            @if($cannedResponse->usage_count > 0)
                                <div class="col-12 mb-3">
                                    <div class="alert alert-info">
                                        <i class="fa fa-info-circle me-1"></i>
                                        This response has been used <strong>{{ $cannedResponse->usage_count }}</strong> time{{ $cannedResponse->usage_count !== 1 ? 's' : '' }}.
                                        @if($cannedResponse->last_used_at)
                                            Last used {{ $cannedResponse->last_used_at->diffForHumans() }}.
                                        @endif
                                    </div>
                                </div>
                            @endif
                            ...
                            <div class="col-12">
                                <div class="d-flex gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fa fa-check-circle me-1"></i> Update response
                                    </button>
