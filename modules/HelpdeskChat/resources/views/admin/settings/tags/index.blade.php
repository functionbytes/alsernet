        ...
        <div class="card-header border-bottom p-3">
            <div class="row g-3 align-items-end">
                <div class="col-12 col-md-5">
                    ...
                    <form method="GET" action="{{ route('manager.helpdesk.settings.tickets.tags.index') }}" class="d-flex gap-2">
                ...
                <div class="col-12 col-md-4 text-end">
                    @if(request('search') || request('status'))
                        <a href="{{ route('manager.helpdesk.settings.tickets.tags.index') }}" class="btn btn-secondary btn-sm">
                            Clear filters
                        </a>
                    @endif
                </div>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group btn-group-sm" role="group">
                                            <a href="{{ route('manager.helpdesk.settings.tickets.tags.edit', $tag->id) }}"
            ...
            @else
                <div class="text-center py-5">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        @if(!request('search'))
                            <a href="{{ route('manager.helpdesk.settings.tickets.tags.create') }}" class="btn btn-primary btn-sm">
...
$(document).ready(function() {
    ...
    $('.delete-tag').on('click', function() {
        ...
        const deleteRoute = '{{ route("manager.helpdesk.settings.tickets.tags.destroy", ":id") }}'.replace(':id', tagId);
