            ...
            <form action="{{ route('admin.teams.update', $team) }}" method="POST">
                ...
                <div class="mb-3">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="allow_auto_assign"
                            name="allow_auto_assign" value="1"
                            {{ old('allow_auto_assign', $team->allow_auto_assign) ? 'checked' : '' }}>
                        ...
                        @forelse($users as $user)
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox"
                                    ...
                                    name="member_ids[]"
                                    value="{{ $user->id }}"
                                    {{ in_array($user->id, old('member_ids', $teamMemberIds)) ? 'checked' : '' }}>
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">
                        <i class="fa fa-check-circle me-1"></i> Update Team
                    </button>
