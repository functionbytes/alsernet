            ...
            <div class="row align-items-center">
                <div class="col-9">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('manager.helpdesk.conversation.index') }}">Helpdesk</a></li>
                ...
                <div class="col-3">
                    <div class="text-center mb-n5">
                        <img src="{{ asset('admin/images/breadcrumb/ChatBc.png') }}" alt="" class="img-fluid mb-n4" style="max-height: 150px;">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="tab-content mt-4" id="aiAgentTabContent">
                ...
                <div class="tab-pane fade show active" id="tab-settings" role="tabpanel">
                    @include('admin.views.helpdesk.ai-agent.partials.settings-tab', ['agent' => $agent, 'providers' => $providers, 'statuses' => $statuses])
                </div>
...
<!-- Modals -->
@include('admin.views.helpdesk.ai-agent.modals.tag-modal')
@include('admin.views.helpdesk.ai-agent.modals.tool-modal')
@include('admin.views.helpdesk.ai-agent.modals.knowledge-modal')
