...
<head>
    ...
    <!-- Library CSS -->
    <link rel="stylesheet" href="{{ url('admin/libs/taginput/bootstrap-tagsinput.css') }}">
    <link rel="stylesheet" href="{{ url('admin/libs/owl.carousel/dist/assets/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ url('admin/libs/select2/dist/css/select2.min.css') }}">
    <link rel="stylesheet" href="{{ url('admin/libs/quill/dist/quill.snow.css') }}">
    <link rel="stylesheet" href="{{ url('admin/libs/toastr/toastr.css') }}">
    <link rel="stylesheet" href="{{ url('admin/libs/dropzone/dist/min/dropzone.min.css') }}">
    <link rel="stylesheet" href="{{ url('admin/libs/daterangepicker/daterangepicker.css') }}">

    <!-- Font Awesome Icons -->
    <link rel="stylesheet" href="{{ url('admin/libs/fontawesome/fontawesome.css') }}"

    <!-- Theme CSS -->
    <link rel="stylesheet" href="{{ url('admin/css/style.css') }}">
    <link rel="stylesheet" href="{{ url('admin/css/extra.css') }}">
...
<script src="{{ url('admin/libs/simplebar/dist/simplebar.min.js') }}"></script>
<script src="{{ url('admin/libs/bootstrap/dist/js/bootstrap.bundle.min.js') }}"></script>
<script src="{{ url('core/tooltipster/js/tooltipster.bundle.min.js') }}"></script>

<!-- Form/Input Libraries -->
<script src="{{ url('admin/libs/taginput/bootstrap-tagsinput.js') }}"></script>
<script src="{{ url('admin/libs/bootstrap-material-datetimepicker/node_modules/moment/moment.js') }}"></script>
<script src="{{ url('admin/libs/select2/dist/js/select2.min.js') }}"></script>
<script src="{{ url('admin/libs/jquery-validation/dist/jquery.validate.min.js') }}"></script>
<script src="{{ url('admin/libs/dropzone/dist/dropzone.js') }}"></script>
<script src="{{ url('admin/libs/toastr/toastr.min.js') }}"></script>
<script src="{{ url('admin/libs/quill/dist/quill.min.js') }}"></script>

<!-- Theme & App Scripts -->
<script src="{{ url('admin/js/theme/theme.js') }}"></script>

<!-- Form Initializers -->
<script src="{{ url('admin/js/forms/select2.init.js') }}"></script>
<script src="{{ url('admin/js/forms/quill-init.js') }}"></script>
