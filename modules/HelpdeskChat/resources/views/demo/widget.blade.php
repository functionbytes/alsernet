        ...
        <div class="demo-content">
            ...
            @else
                <div class="demo-section">
                    ...
                    <p><code style="background: #edf2f7; padding: 8px 12px; border-radius: 4px; display: inline-block; margin: 10px 0;">{{ url('/demo/widget/YOUR_WEBSITE_TOKEN') }}</code></p>
                </div>
            @endif
...
&lt;/script&gt;</code></pre>
                ...
                <a href="{{ url('/admin/helpdesk/channels') }}" class="cta-button">
                    Manage Your Widgets
                </a>
            </div>
        </div>
