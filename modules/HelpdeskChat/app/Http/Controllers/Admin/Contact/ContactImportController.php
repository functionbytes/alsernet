...
use Modules\HelpdeskChat\Services\Contacts\ContactImportService;
...
class ContactImportController extends Controller
{
    ...
    public function showAdvanced(): View
    {
        ...
        return view('helpdeskchat::admin.contacts.import-advanced', [
            'labels' => $labels,
    ...
    public function downloadTemplate()
    {
        try {
            ...
            return response()->download($filePath, 'contact_import_template.csv', [
