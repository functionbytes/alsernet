...
use Modules\HelpdeskChat\Models\Channels\Api;
...
class ApiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('helpdeskchat::admin.settings.channels.api.index', compact('apiChannels'));
    }
    ...
    {
        return view('helpdeskchat::admin.settings.channels.api.create');
    }
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'identifier' => 'required|string|max:255|unique:channel_apis,identifier',
        ...
        try {
            ...
            return redirect()
                ->route('admin.helpdesk.channels.api.index')
    ...
    public function show(Api $api)
    {
        ...
        return view('helpdeskchat::admin.settings.channels.api.show', compact('api', 'incomingWebhookUrl'));
    }
    ...
    {
        return view('helpdeskchat::admin.settings.channels.api.edit', compact('api'));
    }
    ...
    public function update(Request $request, Api $api)
    {
        $validated = $request->validate([
            'inbox_name' => 'required|string|max:255',
            'identifier' => 'required|string|max:255|unique:channel_apis,identifier,'.$api->id,
            'webhook_url' => 'nullable|url|max:500',
            'additional_settings' => 'nullable|json',
