...
class WebController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('helpdeskchat::admin.settings.channels.webs.index', compact('widgets'));
    }
    ...
    {
        return view('helpdeskchat::admin.settings.channels.webs.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()
                ->route('admin.helpdesk.channels.webs.show', $widget)
    ...
    public function show(Web $webWidget)
    {
        ...
        return view('helpdeskchat::admin.settings.channels.webs.show', compact('webWidget'));
    }
    ...
    public function edit(Web $webWidget)
    {
        ...
        return view('helpdeskchat::admin.settings.channels.webs.edit', compact('webWidget'));
    }
    ...
    public function update(Request $request, Web $webWidget)
    {
        ...
        try {
            ...
            return redirect()
                ->route('admin.helpdesk.channels.webs.show', $webWidget)
    ...
    public function destroy(Web $webWidget)
    {
        try {
            ...
            return redirect()
                ->route('admin.helpdesk.channels.webs.index')
