...
use Modules\HelpdeskChat\Services\Macros\MacroExecutor;
...
class MacroController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('helpdeskchat::admin.settings.macros.index', compact('macros'));
    }
    ...
    public function create()
    {
        ...
        return view('helpdeskchat::admin.settings.macros.create', compact('visibilityOptions'));
    }
    ...
    public function show(Macro $macro)
    {
        ...
        return view('helpdeskchat::admin.settings.macros.show', compact('macro'));
    }
    ...
    public function edit(Macro $macro)
    {
        ...
        return view('helpdeskchat::admin.settings.macros.edit', compact('macro', 'visibilityOptions'));
    }
