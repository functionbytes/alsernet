...
class AttributesController extends Controller
{
    ...
    {
        $this->authorize('viewAny', ContactAttribute::class);

        $query = ContactAttribute::query()->withoutGlobalScope('active');
    ...
    {
        $this->authorize('create', ContactAttribute::class);
    ...
    public function store(Request $request)
    {
        ...
        $attribute = ContactAttribute::create($validated);
    ...
    {
        $attribute = ContactAttribute::withoutGlobalScope('active')->findOrFail($id);
