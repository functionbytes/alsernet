...
use Modules\HelpdeskChat\Services\EmailTemplateVariableService;
...
class EmailTemplateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('helpdeskchat::admin.settings.email-templates.index', compact('templates', 'eventTypes'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('helpdeskchat::admin.settings.email-templates.create', compact('eventTypes', 'selectedEventType', 'variables'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('admin.helpdesk.email-templates.index')
    ...
    public function show(EmailTemplate $emailTemplate)
    {
        ...
        return view('helpdeskchat::admin.settings.email-templates.show', compact('emailTemplate', 'variables'));
    }
    ...
    public function edit(EmailTemplate $emailTemplate)
    {
        ...
        return view('helpdeskchat::admin.settings.email-templates.edit', compact('emailTemplate', 'eventTypes', 'variables'));
    }
    ...
    public function preview(Request $request, EmailTemplate $emailTemplate)
    {
        ...
        return view('helpdeskchat::admin.settings.email-templates.preview', compact('emailTemplate', 'renderedHtml', 'renderedSubject'));
    }
