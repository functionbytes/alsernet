...
namespace Modules\HelpdeskChat\Services\Webhooks;
...
class WebhookDispatcher
{
    ...
    {
        if ($resource instanceof Conversation || $resource instanceof Message) {
     ...
     */
    protected function getSubscribedWebhooks(int $accountId, ?int $inboxId, string $event): \Illuminate\Support\Collection
    {
