...
class GiftMessageServiceProvider extends ServiceProvider
{
    ...
    {
        // El propio routes/web.php ya declara Route::middleware(['web', 'auth'])
        // en cada grupo, asi que aqui solo se carga el archivo sin envolverlo en
        // otro grupo 'web': hacerlo duplicaba StartSession/VerifyCsrfToken (se
        // ejecutaban dos veces) y provocaba 419 en peticiones POST/DELETE.
    ...
    protected function registerMenus(): void
    {
        ...
        NavService::registerSidebar($this->moduleNameLower, [
            ...
            'items' => [
                ...
                ['label' => 'Configuracion', 'route' => 'settings.'.$this->moduleNameLower.'.index', 'permission' => 'giftmessage.update'],
