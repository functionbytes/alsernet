                ...
                <div class="card">
                    ...
                    <div class="card-header d-flex align-items-center gap-2">
                        <div class="flex-grow-1 min-w-0">
                            ...
                            <p class="pb-header-sub">Las plantillas son reutilizables y pueden clonarse para crear prompts específicos</p>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body border-bottom">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="tone" class="form-control select2 @error('tone') is-invalid @enderror" required>
                                <option value="professional" {{ old('tone', 'professional') == 'professional' ? 'selected' : '' }}>Profesional - Formal y empresarial</option>
                                <option value="casual" {{ old('tone') == 'casual' ? 'selected' : '' }}>Casual - Relajado y cercano</option>
                                <option value="enthusiastic" {{ old('tone') == 'enthusiastic' ? 'selected' : '' }}>Entusiasta - Dinámico y enérgico</option>
                                <option value="formal" {{ old('tone') == 'formal' ? 'selected' : '' }}>Formal - Serio y corporativo</option>
                                <option value="friendly" {{ old('tone') == 'friendly' ? 'selected' : '' }}>Amigable - Cálido y acogedor</option>
                                <option value="persuasive" {{ old('tone') == 'persuasive' ? 'selected' : '' }}>Persuasivo - Orientado a la venta</option>
                                <option value="technical" {{ old('tone') == 'technical' ? 'selected' : '' }}>Técnico - Detallado y especializado</option>
                                <option value="elegant" {{ old('tone') == 'elegant' ? 'selected' : '' }}>Elegante - Refinado y sofisticado</option>
                            </select>
                            @error('tone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="pb-switch-card">
                            ...
                            <div class="form-check form-switch mb-0">
                                <input class="form-check-input" type="checkbox" role="switch"
                                       ...
                                       @if(old('seo_focus') === '1') checked @endif>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body border-bottom">
                        ...
                        <textarea name="notes" class="form-control @error('notes') is-invalid @enderror"
                                  rows="3" placeholder="Notas de uso interno sobre esta plantilla (opcional)">{{ old('notes') }}</textarea>
                        @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
