            ...
            <form id="formSupplier" enctype="multipart/form-data" role="form" onSubmit="return false">
                ...
                <div class="card-body">
                    ...
                    <p class="card-subtitle mb-3 mt-1 text-muted">
                        Define un nuevo proveedor. Los proveedores activos se sincronizarán con el ERP.
                    </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <small class="form-text text-muted">Nombre descriptivo que se mostrará en la
                                    interfaz</small>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mb-3">
                                ...
                                <small class="form-text text-muted">Solo los proveedores activos se
                                    sincronizarán</small>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <small class="form-text text-muted">Información adicional sobre el proveedor
                                    (opcional)</small>
                            </div>
                        </div>
