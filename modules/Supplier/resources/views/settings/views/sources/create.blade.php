...
@section('title', 'Crear fuente de datos')

@section('page_header')
    @include('core::components.card', ['title' => 'Crear fuente de datos'])
@endsection
...
<div class="card w-100">
    ...
    <form id="formSource" method="POST" action="{{ route('settings.suppliers.sources.store', $supplier->uid) }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="label" class="form-control @error('label') is-invalid @enderror"
                           value="{{ old('label') }}" required placeholder="Ej: Web oficial del proveedor">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="description" class="form-control @error('description') is-invalid @enderror"
                           value="{{ old('description') }}" placeholder="Descripción de la fuente y su uso">
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
        ...
        <div class="card-footer">
            <button type="submit" class="btn btn-primary w-100 mb-2">Guardar fuente</button>
