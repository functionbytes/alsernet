...
class UpdateLocalCategoryRequest extends FormRequest
{
    ...
    {
        $category = Category::where('uid', $this->route('uid'))->first();

        return [
            'name' => ['required', 'string', 'max:255'],
            'code' => ['nullable', 'string', 'max:100', Rule::unique('supplier_categories', 'code')->ignore($category?->id)],
