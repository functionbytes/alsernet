...
/**
 * @extends Factory<VariantCharacteristic>
 */
class VariantCharacteristicFactory extends Factory
{
    protected $model = VariantCharacteristic::class;

    public function definition(): array
    {
        return [
            'erp_id' => fake()->unique()->numberBetween(1000, 999999),
            'erp_article_id' => fake()->numberBetween(1000, 999999),
            'erp_model_id' => fake()->numberBetween(1000, 999999),
            'characteristic_id' => ErpCharacteristic::factory(),
            'value_id' => ErpCharacteristicValue::factory(),
