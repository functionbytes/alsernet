...
function removeBlock(btn) {
    ...
    if ($container.children().length === 0 && $('#empty-state').length === 0) {
        $container.before(
            '<div class="alert alert-info mb-3" id="empty-state">Sin contenido aún. Haz clic en "Agregar bloque" para comenzar.</div>'
        );
    }
}
...
function updateBlockFields(select) {
    ...
    const templates = {
        ...
        heading: `<div class="row g-2">
                    <div class="col-8"><label class="form-label small mb-1">Título</label>
                    <input type="text" class="form-control form-control-sm" name="content[${index}][value]" placeholder="Título"></div>
        ...
        button: `<div class="row g-2">
                    <div class="col-6"><label class="form-label small mb-1">Texto del botón</label>
                    <input type="text" class="form-control form-control-sm" name="content[${index}][label]" placeholder="Haz clic aquí"></div>
                    ...
                    <select class="form-select form-select-sm" name="content[${index}][style]">
                        ...
                        <option value="success">Éxito</option><option value="danger">Peligro</option>
                    </select></div></div>`,
        image: `<div class="mb-2"><label class="form-label small mb-1">URL de imagen</label>
                ...
                <input type="text" class="form-control form-control-sm" name="content[${index}][alt]" placeholder="Descripción de la imagen"></div>`,
