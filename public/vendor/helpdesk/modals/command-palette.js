/*!
 * Helpdesk · modal "command-palette" del inbox.
 *
 * Extraido de resources/views/helpdesk/inbox/partials/modals/command-palette.blade.php.
...
(function ($) {
    ...
    // El flag de tickets llega por data-* del overlay en vez de por un global
    // interpolado desde PHP, para que este JS pueda vivir en un fichero propio.
    function ticketsEnabled() {
        return $('#bv-cmd-palette').data('tickets-enabled') == 1;
    }
