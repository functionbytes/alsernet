...
(function ($) {
    ...
    function goToStep(step) {
        ...
        $('#ncwStep2').toggleClass('d-none', step !== 2);
        $('#bv-ncw-next').text(step === 1 ? 'Continuar' : 'Iniciar conversación');
        $('#bv-ncw-back').toggleClass('d-none', step !== 2);
        ...
        if (step === 2) {
            ...
            $('#ncwHsmSection').toggleClass('d-none', !needHsm);
    ...
    $(document).on('bv:modal:open', function (e, name) {
        ...
        $('#ncwChannelWarning').addClass('d-none');
        goToStep(1);
    });
    ...
    $(document).on('click', '#ncwChannelGrid .bv-ch-pick', function () {
        ...
        if (warning) {
            ...
            $('#ncwChannelWarning').removeClass('d-none');
        } else {
            $('#ncwChannelWarning').addClass('d-none');
        }
    });
    ...
    $(document).on('change', '#ncwHsmTemplate', function () {
        ...
        if (body) {
            ...
            $('#ncwHsmPreview').removeClass('d-none');
        } else {
            $('#ncwHsmPreview').addClass('d-none');
        }
    });
