...
class Popup {
    ...
    async open(options = {}) {
        ...
        if (options.url) {
            ...
            // Inline content must also wire up [data-popup-close], data-mc-form,
            // RichSelect, etc. — otherwise the Done/Cancel buttons in callers
            // that build the modal HTML in JS (e.g. wizard-setup.js fitness
            // modal) silently no-op and the backdrop traps further clicks.
