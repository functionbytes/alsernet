...
use Modules\Template\Policies\MenuItemPolicy;
use Modules\Template\Policies\MenuPolicy;
use Modules\Template\Policies\ShortcodePolicy;
...
class TemplateServiceProvider extends ServiceProvider
{
    ...
    {
        Gate::policy(TemplateModel::class, TemplatePolicy::class);
        Gate::policy(MenuModel::class, MenuPolicy::class);
        Gate::policy(MenuItem::class, MenuItemPolicy::class);
        Gate::policy(Shortcode::class, ShortcodePolicy::class);
    }
    ...
    protected function registerDynamicShortcodes(): void
    {
        $this->app->booted(function () {
            try {
                $shortcodes = Shortcode::cachedActive();
