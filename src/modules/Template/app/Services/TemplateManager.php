...
class TemplateManager
{
    ...
    /**
     * Carga (lazy) los templates disponibles en platform/themes/.
     *
     * El escaneo del filesystem se difiere hasta el primer acceso para no
     * acoplar I/O al resolver el singleton durante el boot.
     */
