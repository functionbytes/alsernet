...
.hmsg-row__chip:hover { background: #90bb122b; color: #90bb13; border-color: #90bb13; }
...
.logo-card:hover { border-color: #90bb13; box-shadow: 0 2px 8px rgba(177,1,0,.12); }
.logo-card__preview {
    position: relative;
    height: 140px;
    display: flex;
...
.logo-card--favicon .logo-card__preview { background: #f5f6f8; }
...
.header-style-summary__mockup .mock-logo {
    width: 32px; height: 12px; background: #90bb13; border-radius: 2px;
}
...
.icon-grid__btn:hover { border-color: #90bb13; color: #90bb13; }
