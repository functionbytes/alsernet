                            ...
                            <div class="col-12">
                                <div class="mb-4 d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <p class="text-muted mb-0">Detalles principales y estado del usuario</p>
                                    </div>
                                </div>
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                <div class="mb-4">
                                    ...
                                    <p class="text-muted mb-0">Todos los detalles registrados en el sistema</p>
                                </div>

                                <div>
                                    <div class="row">
                                        <div class="col-md-12 mb-4">
                                            <h6 class="text-muted mb-3 fw-bold">INFORMACIÓN PERSONAL</h6>
                                            ...
                                            <div class="col-md-12 mb-4">
                                                <h6 class="text-muted mb-3 fw-bold">INFORMACIÓN ADICIONAL</h6>
                                                <table class="table table-sm table-borderless">
                                                    <tbody>
                                                    <tr>
                                            ...
                                            <div class="col-md-12">
                                                <h6 class="text-muted mb-3 fw-bold">AUDITORÍA</h6>
                                                <table class="table table-sm table-borderless mb-0">
                                                    <tbody>
                                                    <tr>
                                                        <td class="text-muted" width="150">Creado:</td>
                                                        <td>{{ $user->created_at->format('d/m/Y H:i') }} <span class="text-muted">({{ $user->created_at->diffForHumans() }})</span></td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-muted">Actualizado:</td>
                                                        <td>{{ $user->updated_at->format('d/m/Y H:i') }} <span class="text-muted">({{ $user->updated_at->diffForHumans() }})</span></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                    ...
                    <div class="tab-pane fade" id="security" role="tabpanel" aria-labelledby="security-tab">
                        <div class="row g-4">
                            <div class="col-lg-8">
                                ...
                                <p class="text-muted mb-4">Gestiona las opciones de seguridad de la cuenta</p>
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                <div class="mb-4">
                                    ...
                                    <p class="text-muted mb-0">Registro de eventos del usuario en el sistema</p>
                                </div>
