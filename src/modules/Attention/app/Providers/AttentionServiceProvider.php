...
class AttentionServiceProvider extends ServiceProvider
{
    ...
    /**
     * Registrar los tipos de notificación de Attention en el registry central.
     */
    protected function registerNotificationTypes(): void
    {
        ...
        $this->app->make(NotificationTypeRegistry::class)->register(
            'attention.status_changed',
            'Estado de PQRSF actualizado',
            'Cuando cambia el estado de una solicitud de atención',
            ['database'],
        );
    }
    ...
    protected function registerMenus(): void
    {
        NavService::registerMiniItem('attentions', [
            'icon' => 'fa-duotone fa-thin fa-headset',
