    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            @foreach($labels as $label)
                                ...
                                @endphp
                                <tr>
                                    <td><code>{{ strtoupper($label) }}</code></td>
                                    <td>
                                        @if($docType)
                                            <div>
                                    ...
                                    <td class="text-center">
                                        @php $labelCount = isset($blockadesByType[strtolower($label)]) ? $blockadesByType[strtolower($label)]->count : 0; @endphp
                ...
                @else
                    <div class="text-center py-5">
                        <div class="d-flex flex-column align-items-center">
                            ...
                            <p class="text-muted mb-3">Agrega etiquetas para comenzar a sincronizar productos bloqueados</p>
                        </div>
                    </div>
                @endif
            </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="mb-1 fw-bold">Productos bloqueados</h6>
                        <p class="small mb-0 text-muted">{{ number_format($totalBlockades) }} registros en la tabla de bloqueos</p>
                    </div>
                    <a href="{{ route('settings.documents.blockades.products') }}" class="btn btn-primary">
                        <i class="fa-duotone fa-box-open me-2"></i>Ver productos bloqueados
                    </a>
                </div>
            </div>
