...
<style>
    ...
    .settings-header {
        ...
        border-radius: 12px;
        margin-bottom: 2rem;
        box-shadow: 0 4px 15px rgba(144, 187, 19, 0.2);
    }
        ...
        <div class="card shadow-sm" style="border-radius: 12px; border: 1px solid #e0e0e0;">
            ...
            <div class="card-header-custom">
                ...
                <div class="d-flex gap-2">
                    @if(request('search'))
                        <a href="{{ route('manager.helpdesk.settings.ticket-categories.index') }}" class="btn btn-outline-secondary btn-sm">
                            <i class="fas fa-times me-1"></i> Limpiar búsqueda
                        </a>
                    @endif
                    <a href="{{ route('manager.helpdesk.settings.ticket-categories.create') }}" class="btn-primary-custom">
            ...
            <div class="card-body border-bottom" style="background: #f8f9fa;">
                <form method="GET" action="{{ route('manager.helpdesk.settings.ticket-categories.index') }}">
                    <div class="row align-items-center g-2">
                        <div class="col-md-9">
                            <div class="input-group">
                                ...
                                <input type="search" name="search" class="form-control -0" placeholder="Buscar por nombre o slug..." value="{{ request('search') }}" style="border-color: #e0e0e0;">
                            </div>
                        </div>
                        <div class="col-md-3">
            ...
            <div class="card-body">
                @if($categories->count() > 0)
                    <div class="alert mb-3" style="background: rgba(144, 187, 19, 0.1); border: 1px solid rgba(144, 187, 19, 0.3); color: #7a9e10;">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div>
                                                ...
                                                @if($category->is_default)
                                                    <span class="badge ms-2" style="background: rgba(144, 187, 19, 0.2); color: #7a9e10; font-weight: 600; font-size: 0.75rem;">Por defecto</span>
                                                @endif
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center border-0 align-middle">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <li>
                                                    <form method="POST" action="{{ route('manager.helpdesk.settings.ticket-categories.destroy', $category->id) }}"
                                                          class="needs-confirm"
                                                          data-confirm-msg="¿Estás seguro de eliminar esta categoría?">
                                                        @csrf
                                                        @method('DELETE')
