                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="icon" class="form-control" value="{{ old('icon') }}" placeholder="Ej: fas fa-headset">
                    ...
                    <div class="col-12">
                        ...
                        <p class="text-muted mb-3">
                            ...
                            Podrás agregar campos personalizados una vez creada la categoría, desde la opción <strong>Editar</strong>.
                        </p>
                    </div>
