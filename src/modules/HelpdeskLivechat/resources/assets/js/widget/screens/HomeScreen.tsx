...
export function HomeScreen() {
    ...
    useEffect(() => {
        ...
        const conversationToken = localStorage.getItem('livechat_pubsub_token');
        // No token → can no longer authorize this conversation; skip the resume card.
        ...
        fetch(url.toString(), { headers: conversationAuthHeaders() })
