    ...
    protected function registerMenus(): void
    {
        ...
        NavService::registerSidebar('helpdesk-social', [
            ...
            'items' => [
                ...
                ['label' => 'Reglas automáticas', 'route' => 'helpdesksocial.rules.index', 'permission' => 'helpdesksocial.rules.manage'],
                ['label' => 'Asignación inteligente', 'route' => 'helpdesksocial.assignment-rules.index', 'permission' => 'helpdesksocial.rules.manage'],
                ['label' => 'Plantillas', 'route' => 'helpdesksocial.templates.index', 'permission' => 'helpdesksocial.templates.manage'],
                ['label' => 'Tags', 'route' => 'helpdesksocial.tags.index', 'permission' => 'helpdesksocial.rules.manage'],
                ['label' => 'SLA', 'route' => 'helpdesksocial.sla-policies.index', 'permission' => 'helpdesksocial.rules.manage'],
                ['label' => 'Aprobaciones', 'route' => 'helpdesksocial.approval-requests.index', 'permission' => 'helpdesksocial.view'],
                ['label' => 'Competidores', 'route' => 'helpdesksocial.competitors.index', 'permission' => 'helpdesksocial.analytics.view'],
                ['label' => 'Analítica', 'route' => 'helpdesksocial.analytics.index', 'permission' => 'helpdesksocial.analytics.view'],
                ['label' => 'Rendimiento agentes', 'route' => 'helpdesksocial.analytics.agents', 'permission' => 'helpdesksocial.analytics.view'],
            ],
        ]);
