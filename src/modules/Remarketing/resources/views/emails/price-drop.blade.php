...
<body style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; color: #333333;">
    ...
    <div style="border: 2px solid #90bb13; border-radius: 6px; padding: 20px; margin-bottom: 24px; text-align: center;">
        ...
        <div style="font-size: 28px; font-weight: bold; color: #90bb13;">
            €{{ number_format((float) $newPrice, 2, ',', '.') }}
        </div>
        @if($dropPercent > 0)
        <div style="display: inline-block; background: #90bb13; color: white; padding: 4px 12px; border-radius: 20px; font-size: 14px; margin-top: 8px;">
