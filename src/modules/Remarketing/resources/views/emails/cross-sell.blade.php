    ...
    <div style="display: grid; gap: 16px;">
        ...
        <div style="border: 1px solid #e0e0e0; border-radius: 6px; padding: 16px; overflow: hidden;">
            ...
            <div style="overflow: hidden;">
                ...
                <span style="color: #90bb13; font-size: 16px; font-weight: bold;">
                ...
                <div style="margin-top: 8px;">
                    <a href="{{ $product->url }}"
                       style="display: inline-block; background: #90bb13; color: white; padding: 8px 16px; text-decoration: none; border-radius: 4px; font-size: 13px; font-weight: bold;">
                        Ver producto
                    </a>
                </div>
                @endif
