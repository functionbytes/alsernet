...
@section('title', 'Nueva Keyword - Social Listening')
        ...
        <div class="col-12">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Nueva Keyword</li>
                </ol>
            </nav>

            <form action="{{ route('admin.social.listening.store') }}" method="POST">
                @csrf
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input"
                                                       ...
                                                       id="network_facebook"
                                                       value="facebook"
                                                       {{ in_array('facebook', old('networks', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input"
                                                       ...
                                                       value="instagram"
                                                       {{ in_array('instagram', old('networks', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input"
                                                       ...
                                                       id="network_twitter"
                                                       value="twitter"
                                                       {{ in_array('twitter', old('networks', [])) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input"
                                                       ...
                                                       id="network_linkedin"
                                                       value="linkedin"
                                                       {{ in_array('linkedin', old('networks', [])) ? 'checked' : '' }}>
                                ...
                                <div class="mb-0">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror"
                                              ...
                                              name="notes"
                                              rows="3"
                                              placeholder="Ej: Campaña Q1 2024, Monitoreo de competencia">{{ old('notes') }}</textarea>
                                    @error('notes')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('sentiment_filter') is-invalid @enderror"
                                        ...
                                        <option value="all" {{ old('sentiment_filter', 'all') === 'all' ? 'selected' : '' }}>
                                            Todos los sentiments
                                        </option>
                                        <option value="positive" {{ old('sentiment_filter') === 'positive' ? 'selected' : '' }}>
                                            Solo positivo
                                        </option>
                                        <option value="negative" {{ old('sentiment_filter') === 'negative' ? 'selected' : '' }}>
                                            Solo negativo
                                        </option>
                                        <option value="neutral" {{ old('sentiment_filter') === 'neutral' ? 'selected' : '' }}>
                                            Solo neutral
                                        </option>
                                    </select>
                                        ...
                                        @foreach(['#3498db', '#2ecc71', '#f39c12', '#e74c3c', '#9b59b6', '#1abc9c', '#34495e', '#e67e22'] as $colorOption)
                                            <div class="form-check">
                                                <input class="form-check-input color-radio"
                                                       ...
                                                       value="{{ $colorOption }}"
                                                       {{ old('color', '#3498db') === $colorOption ? 'checked' : '' }}>
                            ...
                            <div class="card-body">
                                <div class="d-grid gap-2">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fas fa-save me-1"></i> Crear Keyword
                                    </button>
