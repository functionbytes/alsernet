...
@section('title', trans('campaign::page-templates.page.title'))

@section('page-header')
    <div class="mc-page-header">
        <div>
            <h1 class="mc-page-title">{{ trans('campaign::page-templates.page.title') }}</h1>
            <p class="mc-page-subtitle">{{ trans('campaign::page-templates.page.subtitle') }}</p>
        </div>
...
<div style="display:grid;grid-template-columns:repeat(3,1fr);gap:var(--space-4);margin-bottom:var(--space-5);">
    <div class="mc-stat-card">
        ...
        <div class="mc-stat-content">
            <div class="mc-stat-label">{{ trans('campaign::page-templates.stat.total') }}</div>
    ...
    <div class="mc-stat-card">
        ...
        <div class="mc-stat-content">
            <div class="mc-stat-label">{{ trans('campaign::page-templates.stat.base') }}</div>
    ...
    <div class="mc-stat-card">
        ...
        <div class="mc-stat-content">
            <div class="mc-stat-label">{{ trans('campaign::page-templates.stat.extended') }}</div>
...
<div class="mc-alert mc-alert-teal" style="margin-bottom:var(--space-5);">
    ...
    <div class="mc-alert-content">
        <div class="mc-alert-title">{{ trans('campaign::page-templates.banner.title') }}</div>
        <div class="mc-alert-text">{{ trans('campaign::page-templates.banner.desc') }}</div>
    </div>
</div>
...
<div class="mc-card mc-card-table">
    ...
    <div class="mc-tabs mc-tabs-card-header" data-mc-tabs id="page-tpl-tabs" style="padding:0 var(--space-5);border-bottom:var(--space-px) solid var(--color-border);">
        <button type="button" class="mc-tab active" data-tab="">
            {{ trans('campaign::page-templates.tabs.all') }}
    ...
    <div class="mc-filter-bar">
        <div class="mc-filter-search">
            ...
            <input class="mc-form-input mc-search-input" type="text" name="keyword"
                   placeholder="{{ trans('campaign::page-templates.filter.search') }}"
                   data-list-filter="keyword">
        </div>
        <div class="mc-view-toggle" id="view-toggle">
            <button type="button" class="mc-view-toggle-btn is-active" data-view="list" title="{{ trans('campaign::page-templates.view.list') }}">
                @include('campaign::refactor.components.icons.mc-icon', ['icon' => 'list', 'size' => 16])
            </button>
            <button type="button" class="mc-view-toggle-btn" data-view="grid" title="{{ trans('campaign::page-templates.view.grid') }}">
    ...
    <div id="page-template-list"
         data-url="{{ route('manager.page_templates.listing') }}"
    ...
    document.addEventListener('click', function(e) {
        ...
        if (deleteBtn) {
            ...
            window.McDialog.confirm({
                title: '{{ trans("campaign::page-templates.confirm.delete_title") }}',
                message: '{{ trans("campaign::page-templates.confirm.delete_msg") }}',
                type: 'danger',
                confirmText: '{{ trans("campaign::page-templates.confirm.delete_btn") }}',
                onConfirm: function() {
