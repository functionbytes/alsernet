...
@section('content')
<form id="form-template-copy-form" action="{{ route('manager.page_templates.store_copy', $item->uid) }}" method="POST">
    @csrf
    ...
    <div class="mc-alert mc-alert-teal" style="margin-bottom:var(--space-5);">
        ...
        <div class="mc-alert-content">
            <div class="mc-alert-text">{{ trans('campaign::page-templates.copy.desc') }}</div>
        </div>
    </div>
