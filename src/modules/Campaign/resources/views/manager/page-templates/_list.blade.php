            ...
            <div class="mc-template-list-row">
                ...
                <div class="mc-template-list-info">
                    ...
                    <div class="mc-template-list-meta">
                        ...
                        <span class="mc-template-list-meta-item">
                            ...
                            {{ trans('campaign::page-templates.meta.edited') }} {{ $item->updated_at->diffForHumans() }}
                        </span>
                        @endif
                ...
                <div class="mc-template-list-actions">
                    ...
                    <a href="{{ route('manager.page_templates.preview', $item->uid) }}"
                       ...
                       class="mc-template-action-btn" title="{{ trans('campaign::page-templates.action.preview') }}">
