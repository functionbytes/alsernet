        ...
        @foreach ($items as $item)
            @php
                ...
                $editRoute  = $isUploaded
                    ? route('manager.my_email_templates.custom_html', $item->uid)
                    : route('manager.my_email_templates.builder', $item->uid);
            ...
            <div class="mc-template-card">
                <div class="mc-template-thumb">
                    ...
                    <div class="mc-template-overlay">
                        <a href="{{ route('manager.my_email_templates.preview', $item->uid) }}"
                           data-preview="{{ route('manager.my_email_templates.preview', $item->uid) }}"
                           ...
                           class="mc-btn mc-btn-white mc-btn-sm">
                            ...
                            {{ trans('campaign::email-templates.action.preview') }}
                        </a>
                ...
                <div class="mc-template-info">
                    ...
                    <div class="mc-template-actions" data-dropdown>
                        ...
                        <div class="mc-dropdown-menu mc-dropdown-menu-end">
                            @unless ($isUploaded)
                            <a class="mc-dropdown-item" href="{{ route('manager.my_email_templates.custom_html', $item->uid) }}">
                                @include('campaign::refactor.components.icons.mc-icon', ['icon' => 'code', 'size' => 16])
                                {{ trans('campaign::email-templates.action.custom_html') }}
                            </a>
                            @endunless
                            <a class="mc-dropdown-item" href="{{ route('manager.my_email_templates.copy', $item->uid) }}"
                            ...
                            <a class="mc-dropdown-item" href="{{ route('manager.my_email_templates.change_name', $item->uid) }}"
                            ...
                            <a class="mc-dropdown-item mc-dropdown-item-danger" href="javascript:;"
                               data-action-delete="{{ route('manager.my_email_templates.delete') }}" data-uid="{{ $item->uid }}">
...
@else
    ...
    <div class="mc-empty-state" style="padding:var(--space-12) var(--space-6);">
        ...
        <a href="{{ route('manager.my_email_templates.add') }}"
