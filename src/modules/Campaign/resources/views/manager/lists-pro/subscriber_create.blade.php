...
@section('title', trans('campaign::lists.form.create_title'))

@section('page-header')
    <div class="mc-page-header">
        <div>
            <h1 class="mc-page-title">{{ trans('campaign::lists.form.create_title') }}</h1>
            <p class="mc-page-subtitle">{{ $list->name }}</p>
        </div>
...
@section('content')
    ...
    <div class="mc-card" style="max-width:560px;">
        <div class="mc-card-body">
            <form id="SubscriberCreateForm" method="POST" action="{{ route('manager.lists_pro.subscriber_store', $list->uid) }}">
                @csrf
                ...
                <div class="mc-form-group" style="margin-bottom:var(--space-5);">
                    <label class="mc-form-label" for="email">
                        ...
                        <span class="mc-form-required" aria-hidden="true">*</span>
                    </label>
...
<script>
(function () {
    var form = document.getElementById('SubscriberCreateForm');
    if (!form) return;
