...
use Modules\Campaign\Models\Country;
use Modules\Campaign\Models\Currency;
use Modules\Campaign\Models\PlanGeneral;
            ...
            'functions' => [
                [
                    ...
                    'parameters' => [
                        ...
                        ['name' => 'divider', 'description' => 'Customers information'],
...
-d api_token='.\Auth::user()->api_token.' \
-d name=List+1 \
-d from_email=helpdesks@abccorp.org \
...
-d contact[country_id]='.Country::first()->id.' \
            ...
            'functions' => [
                [
                    ...
                    'help' => 'User can login by visiting the following URL:<br>
                        <code>'.action('Controller@tokenLogin', ['token' => '*|token_string|*']).'</code>',
                    'parameters' => [
                        ['name' => '$uid', 'description' => 'Customers\'s uid'],
                    ],
                    'returns' => 'Token string',
                    'example' => 'curl -X POST -H "accept:application/json" -G \
'.str_replace('-uid-', '<redbold>{uid}</redbold>', action("Api\CustomerController@loginToken")).' \
                    ...
                    'parameters' => [
                        ...
                        ['name' => '$options[...]', 'description' => 'Plan\'s options...<br>
                            <ul>
                                ...
                                <li><span class="text-semibold">sending_server_option</span>: ('.PlanGeneral::SENDING_SERVER_OPTION_SYSTEM.'|'.PlanGeneral::SENDING_SERVER_OPTION_OWN.'|'.PlanGeneral::SENDING_SERVER_OPTION_SUBACCOUNT.')</li>
...
-d api_token='.\Auth::user()->api_token.'  \
-d name=Advanced \
-d currency_id='.Currency::first()->id.' \
-d frequency_amount=1 \
-d frequency_unit=month \
-d price=20 \
-d color=red \
-d options[sending_server_option]='.PlanGeneral::SENDING_SERVER_OPTION_OWN.' \
...
-d password=123456',
                ...
                [
                    ...
                    'returns' => 'Customers information in json (profile, contact, sunscriptions,... )',
                    'example' => 'curl -X GET -H "accept:application/json" -G \
...
-d api_token='.\Auth::user()->api_token,
                ...
                [
                    ...
                    'description' => 'Assign Plan to Customers',
                    'parameters' => [
                        ['name' => '$uid', 'description' => 'Customers\'s uid'],
