...
trait HasCampaignManagement
{
    ...
    {
        return $this->hasMany('Modules\Campaign\Models\CampaignMaillist');
    }
    ...
    {
        return $this->hasMany('Modules\Campaign\Models\Campaign');
    }
    ...
    {
        return $this->hasMany('Modules\Campaign\Models\Automation\Automation')->where('status', 'active');
    }
    ...
    {
        return $this->hasMany('Modules\CampaignSendingServers\Models\Blacklist');
    }
