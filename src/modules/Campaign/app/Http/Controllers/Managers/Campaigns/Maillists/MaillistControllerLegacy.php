...
// use removed: Acelle\Hcaptcha\Client (Phase 2)
...
class MaillistController extends Controller
{
    ...
    public function listGrowthChart(Request $request)
    {
        ...
        // columns
        for ($i = 4; $i >= 0; $i--) {
            $result['columns'][] = Carbon::now()->subMonthsNoOverflow($i)->format('m/Y');
        }
        ...
        foreach ($result['bar_names'] as $bar) {
            for ($i = 4; $i >= 0; $i--) {
                $result['data'][] = Customer::subscribersCountByTime(
                    Carbon::now()->subMonthsNoOverflow($i)->startOfMonth(),
                    Carbon::now()->subMonthsNoOverflow($i)->endOfMonth(),
