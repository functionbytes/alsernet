...
use Modules\Campaign\Jobs\SendConfirmationEmailJob;
...
class SubscriberController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->isMethod('patch')) {
            ...
            MailListUpdated::dispatch($subscriber->mailList);
    ...
    public function copy(Request $request)
    {
        ...
        MailListUpdated::dispatch($to_list);
    ...
    public function move(Request $request)
    {
        ...
        // Trigger updating related campaigns cache
        MailListUpdated::dispatch($from_list);
        MailListUpdated::dispatch($to_list);
    ...
    public function resendConfirmationEmail(Request $request)
    {
        ...
        dispatch_now(new SendConfirmationEmailJob($subscribers->get(), $list));
    ...
    public function import2Validate(Request $request)
    {
        ...
        try {
            MailListFieldMapping::parse($request->mapping, $list);
