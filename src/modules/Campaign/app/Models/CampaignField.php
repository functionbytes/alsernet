 ...
 * @property-read Collection<int, CampaignFieldOption> $fieldOptions
 * @property-read int|null $field_options_count
 * @property-read CampaignMaillist $mailList
 *
...
class CampaignField extends Model
{
    ...
    {
        return $this->belongsTo('Modules\Campaign\Models\CampaignMaillist', 'maillist_id');
    }

    public function fieldOptions()
    {
        return $this->hasMany('Modules\Campaign\Models\CampaignFieldOption', 'maillist_id');
    }
