...
class InboxesController extends Controller
{
    ...
    public function index(): View
    {
        ...
        $inboxCounts = Inbox::query()
            ->selectRaw('channel_type, COUNT(*) as total, SUM(is_active) as active')
    ...
    public function channels(): View
    {
        ...
        return view('helpdesk::settings.inboxes.channels', compact(
            'channelLabels',
            'channelIcons',
        ));
    }

    public function channelList(string $type): View
    {
        if (! in_array($type, Inbox::CHANNEL_TYPES, true)) {
            abort(404);
        }
        ...
        return view('helpdesk::settings.inboxes.channel-list', compact(
            'inboxes',
            'type',
            'channelLabels',
            'channelIcons',
