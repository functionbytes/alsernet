...
class StoreConversationStatusRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('helpdesk.statuses.create') ?? false;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['required', 'string', 'max:255', 'unique:helpdesk.helpdesk_conversation_statuses,slug', 'regex:/^[a-z0-9_-]+$/'],
