    ...
    <div class="bv-modal-dialog md">
        <div class="bv-modal-head bv-modal-head--with-icon">
            ...
            <div class="bv-modal-title-wrap">
                <span class="bv-modal-label">AYUDA · CENTRO</span>
                <div class="bv-modal-title"><span>Centro de ayuda</span></div>
            </div>
        ...
        <div class="bv-modal-body">
            <div class="search-field">
                ...
                <input type="text" id="hcSearch" placeholder="¿Qué necesitas hacer?" autocomplete="off">
            </div>
