...
class VisualEditorController extends Controller
{
    ...
    private function buildPostMessageBridge(): string
    {
        return <<<'HTML'
<style>
.ve-sel      { outline: 2px solid #90bb13 !important; outline-offset: 1px !important; }
...
(function () {
        ...
        switch (d.type) {
            ...
            case 've-search-text': {
                ...
                textNodes.forEach(function(node) {
                    ...
                    span.style.cssText = 'background:#90bb13;color:#fff;border-radius:2px;padding:0 1px;';
            ...
            case 've-search-nav': {
                ...
                arr[nidx].style.outline = '2px solid #90bb13';
    ...
    document.addEventListener('mousemove', function(e) {
        ...
        if (!isDragging) {
            ...
            dragEl.style.outline = '2px dashed #90bb13';
            dragPlaceholder = document.createElement('div');
            dragPlaceholder.className = 've-drag-placeholder';
            dragPlaceholder.style.cssText = 'height:4px;background:#90bb13;border-radius:2px;margin:4px 0;pointer-events:none;';
        }
    ...
    document.addEventListener('click', function (e) {
        ...
        handle.style.cssText = 'position:absolute;bottom:0;right:0;width:14px;height:14px;background:#90bb13;cursor:se-resize;border-radius:2px;z-index:9999;';
