...
Route::prefix('panel/settings')->middleware(['web', 'auth'])->name('settings.')->group(function () {
    Route::prefix('shortcodes')->name('shortcode.')->group(function () {
        // Dashboard read-only de shortcodes registrados en código + stats de uso.
        // El listado/CRUD canónico en `panel/settings/shortcodes` lo provee el módulo Template.
        Route::get('/dashboard', [ShortcodeController::class, 'index'])->name('dashboard');
