    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body p-0">
                <div class="row g-0 shortcode-picker-body">
                    ...
                    <div class="col-5 border-end d-flex flex-column">
                        ...
                        <div class="overflow-auto flex-grow-1 shortcode-picker-list" id="shortcodeList">
...
@push('css')
<style>
    .shortcode-picker-body { min-height: 420px; }
    .shortcode-picker-list { max-height: 380px; }
    .shortcode-picker-desc { font-size: 0.78rem; }
    .shortcode-picker-example { font-size: 0.78rem; white-space: pre-wrap; word-break: break-all; }
</style>
@endpush
@push('scripts')
<script>
    ...
    function renderList(shortcodes) {
        ...
        const items = shortcodes.map(function (s) {
            return `<button type="button"
                        ...
                        <span class="text-muted shortcode-picker-desc">${escHtml(s.description || '')}</span>
                    </button>`;
        }).join('');
    ...
    function renderDetail(s) {
        ...
        $detail.html(`
            ...
            <div class="mb-3">
                ...
                <pre class="bg-light border rounded p-2 mb-0 shortcode-picker-example">${escHtml(s.example || '')}</pre>
            </div>
