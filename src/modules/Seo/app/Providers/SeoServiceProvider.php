...
class SeoServiceProvider extends ServiceProvider
{
    ...
    protected function registerMenus(): void
    {
        NavService::registerSidebar('settings', [
            'title' => 'SEO',
            'items' => [
                ['label' => 'Dashboard SEO', 'route' => 'settings.seo.dashboard'],
                ['label' => 'Analytics SEO', 'route' => 'settings.seo.analytics.index'],
                ['label' => 'Meta SEO', 'route' => 'settings.seo.metas.index'],
                ['label' => 'Gestión Hreflang', 'route' => 'settings.seo.metas.hreflang'],
                ['label' => 'Auditoría SEO', 'route' => 'settings.seo.audit.index'],
                ['label' => 'Historial auditorías', 'route' => 'settings.seo.audit.history'],
                ['label' => 'Redirecciones', 'route' => 'settings.seo.redirects.index'],
                ['label' => 'Errores 404', 'route' => 'settings.seo.404-logs.index'],
                ['label' => 'Alertas SEO', 'route' => 'settings.seo.alerts.index'],
                ['label' => 'Plantillas SEO', 'route' => 'settings.seo.templates.index'],
                ['label' => 'Contenido sin SEO', 'route' => 'settings.seo.orphans.index'],
                ['label' => 'URLs del sitio', 'route' => 'settings.seo.page-urls.index'],
                ['label' => 'URLs estáticas', 'route' => 'settings.seo.static-urls.index'],
                ['label' => 'Robots.txt', 'route' => 'settings.seo.robots.edit'],
                ['label' => 'llms.txt (IA)', 'route' => 'settings.seo.llms.edit'],
                ['label' => 'IndexNow', 'route' => 'settings.seo.indexnow.index'],
                ['label' => 'Core Web Vitals', 'route' => 'settings.seo.web-vitals.index'],
                ['label' => 'Sitemap XML', 'route' => 'settings.seo.sitemap.index'],
                ['label' => 'Reporte SEO', 'route' => 'settings.seo.report.index'],
                ['label' => 'Verificación', 'route' => 'settings.seo.verification.index'],
                ['label' => 'Search Console (CSV)', 'route' => 'settings.seo.search-console.import'],
                ['label' => 'Search Console (API)', 'route' => 'settings.seo.gsc.index'],
                ['label' => 'Configuración SEO', 'route' => 'settings.seo.settings.edit'],
            ],
        ]);
    }
    ...
    protected function registerSitemapCallbacks(): void
    {
        $this->app->booted(function () {
            ...
            if (class_exists(BlogCategory::class) && Module::isEnabled('Blog')) {
            ...
            if (class_exists(BlogTag::class) && Module::isEnabled('Blog')) {
                SitemapCallbackRegistry::register(function ($builder) {
