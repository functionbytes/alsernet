                            ...
                            <div class="d-flex justify-content-between align-items-center gap-3">
                                ...
                                @php
                                    ...
                                    if ($indexable && $followable) {
                                        ...
                                        $robotsBg = '#fce8e8'; $robotsColor = '#90bb13';
                                    } else {
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-1">
                        ...
                        <small class="fw-semibold" style="color:#90bb13;">{{ $pct }}%</small>
                    </div>
                    <div class="rounded mb-3" style="height:5px;background:#f5f6f8;">
                        <div class="rounded" style="height:5px;width:{{ $pct }}%;background:#90bb13;transition:width .4s;"></div>
                    </div>
                        ...
                        <li class="d-flex align-items-center gap-2 py-2 {{ !$loop->last ? 'border-bottom' : '' }}">
                            ...
                            @else
                                <span class="rounded-circle d-flex align-items-center justify-content-center flex-shrink-0"
                                    ...
                                    <i class="fas fa-times" style="font-size:0.5rem;color:#90bb13;"></i>
                                </span>
