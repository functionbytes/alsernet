(function ($) {
    ...
    function fetchTemplates(searchTerm) {
        ...
        $.ajax({
            url:      (window.ChatConfig && window.ChatConfig.baseUrl || '/chat/conversations') + '/' + convId + '/message-templates/search',
            type:     'GET',
            data:     { q: searchTerm },
            dataType: 'json',
    ...
    function fetchConversationData(convId, callback) {
        $.ajax({
            url:  (window.ChatConfig && window.ChatConfig.baseUrl || '/chat/conversations') + '/' + convId + '/variables',
            type: 'GET',
