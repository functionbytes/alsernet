...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'helpdesk' => [
            'driver' => env('DB_CONNECTION_HELPDESK', env('DB_CONNECTION', 'mariadb')),
            'url' => env('DB_URL_HELPDESK'),
            'host' => env('DB_HOST_HELPDESK', env('DB_HOST', '127.0.0.1')),
            'port' => env('DB_PORT_HELPDESK', env('DB_PORT', '3306')),
            'database' => env('DB_DATABASE_HELPDESK', env('DB_DATABASE', 'laravel')),
            'username' => env('DB_USERNAME_HELPDESK', env('DB_USERNAME', 'root')),
            'password' => env('DB_PASSWORD_HELPDESK', env('DB_PASSWORD', '')),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => env('DB_CHARSET', 'utf8mb4'),
            'collation' => env('DB_COLLATION', 'utf8mb4_unicode_ci'),
            'prefix' => '',
