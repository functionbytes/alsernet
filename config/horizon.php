    ...
    */
    ...
    'environments' => [
        ...
        'local' => [
            ...
            'supervisor-local' => [
                'connection' => 'redis',
                'queue' => ['default', 'pagespeed', 'google-sync', 'notifications', 'reviews-sync', 'exports', 'reviews-replies', 'replies', 'emails', 'sla', 'helpdesk-scheduled', 'helpdesk-heavy', 'broadcasts', 'drip', 'remarketing', 'remarketing-webhooks'],
                'balance' => 'simple',
                'processes' => 3,
                'tries' => 1,
                'timeout' => 60,
