    ...
    'environments' => [
        'production' => [
            ...
            'supervisor-helpdesk' => [
                ...
                // caia al default de Horizon y nunca se procesaba.
                'queue' => ['helpdesk', 'helpdesk-events', 'helpdesk-scheduled', 'helpdesk-heavy', 'helpdesk-ai', 'helpdesk-audit', 'chatflow'],
                'balance' => 'auto',
                'autoScalingStrategy' => 'time',
                'minProcesses' => 1,
                'maxProcesses' => 4,
        ...
        'local' => [
            ...
            'supervisor-local' => [
                'connection' => 'redis',
                'queue' => ['default', 'pagespeed', 'google-sync', 'notifications', 'notifications-high', 'reviews-sync', 'exports', 'reviews-replies', 'replies', 'emails', 'sla', 'helpdesk', 'helpdesk-events', 'helpdesk-scheduled', 'helpdesk-heavy', 'helpdesk-ai', 'helpdesk-audit', 'chatflow', 'broadcasts', 'drip', 'remarketing', 'remarketing-webhooks'],
                'balance' => 'simple',
                'processes' => 3,
                'tries' => 1,
                'timeout' => 60,
