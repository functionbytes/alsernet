...
return [
    ...
    'title' => config('app.name').' Mobile API v1',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API REST para la app móvil Flutter (clientes finales B2C). Autenticación Sanctum, broadcasting Reverb, push FCM.',
