...
class NewProductsSportControllerCore extends ProductListingFrontController
{
    ...
    public function initContent()
    {
        ...
        $this->setTemplate('catalog/listing/new-products', [
            // 'id' => $this->category->id,
            // 'category' => $this->category,
            'entity' => 'new-products-sport',
            'listing' => $variables,
        ]);
    ...
    protected function getProductSearchQuery()
    {
        ...
        $query
            ->setQueryType('new-products-sport')
    ...
    public function getBreadcrumbLinks()
    {
        ...
        $breadcrumb['links'][] = [
            'title' => $this->trans('New products', [], 'Shop.Theme.Catalog'),
            //'url' => $this->context->link->getPageLink('new-products-sport&id_category='.Tools::getValue("id_category"), true),
