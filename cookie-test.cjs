...
(async () => {
  ...
  await page.fill('input[name="email"]', 'admin@caixilhariablanco.pt');
  ...
  await page.screenshot({ path: '/tmp/cookie-settings.png', fullPage: true });
  console.log('Screenshot saved to /tmp/cookie-settings.png');
