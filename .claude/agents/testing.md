---
name: testing
description: "Testing specialist for PHPUnit tests, browser testing, and quality assurance. Use proactively after writing code, when bugs are found, or when test coverage is needed."
model: sonnet
