...
## 4. Force Delete Modal (Soft Deletes)
...
<div class="modal fade" id="force-delete-modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="mb-1">¿Estas seguro que deseas eliminar permanentemente:</p>
                <p class="fw-semibold" id="force-delete-title"></p>
                <p class="text-danger small mb-0">Esta accion no se puede deshacer.</p>
            </div>
...
## 5. Form Modal (create/edit inline)

```blade
<div class="modal fade" id="formModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form id="inlineForm" action="{{ route('resource.store') }}" method="POST">
                @csrf
                <div class="modal-header">
...
10. **Form modals**: usar `@csrf`, limpiar errores al abrir/cerrar
