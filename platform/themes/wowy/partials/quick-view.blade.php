<link rel="stylesheet" href="{{ theme_asset('plugins/lightGallery/css/lightgallery.min.css') }}">
<script src="{{ theme_asset('plugins/lightGallery/js/lightgallery.min.js') }}"></script>
