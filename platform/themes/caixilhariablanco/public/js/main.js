...
// testimonial//
if ($('.slider-galeria').length && $('.slider-galeria').children().length > 0) {
...
if ($('.slider-galeria-thumbs').length && $('.slider-galeria-thumbs').children().length > 0) {
...
// testimonial //
if ($(".product-slider-nav").length && $(".product-slider-nav").children().length > 0) {
...
if ($('.slider-nav1').length && $('.slider-nav1').children().length > 0) {
$('.slider-nav1').slick({
  slidesToShow: 1,
  slidesToScroll: 1,
  asNavFor: '.foter-carousel',
...
if ($('.foter-carousel').length && $('.foter-carousel').children().length > 0) {
...
// testimonials //
if ($('.all-images-area').length && $('.all-images-area').children().length > 0)
...
if ($('.all-images-area2').length && $('.all-images-area2').children().length > 0)
