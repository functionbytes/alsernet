@if(!empty($images))
@php $gid = 'gi-' . substr(md5(implode(',', $images)), 0, 8); @endphp
    ...
    <div class="container">
        ...
        <div class="gi-grid">
            @foreach($images as $src)
                <a href="{{ $src }}"
                   ...
                   data-gallery="{{ $gid }}"
                   data-wow-delay="{{ number_format(0.05 * $loop->index, 2) }}s">
                    <div class="gi-img-wrap">
                        <img src="{{ $src }}"
                             alt="Instalación {{ $loop->iteration }}"
                    ...
                    <div class="gi-overlay">
                        ...
                        <div class="gi-label">
                            <span class="gi-counter">{{ str_pad($loop->iteration, 2, '0', STR_PAD_LEFT) }} / {{ str_pad(count($images), 2, '0', STR_PAD_LEFT) }}</span>
        ...
        <div class="gi-footer text-center wow fadeInUp">
            <p class="gi-footer-text">
                ...
                <span>{{ count($images) }} instalaciones reales en Alcobaça y toda la región Centro de Portugal</span>
            </p>
        </div>
    </div>
</section>
