...
class NewslettersConditionsController extends Controller
{
    ...
    public function index(Request $request){
            ...
            $conditions = NewsletterCondition::orderBy('title' , 'desc');
            ...
            return view('managers.views.newsletters.conditions.index')->with([
      ...
      public function create(){
          ...
          return view('managers.views.newsletters.conditions.create')->with([
      ...
      public function edit($slack){
            ...
            $condition = NewsletterCondition::uid($slack);
            ...
            return view('managers.views.newsletters.conditions.edit')->with([
              'condition' => $condition,
              'availables' => $availables,
            ]);
    ...
    public function update(Request $request){
         ...
         $condition = NewsletterCondition::uid($request->uid);
      ...
      public function store(Request $request){
          ...
          $condition = new NewsletterCondition;
    ...
    public function destroy($slack){
        $condition = NewsletterCondition::uid($slack);
        $condition->delete();
        return redirect()->route('manager.newsletters.conditions');
    }
