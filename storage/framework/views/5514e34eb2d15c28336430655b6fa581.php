...
© <?php echo new EncodedHtmlString(date('Y')); ?> <?php echo new EncodedHtmlString(config('app.name')); ?>. <?php echo new EncodedHtmlString(__('All rights reserved.')); ?>
...
<?php } ?>
<?php /**PATH /Users/developerts/Herd/system/resources/views/vendor/mail/html/message.blade.php ENDPATH**/ ?>