...
$__env->startSection('page_title', 'Editar Componente: '.$component->subject); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <form method="POST" action="<?php echo e(route('mailers.components.update', $component->uid)); ?>" id="formEdit">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                            ...
                            <div class="col-12 col-md-12">
                                ...
                                <select class="form-select select2 <?php $__errorArgs = ['type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?>" id="type" name="type" required>
                                    <option value="partial" <?php if ($component->type === 'partial') { ?> selected <?php } ?>>Parcial</option>
                                    <option value="layout" <?php if ($component->type === 'layout') { ?> selected <?php } ?>>Layout</option>
                                    <option value="component" <?php if ($component->type === 'component') { ?> selected <?php } ?>>Componente</option>
                                </select>
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                            ...
                            <div class="col-12 col-md-12">
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" role="switch" id="is_protected" name="is_protected" value="1" <?php if (old('is_protected', $component->is_protected)) { ?> checked <?php } ?>>
                        ...
                        <div class="alert alert-info border-0 mb-0 mt-3 d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    <span><strong>Alias:</strong> <code class="text-primary"><?php echo e($component->alias); ?></code></span>
                                    <span class="text-muted">•</span>
                                    <span><strong>Código:</strong> <code class="text-primary"><?php echo e($component->code); ?></code></span>
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if (in_array($component->alias, ['email_template_header', 'email_template_footer', 'email_template_wrapper'])) { ?>
                    ...
                    <div class="card-footer bg-white border-top">
                        ...
                        <a href="<?php echo e(route('mailers.components.preview', ['uid' => $component->uid, 'lang_id' => $currentLangId ?? 1])); ?>" class="btn btn-info w-100 mb-1" target="_blank">
                            Vista previa
                        </a>

                        <a href="<?php echo e(route('mailers.components.index')); ?>" class="btn btn-secondary w-100">
                            Volver
                        </a>
                    </div>
                </div>
                            ...
                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if (! empty($langs) && $langs->count() > 1) { ?>
                                ...
                                foreach ($__currentLoopData as $lang) {
                                    ...
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($lang->id !== $currentLangId) { ?>
                                        ...
                                        ?>
                                        <a href="<?php echo e(route('mailers.components.edit', ['uid' => $component->uid, 'lang_id' => $lang->id])); ?>"
                    ...
                    <div class="card-footer bg-light p-2  text-muted">
                        <div class="d-flex gap-3 flex-wrap">
                            <span>
                                ...
                                <strong><?php echo e($component->translations->where('subject', '!=', null)->where('content', '!=', null)->count()); ?></strong> completas
                            </span>
                            <span>
                                <i class="fas fa-exclamation-circle text-warning me-1"></i>
                                <strong><?php echo e($langs->count() - $component->translations->where('subject', '!=', null)->where('content', '!=', null)->count()); ?></strong> pendientes
                            </span>
                        </div>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    function updatePreview() {
        const previewUrl = `<?php echo e(route('mailers.components.preview-ajax', $component->uid)); ?>?lang_id=${currentLangId}`;
    ...
    function loadVariables() {
        $.ajax({
            url: '<?php echo e(route('mailers.components.variables')); ?>',
            type: 'GET',
            dataType: 'json',
            success: function(data) {
                if (data.success) {
...
<?php echo $__env->make('layouts.theme', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/developerts/Herd/system/modules/Mailer/app/Providers/../../resources/views/components/edit.blade.php ENDPATH**/ ?>