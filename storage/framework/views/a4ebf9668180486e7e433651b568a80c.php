...
$__env->startSection('page_title', 'Editar página'); ?>

<?php $__env->startSection('content'); ?>

    <?php echo $__env->make('core::components.card', ['title' => 'Editar página: '.$page->title], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <form action="<?php echo e(route('pages.update', $page->id)); ?>" method="POST" enctype="multipart/form-data" id="pageForm">
        <?php echo csrf_field(); ?>
            ...
            <div class="col-lg-8 order-lg-1">
                ...
                <div class="card mb-3">
                    <ul class="nav nav-tabs border-0 user-profile-tab" id="langTabs" role="tablist">
                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php SupportCompiledWireKeys::openLoop(); ?><?php } ?><?php $__currentLoopData = $locales;
$__env->addLoop($__currentLoopData);
foreach ($__currentLoopData as $localeObj) {
    ...
    $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                            <?php $locale = $localeObj->code;
    $t = $translations->get($locale); ?>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-3 <?php echo e($loop->first ? 'active' : ''); ?>"
                                        id="tab-btn-<?php echo e($locale); ?>"
                                        data-bs-toggle="tab"
                                        data-bs-target="#pane-<?php echo e($locale); ?>"
                                        data-locale="<?php echo e($locale); ?>"
                                        type="button" role="tab">
                                    <span class="d-none d-md-block">
                                        <?php echo e($localeObj->name); ?>
...
foreach ($__currentLoopData as $localeObj) {
    ...
    $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                            <?php $locale = $localeObj->code;
    $t = $translations->get($locale); ?>
                            <div class="tab-pane fade <?php echo e($loop->first ? 'show active' : ''); ?> p-4"
                                 id="pane-<?php echo e($locale); ?>" role="tabpanel">

                                
                                <div class="mb-3">
                                    <label for="title-<?php echo e($locale); ?>" class="form-label fw-semibold">Nombre</label>
                                    <input type="text"
                                           class="form-control <?php $__errorArgs = ['translations.'.$locale.'.title'];
    ...
    unset($__errorArgs, $__bag); ?>"
                                           id="title-<?php echo e($locale); ?>"
                                           name="translations[<?php echo e($locale); ?>][title]"
                                           value="<?php echo e(old('translations.'.$locale.'.title', $t?->title)); ?>"
                                           maxlength="255">
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['translations.'.$locale.'.title'];
    $__bag = $errors->getBag($__errorArgs[1] ?? 'default');
    if ($__bag->has($__errorArgs[0])) {
        if (isset($message)) {
            $__messageOriginal = $message;
    ...
    unset($__errorArgs, $__bag); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                                ...
                                <?php $prefix = setting('permalink-modules-page-models-page', ''); ?>
                                <div class="mb-3">
                                    <label for="slug-<?php echo e($locale); ?>" class="form-label fw-semibold">Enlace permanente</label>
                                    <div class="input-group">
                                <span class="input-group-text text-muted">
                                    <?php echo e($prefix ? url($prefix).'/' : url('/').'/'); ?>

                                </span>
                                        <input type="text"
                                               class="form-control <?php $__errorArgs = ['translations.'.$locale.'.slug'];
    $__bag = $errors->getBag($__errorArgs[1] ?? 'default');
    if ($__bag->has($__errorArgs[0])) {
        if (isset($message)) {
            $__messageOriginal = $message;
    ...
    unset($__errorArgs, $__bag); ?>"
                                               id="slug-<?php echo e($locale); ?>"
                                               name="translations[<?php echo e($locale); ?>][slug]"
                                               value="<?php echo e(old('translations.'.$locale.'.slug', $t?->slug)); ?>"
                                               placeholder="slug-de-la-pagina">
                                        <button type="button" class="btn btn-info"
                                                onclick="regenerateSlugForLocale('<?php echo e($locale); ?>')">
                                                <i class="fas fa-wand-magic-sparkles"></i>
                                        </button>
                                    </div>
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['translations.'.$locale.'.slug'];
    $__bag = $errors->getBag($__errorArgs[1] ?? 'default');
    if ($__bag->has($__errorArgs[0])) {
        if (isset($message)) {
            $__messageOriginal = $message;
    ...
    unset($__errorArgs, $__bag); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                                    <?php $slugVal = old('translations.'.$locale.'.slug', $translations[$locale]?->slug ?? null); ?>
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($slugVal) { ?>
                                        <div class="mt-1">
                                            <a href="<?php echo e($prefix ? url($prefix.'/'.$slugVal) : url($slugVal)); ?>"
                                               target="_blank"
                                               class="text-decoration-none small text-muted"
                                               id="view-link-<?php echo e($locale); ?>">
                                                <?php echo e($prefix ? url($prefix.'/'.$slugVal) : url($slugVal)); ?>
                                ...
                                <div class="mb-3">
                                    <label for="description-<?php echo e($locale); ?>" class="form-label fw-semibold">Descripción</label>
                                    <textarea class="form-control <?php $__errorArgs = ['translations.'.$locale.'.description'];
    $__bag = $errors->getBag($__errorArgs[1] ?? 'default');
    if ($__bag->has($__errorArgs[0])) {
        if (isset($message)) {
            $__messageOriginal = $message;
    ...
    unset($__errorArgs, $__bag); ?>"
                                              id="description-<?php echo e($locale); ?>"
                                              name="translations[<?php echo e($locale); ?>][description]"
                                              rows="3" maxlength="500"
                                              placeholder="Descripción corta"><?php echo e(old('translations.'.$locale.'.description', $t?->description)); ?></textarea>
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['translations.'.$locale.'.description'];
    $__bag = $errors->getBag($__errorArgs[1] ?? 'default');
    if ($__bag->has($__errorArgs[0])) {
        if (isset($message)) {
            $__messageOriginal = $message;
    ...
    unset($__errorArgs, $__bag); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                                ...
                                <div class="mb-3">
                                    <div class="d-flex align-items-start justify-content-between mb-2 gap-2">
                                        ...
                                        <div class="d-flex gap-1 flex-shrink-0 justify-content-center align-items-center">
                                            <button type="button"
                                                    ...
                                                    onclick="toggleEditor('<?php echo e($locale); ?>')"
                                    ...
                                    <div id="editorWrapper-<?php echo e($locale); ?>" class="mt-3 d-none">
                                        <textarea id="content-<?php echo e($locale); ?>"
                                          name="translations[<?php echo e($locale); ?>][content]"
                                          class="<?php $__errorArgs = ['translations.'.$locale.'.content'];
    $__bag = $errors->getBag($__errorArgs[1] ?? 'default');
    if ($__bag->has($__errorArgs[0])) {
        if (isset($message)) {
            $__messageOriginal = $message;
    ...
    unset($__errorArgs, $__bag); ?>"><?php echo e(old('translations.'.$locale.'.content', $t?->content)); ?></textarea>
                                    </div>
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['translations.'.$locale.'.content'];
    $__bag = $errors->getBag($__errorArgs[1] ?? 'default');
    if ($__bag->has($__errorArgs[0])) {
        if (isset($message)) {
            $__messageOriginal = $message;
...
foreach ($__currentLoopData as $localeObj) {
    ...
    $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                                <?php $locale = $localeObj->code;
    $tData = $translationData[$locale]; ?>
                                <input type="hidden" class="trans-status-hidden" id="trans-status-<?php echo e($locale); ?>"
                                       name="translations[<?php echo e($locale); ?>][status]" data-locale="<?php echo e($locale); ?>"
                                       value="<?php echo e($tData['status']); ?>">
                                <input type="hidden" class="trans-published-at-hidden" id="trans-published-at-<?php echo e($locale); ?>"
                                       name="translations[<?php echo e($locale); ?>][published_at]" data-locale="<?php echo e($locale); ?>"
                                       value="<?php echo e($tData['published_at']); ?>">
                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::endLoop(); ?><?php } ?><?php } $__env->popLoop();
$loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php SupportCompiledWireKeys::closeLoop(); ?><?php } ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-select <?php $__errorArgs = ['header_style'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?> select2"
                                    ...
                                    <option value="header-style-1" <?php echo e(old('header_style', $page->header_style) === 'header-style-1' ? 'selected' : ''); ?>>Por defecto</option>
                                    <option value="header-style-2" <?php echo e(old('header_style', $page->header_style) === 'header-style-2' ? 'selected' : ''); ?>>Estilo de encabezado 2</option>
                                    <option value="header-style-3" <?php echo e(old('header_style', $page->header_style) === 'header-style-3' ? 'selected' : ''); ?>>Estilo de encabezado 3</option>
                                    <option value="header-style-4" <?php echo e(old('header_style', $page->header_style) === 'header-style-4' ? 'selected' : ''); ?>>Estilo de encabezado 4</option>
                                </select>
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['header_style'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-select <?php $__errorArgs = ['template'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?> select2" id="template" name="template">
...
foreach ($__currentLoopData as $key => $label) {
    $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                                        <option value="<?php echo e($key); ?>" <?php echo e(old('template', $page->template) === $key ? 'selected' : ''); ?>>
                                            <?php echo e($label); ?>
...
$loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php SupportCompiledWireKeys::closeLoop(); ?><?php } ?>
                                ...
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['template'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="datetime-local" class="form-control <?php $__errorArgs = ['publish_at'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       value="<?php echo e(old('publish_at', $page->publish_at?->format('Y-m-d\TH:i'))); ?>">
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['publish_at'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="datetime-local" class="form-control <?php $__errorArgs = ['unpublish_at'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       value="<?php echo e(old('unpublish_at', $page->unpublish_at?->format('Y-m-d\TH:i'))); ?>">
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['unpublish_at'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                            ...
                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($page->willBePublished() || $page->willBeUnpublished()) { ?>
                            <div class="col-12">
                                <div class="alert alert-info mb-0 py-2">
                                    <small>
                                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($page->willBePublished()) { ?>
                                            <i class="fas fa-clock me-1"></i> Se publica el <?php echo e($page->publish_at->format('d/m/Y H:i')); ?><br>
                                        <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($page->willBeUnpublished()) { ?>
                                            <i class="fas fa-clock me-1"></i> Se despublica el <?php echo e($page->unpublish_at->format('d/m/Y H:i')); ?>
                            ...
                            <?php $selectedCategories = old('categories', $page->categories->pluck('id')->toArray()); ?>
                            <input type="hidden" name="status" value="<?php echo e($page->status?->value ?? $page->status); ?>">
                            <div class="col-md-12">
                                <label for="parent_id" class="form-label fw-semibold">Página padre</label>
                                <select class="form-select select2 <?php $__errorArgs = ['parent_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php SupportCompiledWireKeys::openLoop(); ?><?php } ?><?php $__currentLoopData = Page::root()->where('id', '!=', $page->id)->orderBy('title')->get(['id', 'title']);
$__env->addLoop($__currentLoopData);
foreach ($__currentLoopData as $parentPage) {
    $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
...
$loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php SupportCompiledWireKeys::closeLoop(); ?><?php } ?>
                                ...
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['parent_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <select id="categories-select" name="categories[]"
                                        class="form-select select2 <?php $__errorArgs = ['categories'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
$loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php SupportCompiledWireKeys::closeLoop(); ?><?php } ?>
                                ...
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['categories'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control <?php $__errorArgs = ['tags_input'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?>"
                                       ...
                                       value="<?php echo e(old('tags_input', $page->tags->pluck('name')->join(', '))); ?>">
                                <small class="form-text text-muted">Separa los tags con comas</small>
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['tags_input'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="hidden" id="featured_image_url" name="featured_image_url"
                                       value="<?php echo e(old('featured_image_url', $page->featured_image_url ?? $page->featured_image)); ?>">
                                <div id="imagePreviewContainer" class="mb-2">
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($page->featured_image) { ?>
                                        <div class="position-relative">
                                            <img src="<?php echo e($page->featured_image); ?>" alt="Imagen destacada" id="featuredImagePreview"
            ...
            <div class="col-lg-4 order-lg-2">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body d-grid gap-2">
                        ...
                        <a href="<?php echo e(route('pages.visual-editor', $page)); ?>?locale=<?php echo e($locales->first()?->code); ?>" class="btn btn-primary" id="btn-editor-visual">
                            Editor visual
                        </a>
                        ...
                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($page->hasVersions()) { ?>
                            <a href="<?php echo e(route('pages.versions.index', $page->id)); ?>" class="btn btn-outline-secondary">
                                Ver versiones (<?php echo e($page->getTotalVersions()); ?>)
                            </a>
                        <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                        <?php $firstLocaleCode = $locales->first()?->code ?? ''; ?>
                        <div id="form-unpublish-action" style="<?php echo e(($translationData[$firstLocaleCode]['status'] ?? '') !== 'published' ? 'display:none;' : ''); ?>">
                            <form action="<?php echo e(route('pages.unpublish', $page->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn btn-outline-secondary w-100">Despublicar</button>
                            </form>
                        </div>
                        <div id="form-publish-action" style="<?php echo e(($translationData[$firstLocaleCode]['status'] ?? '') === 'published' ? 'display:none;' : ''); ?>">
                            <form action="<?php echo e(route('pages.publish', $page->id)); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <button type="submit" class="btn btn-outline-secondary w-100">Publicar ahora</button>
                            </form>
                        </div>
                        <form action="<?php echo e(route('pages.duplicate', $page->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="mb-2">
                            ...
                            <strong><?php echo e($page->created_at->format('d/m/Y H:i')); ?></strong>
                        </div>
                        <div class="mb-2">
                            <span class="text-muted d-block">Modificado</span>
                            <strong><?php echo e($page->updated_at->format('d/m/Y H:i')); ?></strong>
                        </div>
                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($page->user) { ?>
                            <div class="mb-2">
                                <span class="text-muted d-block">Autor</span>
                                <strong><?php echo e($page->user->full_name ?? $page->user->name); ?></strong>
                            </div>
                        <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($page->hasVersions()) { ?>
                            <div class="mb-2">
                                <span class="text-muted d-block">Versiones</span>
                                <strong><?php echo e($page->getTotalVersions()); ?></strong>
                            </div>
                        <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                        <?php
...
?>
                        <div>
                            ...
                            <?php $statusVal = $page->status instanceof PageStatus ? $page->status->value : $page->status; ?>
                            <span class="badge <?php echo e($badges[$statusVal] ?? 'bg-secondary-subtle text-secondary'); ?>">
                                <?php echo e($labels[$statusVal] ?? $statusVal); ?>
                ...
                <div class="card mb-3">
                    <div class="card-body p-4">
                        ...
                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($seoMeta) { ?>
                            <?php
        $seoScore = $seoMeta->seo_score;
                            $seoGrade = $seoMeta->seo_grade;
                            if ($seoScore >= 80) {
                                $sBg = 'bg-success-subtle';
                                $sTxt = 'text-success';
                                $sIbg = 'text-bg-success';
                                $sLabel = 'Excelente';
                            } elseif ($seoScore >= 60) {
                                $sBg = 'bg-primary-subtle';
                                $sTxt = 'text-primary';
                                $sIbg = 'text-bg-primary';
                                $sLabel = 'Bueno';
                            } elseif ($seoScore >= 40) {
                                $sBg = 'bg-warning-subtle';
                                $sTxt = 'text-warning';
                                $sIbg = 'text-bg-warning';
                                $sLabel = 'Mejorable';
                            } else {
                                $sBg = 'bg-danger-subtle';
                                $sTxt = 'text-danger';
                                $sIbg = 'text-bg-danger';
                                $sLabel = 'Bajo';
                            }
                            ...
                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($seoScore) { ?>
                                <div class="rounded-3 p-3 mb-3 d-flex align-items-center justify-content-between <?php echo e($sBg); ?>">
                                    <div>
                                        <div class="text-muted small mb-1">Score SEO</div>
                                        <div class="d-flex align-items-center gap-2">
                                            <span class="fw-bold fs-4 <?php echo e($sTxt); ?>"><?php echo e($seoScore); ?><span class="fs-6 fw-normal text-muted">/100</span></span>
                                            <span class="badge <?php echo e($sIbg); ?>"><?php echo e($sLabel); ?></span>
                                        </div>
                                    </div>
                                    <div class="rounded-circle d-flex align-items-center justify-content-center fw-bold fs-4 <?php echo e($sTxt); ?>"
                            ...
                            <div class="card shadow-none mb-0">
                                <div class="card-body p-0">
                                    <dl class="mb-3 small">
                                        ...
                                        <dd class="fw-semibold mb-3 text-truncate"><?php echo e($seoMeta->title ?: '—'); ?></dd>
                                        <dt class="text-muted fw-normal mb-1">Descripción</dt>
                                        <dd class="text-muted mb-0" style="display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;"><?php echo e($seoMeta->description ?: '—'); ?></dd>
                                    </dl>
                                    <a href="<?php echo e(route('setting.seo.metas.edit', $seoMeta)); ?>" class="btn btn-info w-100">
                                        Editar SEO
                                    </a>
                                </div>
                            </div>
                ...
                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if (count($locales) > 1) { ?>
                    <div class="card mb-3">
                        <div class="card-header p-3 bg-white border-bottom">
                    ...
                    foreach ($__currentLoopData as $localeObj) {
                        $__env->incrementLoopIndices();
                        $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                                        <option value="<?php echo e($localeObj->code); ?>"><?php echo e($localeObj->name); ?></option>
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::endLoop(); ?><?php } ?><?php } $__env->popLoop();
                    $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php SupportCompiledWireKeys::closeLoop(); ?><?php } ?>
                                </select>
                            </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-footer" >
                            <a href="<?php echo e(route('pages.analytics.view', $page->id)); ?>" class="btn btn-info w-100 mb-1">
                                Analytics
                            </a>
...
?>
    <?php echo $__env->make('theme::partials.ui-blocks-modal', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $__env->startPush('scripts-head'); ?>
    <script src="<?php echo e(asset('core/tinymce/tinymce.min.js')); ?>"></script>
<?php $__env->stopPush(); ?>
...
$(document).ready(function () {
    ...
    // =========================================================
    var mediaUploadUrl = '<?php echo e(route('media.files.upload')); ?>';
    var mediaBaseUrl = '<?php echo e(url('media')); ?>';
    var initializedEditors = {};
    var activeLocale = '<?php echo e($locales->first()?->code ?? ''); ?>';
    var translationData = <?php echo json_encode($translationData, 15, 512) ?>;
    var visualEditorBaseUrl = '<?php echo e(route('pages.visual-editor', $page)); ?>';
    ...
    initEditorForLocale('<?php echo e($locales->first()->code); ?>');
    <?php } ?>
    ...
    $(document).on('click', '.add-media-btn', function () {
        ...
        window.MediaPicker.open({
            urls: {
                list:   '<?php echo e(route('media.list')); ?>',
                upload: '<?php echo e(route('media.files.upload')); ?>',
                base:   '<?php echo e(url('media')); ?>',
            },
    ...
    var uiBlocksData = <?php echo json_encode($shortcodes, 15, 512) ?>;
    ...
    $('#generatePreviewBtn').on('click', function () {
        ...
        $.ajax({
            url: '<?php echo e(route('pages.preview.generate', $page->id)); ?>',
            method: 'POST',
    ...
    $('#revokePreviewBtn').on('click', function () {
        ...
        $.ajax({
            url: '<?php echo e(route('pages.preview.revoke', $page->id)); ?>',
            method: 'POST',
            headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
            success: function (data) {
    ...
    $.get('<?php echo e(route('pages.preview.index', $page->id)); ?>', function (data) {
    ...
    toastr.success(<?php echo json_encode(session('success'), 15, 512) ?>, 'Éxito');
    <?php } ?>
    ...
    var autoSaveTimeout;
    var autoSaveUrl = '<?php echo e(route('api.pages.auto-save', $page->id)); ?>';
    var lastSavedData = {};
    ...
    function collectAutoSaveData() {
        ...
        <?php $__currentLoopData = $locales;
$__env->addLoop($__currentLoopData);
foreach ($__currentLoopData as $localeObj) {
    $__env->incrementLoopIndices();
    $loop = $__env->getLastLoop(); ?>
        <?php $locale = $localeObj->code; ?>
        data.translations['<?php echo e($locale); ?>'] = {
            title: $('#title-<?php echo e($locale); ?>').val(),
            slug: $('#slug-<?php echo e($locale); ?>').val(),
            description: $('#description-<?php echo e($locale); ?>').val(),
            content: tinymce.get('content-<?php echo e($locale); ?>') ? tinymce.get('content-<?php echo e($locale); ?>').getContent() : $('#content-<?php echo e($locale); ?>').val(),
        };
        <?php } $__env->popLoop();
$loop = $__env->getLastLoop(); ?>
        return data;
    ...
    // =========================================================
    var pageId = <?php echo e($page->id); ?>;
    var lockCheckUrl = '<?php echo e(route('api.pages.lock.check', $page->id)); ?>';
    var lockAcquireUrl = '<?php echo e(route('api.pages.lock.acquire', $page->id)); ?>';
    var lockReleaseUrl = '<?php echo e(route('api.pages.lock.release', $page->id)); ?>';
    var lockRenewUrl = '<?php echo e(route('api.pages.lock.renew', $page->id)); ?>';
    ...
    updateSidebarForLocale(activeLocale || '<?php echo e($locales->first()?->code ?? ''); ?>');
    ...
    if (typeof Reverb !== 'undefined' && typeof Echo !== 'undefined') {
        ...
        channel.listen('lock-acquired', function(data) {
            ...
            if (data.locked_by.id !== <?php echo e(auth()->id()); ?>) {
                showLockAlert({
                    is_locked: true,
        ...
        channel.listen('lock-released', function(data) {
            ...
            if (data.released_by_user_id !== <?php echo e(auth()->id()); ?>) {
                $('#lockAlert').fadeOut();
        ...
        channel.listen('auto-saved', function(data) {
            ...
            if (data.saved_by.id !== <?php echo e(auth()->id()); ?>) {
...
function updateViewLink(locale) {
    var baseUrl = '<?php echo e($prefix ? url($prefix).'/' : url('/').'/'); ?>';
...
function regenerateSlugForLocale(locale) {
    ...
    <?php
$slugAjaxUrl = Route::has('pages.ajax.slug') ? route('pages.ajax.slug') : null;
?>
    <?php if ($slugAjaxUrl) { ?>
    $.post('<?php echo e($slugAjaxUrl); ?>', {
        title: title,
        ignoreId: <?php echo e($page->id); ?>,
...
// =========================================================
var perfScanUrl  = '<?php echo e(route('pages.performance.scan', $page->id)); ?>';
var perfShowUrl  = '<?php echo e(route('pages.performance.show', $page->id)); ?>';
...
// ANALYTICS DE VISTAS
// =========================================================
var analyticsUrl = '<?php echo e(route('pages.analytics.show', $page->id)); ?>';
...
// DEEPL TRANSLATION
// =========================================================
var pageDeeplTranslateUrl     = '<?php echo e(route('pages.translate', $page->id)); ?>';
var pageDeeplAutoTranslateUrl = '<?php echo e(route('pages.auto-translate', $page->id)); ?>';
...
<?php echo $__env->make('layouts.theme', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/developerts/Herd/system/modules/Page/resources/views/pages/pages/edit.blade.php ENDPATH**/ ?>