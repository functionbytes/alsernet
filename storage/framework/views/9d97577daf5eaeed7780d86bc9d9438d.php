...
$__env->startSection('content'); ?>
    ...
    <?php echo $__env->make('core::components.card', ['title' => 'Analytics Dashboard'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <div class="widget-content">

        <?php echo $__env->make('analytics::dashboard.partials._filters-bar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <?php echo $__env->make('analytics::dashboard.partials._kpi-cards', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <?php echo $__env->make('analytics::dashboard.partials._charts-row', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

        <?php echo $__env->make('analytics::dashboard.partials._tables-row', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    </div>

    
    <?php if (app(Gate::class)->check('analytics.dashboard.export')) { ?>
    <div class="modal fade" id="exportModal" tabindex="-1">
        ...
        ?>
                    <div class="d-flex flex-column gap-2">
                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php SupportCompiledWireKeys::openLoop(); ?><?php } ?><?php $__currentLoopData = $exports;
        $__env->addLoop($__currentLoopData);
        foreach ($__currentLoopData as $e) {
            ...
            $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                        <div class="d-flex align-items-center gap-3 p-3 rounded-3 border">
                            <div class="d-flex align-items-center justify-content-center rounded-2 flex-shrink-0"
                                ...
                                <i class="fas <?php echo e($e['icon']); ?>" style="color:#b10100;"></i>
                            </div>
                            <div style="min-width:0;flex:1;">
                                <div class="fw-semibold small"><?php echo e($e['label']); ?></div>
                                <div class="text-muted" style="font-size:0.72rem;"><?php echo e($e['desc']); ?></div>
                            </div>
                            <div class="d-flex gap-1 flex-shrink-0">
                                <button class="btn btn-sm btn-outline-secondary" style="font-size:0.72rem;padding:3px 8px;"
                                        onclick="exportData('<?php echo e($e['key']); ?>','json')">JSON</button>
                                <button class="btn btn-sm" style="font-size:0.72rem;padding:3px 8px;background:#b10100;color:#fff;border:none;"
                                        onclick="exportData('<?php echo e($e['key']); ?>','csv')">CSV</button>
                            </div>
                        </div>
...
(function () {
    ...
    let selectedRange = '<?php echo e($range); ?>';
    ...
    const routes = {
        overview:        '<?php echo e(route('api.analytics.overview')); ?>',
        topPages:        '<?php echo e(route('api.analytics.top-pages')); ?>',
        topBrowsers:     '<?php echo e(route('api.analytics.top-browsers')); ?>',
        topReferrers:    '<?php echo e(route('api.analytics.top-referrers')); ?>',
        topCountries:    '<?php echo e(route('api.analytics.top-countries')); ?>',
        deviceCategories:'<?php echo e(route('api.analytics.device-categories')); ?>',
        operatingSystems:'<?php echo e(route('api.analytics.operating-systems')); ?>',
        trafficSources:  '<?php echo e(route('api.analytics.traffic-sources')); ?>',
        sessionMetrics:  '<?php echo e(route('api.analytics.session-metrics')); ?>',
        realtime:        '<?php echo e(route('api.analytics.realtime')); ?>',
        landingPages:    '<?php echo e(route('api.analytics.landing-pages')); ?>',
        exitPages:       '<?php echo e(route('api.analytics.exit-pages')); ?>',
        channelTrend:    '<?php echo e(route('api.analytics.channel-trend')); ?>',
        hourlyHeatmap:   '<?php echo e(route('api.analytics.hourly-heatmap')); ?>',
        comparison:      '<?php echo e(route('api.analytics.comparison')); ?>',
        searchTerms:     '<?php echo e(route('api.analytics.search-terms')); ?>',
        userFlow:        '<?php echo e(route('api.analytics.user-flow')); ?>',
    };
        ...
        $.get(routes.topCountries, { range: selectedRange })
            .done(function (res) {
                ...
                if (countriesGeoData) { drawGeoLayer(countriesGeoData, maxSessions); }
                    ...
                    $.getJSON('<?php echo e(asset('vendor/leaflet/countries.geojson')); ?>')
...
<?php echo $__env->make('layouts.theme', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/developerts/Herd/system/modules/Analytics/app/Providers/../../resources/views/dashboard/index.blade.php ENDPATH**/ ?>