...
<li class="nav-item nav-icon-hover-bg rounded-circle dropdown"
    ...
    data-api-index-route="<?php echo e(route('api.notifications.index')); ?>"
    data-api-read-route="<?php echo e(url('/api/notifications/{id}/read')); ?>"
    data-mark-all-read-route="<?php echo e(route('api.notifications.mark-all-read')); ?>"
    ...
    <div class="dropdown-menu content-dd dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2" style="min-width: 360px; max-width: 400px;">
        ...
        <div class="border-top p-3">
            <a href="<?php echo e(route('notifications.index')); ?>" class="btn btn-primary w-100 d-flex align-items-center justify-content-center gap-2">
...
<?php $__env->startPush('scripts'); ?>
    <script src="<?php echo e(asset('modules/Notification/js/notifications.js')); ?>?v=<?php echo e(md5_file(base_path('modules/Notification/public/js/notifications.js'))); ?>"></script>
<?php $__env->stopPush(); ?>
<?php /**PATH /Users/developerts/Herd/system/modules/Notification/app/Providers/../../resources/views/components/notifications.blade.php ENDPATH**/ ?>