        ...
        <div class="col-md">
            <ul class="nav nav-pills gap-1 flex-nowrap overflow-auto" id="rangePills">
                <li class="nav-item flex-shrink-0">
                    <a class="nav-link py-1 px-3 small fw-semibold <?php
use Illuminate\Contracts\Auth\Access\Gate;

echo e($range === 'today' ? 'active' : 'text-muted'); ?>"
                       href="#" data-range="today">Hoy</a>
                </li>
                <li class="nav-item flex-shrink-0">
                    <a class="nav-link py-1 px-3 small fw-semibold <?php echo e($range === 'last_7_days' ? 'active' : 'text-muted'); ?>"
                       href="#" data-range="last_7_days">7 días</a>
                </li>
                <li class="nav-item flex-shrink-0">
                    <a class="nav-link py-1 px-3 small fw-semibold <?php echo e($range === 'last_30_days' ? 'active' : 'text-muted'); ?>"
                       href="#" data-range="last_30_days">30 días</a>
                </li>
                <li class="nav-item flex-shrink-0">
                    <a class="nav-link py-1 px-3 small fw-semibold <?php echo e($range === 'this_month' ? 'active' : 'text-muted'); ?>"
                       href="#" data-range="this_month">Este mes</a>
                </li>
                <li class="nav-item flex-shrink-0">
                    <a class="nav-link py-1 px-3 small fw-semibold <?php echo e($range === 'last_month' ? 'active' : 'text-muted'); ?>"
                       href="#" data-range="last_month">Mes anterior</a>
                </li>
                <li class="nav-item flex-shrink-0">
                    <a class="nav-link py-1 px-3 small fw-semibold <?php echo e($range === 'this_year' ? 'active' : 'text-muted'); ?>"
...
<?php /**PATH /Users/developerts/Herd/system/modules/Analytics/app/Providers/../../resources/views/dashboard/partials/_filters-bar.blade.php ENDPATH**/ ?>