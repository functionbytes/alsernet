...
$__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <?php echo $__env->make('core::components.card', ['title' => 'Limpieza de Base de Datos'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="card-body position-relative">
                                            <div class="d-flex justify-content-between align-items-start">
                                                <div>
                                                    ...
                                                    <h2 id="totalRecords"><?php echo e(array_sum(array_column($tables, 'records'))); ?></h2>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody id="tablesList">
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php SupportCompiledWireKeys::openLoop(); ?><?php } ?><?php $__currentLoopData = $tables;
$__env->addLoop($__currentLoopData);
foreach ($__currentLoopData as $table) {
    ...
    $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                                        <tr class="table-row" data-table-name="<?php echo e($table['name']); ?>"
                                            data-records="<?php echo e($table['records']); ?>">
                                            <td>
                                                <input type="checkbox" class="form-check-input table-checkbox"
                                                       name="tables[]" value="<?php echo e($table['name']); ?>">
                                            </td>
                                            <td>
                                                <code class="bg-light-secondary  p-2 rounded small text-black"><?php echo e($table['name']); ?></code>
                                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($table['records'] === 0) { ?>
                                                    <span class="badge bg-success ms-2">Vacía</span>
                                                <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                                            </td>
                                            <td class="text-end">
                                                <span class="badge bg-light-secondary  text-dark table-record-count"><?php echo e($table['records']); ?></span>
                                            </td>
                                        </tr>
...
$loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php SupportCompiledWireKeys::closeLoop(); ?><?php } ?>
                            ...
                            <div class="row">
                                <div class="border-top pt-1 mt-4 pt-2">
                                    ...
                                    <a href="<?php echo e(route('settings.database.index')); ?>"
                            ...
                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if (empty($tables)) { ?>
    ...
    <script>
        $(function () {
            ...
            $('#confirmCleanupBtn').on('click', function () {
                ...
                $.ajax({
                    url: '<?php echo e(route('settings.database.cleanup.truncate')); ?>',
                    method: 'POST',
...
<?php echo $__env->make('layouts.theme', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/developerts/Herd/system/modules/Database/resources/views/cleanup/index.blade.php ENDPATH**/ ?>