...
<script src="<?php echo e(asset('core/select2/js/select2.min.js')); ?>"></script>
<script src="<?php echo e(asset('core/validate/jquery.validate.min.js')); ?>"></script>
<script>
document.addEventListener('DOMContentLoaded', function () {
    ...
    var totalSteps  = 5;
    var currentStep = 1;
    var waPhone     = '<?php echo e(preg_replace('/[^0-9]/', '', theme_option('phone', '351913893833'))); ?>';
    var submitUrl   = '<?php echo e(url('/forms/presupuesto/submit')); ?>';
...
<?php echo $__env->make('template::layouts.default', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/developerts/Herd/system/platform/themes/caixilhariablanco/views/templates/estimate.blade.php ENDPATH**/ ?>