...
$__env->startSection('title', 'Gestionar solicitud #'.$submission->id); ?>

<?php $__env->startSection('content'); ?>

    <?php echo $__env->make('core::components.card', ['title' => 'Gestionar solicitud #'.$submission->id], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <button type="button" class="btn btn-outline-primary w-100" id="sendConfirmationBtn"
                                data-url="<?php echo e(route('forms.inbox.emails.send-confirmation', $submission)); ?>"
                                <?php if (! $submitterEmail) { ?> disabled title="Sin email registrado en el formulario" <?php } ?>>
                            Enviar confirmación
                        </button>
                    </div>
                    <hr class="my-3">
...
$__currentLoopData = $submission->notes->sortByDesc('created_at');
...
foreach ($__currentLoopData as $note) {
    ...
    $__empty_1 = false; ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                            <div class="border-bottom pb-2 mb-2">
                                <strong class="small"><?php echo e($note->user?->full_name ?? 'Sistema'); ?></strong><br>
                                <span class="small"><?php echo e($note->note); ?></span>
                                <small class="text-muted d-block"><?php echo e($note->created_at?->format('d/m/Y H:i')); ?></small>
                            </div>
...
if ($__empty_1) { ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::closeLoop(); ?><?php } ?>
            ...
            <div class="card mb-3">
                ...
                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($recentActions->count() > 0) { ?>
                    <div class="card-body p-0">
                        <div style="max-height: 260px; overflow-y: auto;">
                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php SupportCompiledWireKeys::openLoop(); ?><?php } ?><?php $__currentLoopData = $recentActions;
                    $__env->addLoop($__currentLoopData);
                    foreach ($__currentLoopData as $action) {
                        $__env->incrementLoopIndices();
                        $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                                <div class="border-bottom p-3 small">
                                    <div class="d-flex justify-content-between mb-1">
                                        ...
                                        <span class="fw-semibold text-end"><?php echo e($action->action_label); ?></span>
                                    </div>
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($action->description) { ?>
                                        <div class="d-flex justify-content-between mb-1">
                                    ...
                                    <div class="d-flex justify-content-between mb-1">
                                        ...
                                        <span class="fw-semibold text-end">
                                            <?php echo e($action->user ? ucfirst(strtolower($action->user->firstname ?? '')).' '.strtoupper(substr($action->user->lastname ?? '', 0, 1)).'.' : 'Sistema'); ?>

                                        </span>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <span class="text-muted">Fecha</span>
                                        <span class="fw-semibold"><?php echo e($action->created_at->format('d/m/Y H:i')); ?></span>
                                    </div>
                                </div>
                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::endLoop(); ?><?php } ?><?php } $__env->popLoop();
            ...
            <div class="card mb-3">
                ...
                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($recentEmails->count() > 0) { ?>
                    <div class="card-body p-0">
                        <div class="email-history-list">
                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php SupportCompiledWireKeys::openLoop(); ?><?php } ?><?php $__currentLoopData = $recentEmails;
                    $__env->addLoop($__currentLoopData);
                    foreach ($__currentLoopData as $email) {
                        $__env->incrementLoopIndices();
                        $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                                <a href="<?php echo e(route('forms.inbox.emails.preview', [$submission, $email])); ?>"
                                   class="email-item d-block text-decoration-none" target="_blank">
                                    <div class="d-flex flex-column">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <span class="fw-semibold small text-dark"><?php echo e($email->email_type_label); ?></span>
                                            <span class="badge bg-<?php echo e($email->status_color); ?>-subtle text-<?php echo e($email->status_color); ?>">
                                                <?php echo e($email->status_label); ?>

                                            </span>
                                        </div>
                                        <p class="text-muted mb-1" title="<?php echo e($email->subject); ?>">
                                            <?php echo e(Str::limit($email->subject, 45)); ?>

                                        </p>
                                        <small class="text-muted">
                                            <i class="fa fa-clock me-1"></i>
                                            <?php echo e(($email->sent_at ?? $email->created_at)->format('d/m/Y H:i')); ?>
                    ...
                    $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php SupportCompiledWireKeys::closeLoop(); ?><?php } ?>
                        ...
                        <div class="border-top p-3">
                            <a href="<?php echo e(route('forms.inbox.emails.index', $submission)); ?>" class="btn btn-primary w-100 btn-sm">
...
?>
                    ...
                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($totalChanges > 0) { ?>
                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($hasMore) { ?>
                            <div class="alert alert-info py-1 px-2 mb-2" role="alert">
                                <i class="fas fa-info-circle me-1"></i> Últimos <?php echo e($showLimit); ?>/<?php echo e($totalChanges); ?>

                            </div>
                        <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>

                        <div class="status-timeline-scroll <?php if ($hasMore) { ?> scrollable <?php } ?>"
                             <?php if ($hasMore) { ?> style="max-height: 350px; overflow-y: auto;" <?php } ?>>
                            <ul class="timeline-widget mb-0 list-unstyled">
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php SupportCompiledWireKeys::openLoop(); ?><?php } ?><?php $__currentLoopData = $statusChanges->take($showLimit);
                        $__env->addLoop($__currentLoopData);
                        foreach ($__currentLoopData as $change) {
                            $__env->incrementLoopIndices();
                            $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                                    <li class="p-3 border-bottom small">
                                        <div class="d-flex justify-content-between mb-1">
                                            <span class="text-muted">Fecha</span>
                                            <span class="fw-semibold"><?php echo e($change->created_at->format('d/m H:i')); ?></span>
                                        </div>
                                        <div class="d-flex justify-content-between mb-1">
                                            <span class="text-muted">Cambio</span>
                                            <span class="fw-semibold"><?php echo e($change->description); ?></span>
                                        </div>
                                        <div class="d-flex justify-content-between mb-1">
                                            <span class="text-muted">Actualizado por</span>
                                            <span class="fw-semibold"><?php echo e($change->user->full_name ?? 'Sistema'); ?></span>
                                        </div>
                                    </li>
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::endLoop(); ?><?php } ?><?php } $__env->popLoop();
                        $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php SupportCompiledWireKeys::closeLoop(); ?><?php } ?>
        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if (! $citizenInfo['name'] && ! $citizenInfo['lastname'] && ! $submitterEmail && ! $citizenInfo['phone']) { ?>
                    ...
                    <?php } else { ?>
                        <div class="row g-3">
                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($citizenInfo['name']) { ?>
                                <div class="col-sm-12 col-md-6">
                                    <label class="form-label fw-semibold">Nombre</label>
                                    <input type="text" class="form-control" value="<?php echo e($citizenInfo['name']); ?>" disabled>
                                </div>
                            <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($citizenInfo['lastname']) { ?>
                                <div class="col-sm-12 col-md-6">
                                    <label class="form-label fw-semibold">Apellido</label>
                                    <input type="text" class="form-control" value="<?php echo e($citizenInfo['lastname']); ?>" disabled>
                                </div>
                            <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($submitterEmail) { ?>
                                <div class="col-sm-12 col-md-6">
                                    <label class="form-label fw-semibold">Correo electrónico</label>
                                    <input type="text" class="form-control" value="<?php echo e($submitterEmail); ?>" disabled>
                                </div>
                            <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($citizenInfo['phone']) { ?>
                                <div class="col-sm-12 col-md-6">
                                    <label class="form-label fw-semibold">Teléfono</label>
                                    <input type="text" class="form-control" value="<?php echo e($citizenInfo['phone']); ?>" disabled>
                                </div>
                            <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                        </div>
                    <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-sm-12 col-md-6">
                            ...
                            <input type="text" class="form-control" value="#<?php echo e($submission->id); ?>" disabled>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <label class="form-label fw-semibold">Formulario</label>
                            <input type="text" class="form-control" value="<?php echo e($submission->form->name ?? '—'); ?>" disabled>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <label class="form-label fw-semibold">Estado actual</label>
                            <input type="text" class="form-control" value="<?php echo e($st['label']); ?>" disabled>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <label class="form-label fw-semibold">Asignado a</label>
                            <input type="text" class="form-control"
                                   value="<?php echo e($submission->assignedTo?->full_name ?? 'Sin asignar'); ?>" disabled>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <label class="form-label fw-semibold">Fecha de envío</label>
                            <input type="text" class="form-control"
                                   value="<?php echo e($submission->created_at?->format('d/m/Y H:i:s') ?? '—'); ?>" disabled>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <label class="form-label fw-semibold">Última actualización</label>
                            <input type="text" class="form-control"
                                   value="<?php echo e($submission->updated_at?->format('d/m/Y H:i:s') ?? '—'); ?>" disabled>
                        </div>
                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($submission->ip_address) { ?>
                            <div class="col-sm-12 col-md-6">
                                <label class="form-label fw-semibold">IP</label>
                                <input type="text" class="form-control" value="<?php echo e($submission->ip_address); ?>" disabled>
                            </div>
                        <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($submission->country || $submission->city) { ?>
                            <div class="col-sm-12 col-md-6">
                                <label class="form-label fw-semibold">País / Ciudad</label>
                                <input type="text" class="form-control"
                                       value="<?php echo e(implode(', ', array_filter([$submission->country, $submission->city]))); ?>" disabled>
                            </div>
                        <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                    </div>
                </div>
...
foreach ($__currentLoopData as $user) {
    ...
    $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                                        <option value="<?php echo e($user->id); ?>"
                                            <?php echo e($submission->assigned_to == $user->id ? 'selected' : ''); ?>>
...
$loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php SupportCompiledWireKeys::closeLoop(); ?><?php } ?>
                            ...
                            <div class="col-12">
                                ...
                                <a href="<?php echo e(route('forms.inbox.show', $submission)); ?>" class="btn btn-secondary w-100  mb-1">
                                    Ver detalles
                                </a>
                                <a href="<?php echo e(route('forms.inbox.index')); ?>" class="btn btn-outline-secondary w-100">
                                    Volver al inbox
                                </a>
                            </div>
                        </div>
            ...
            <div class="card mb-3">
                <div class="card-header p-3 bg-white border-bottom">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span class="badge bg-primary"><?php echo e($submission->files->count()); ?> archivo(s)</span>
                    </div>
                </div>
                <div class="card-body" id="filesContainer">
                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($submission->files->count() > 0) { ?>
                        <div class="list-group mb-3" id="filesList">
                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php SupportCompiledWireKeys::openLoop(); ?><?php } ?><?php $__currentLoopData = $submission->files;
                        $__env->addLoop($__currentLoopData);
                        foreach ($__currentLoopData as $file) {
                            $__env->incrementLoopIndices();
                            $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                                <div class="list-group-item d-flex justify-content-between align-items-center" data-file-id="<?php echo e($file->id); ?>">
                                    <div class="d-flex align-items-center flex-grow-1">
                                        <i class="fas fa-file text-primary me-2"></i>
                                        <div>
                                            <p class="mb-0 fw-semibold small"><?php echo e($file->filename); ?></p>
                                            <small class="text-muted">
                                                <?php echo e($file->size_formatted); ?> •
                                                <?php echo e($file->created_at->format('d/m/Y H:i')); ?>

                                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($file->uploader) { ?>
                                                    • <?php echo e($file->uploader->full_name); ?>
                                    ...
                                    <div class="d-flex gap-2">
                                        <a href="<?php echo e($file->url); ?>" class="btn btn-sm btn-primary" target="_blank" title="Descargar">
                                            <i class="fa fa-download"></i>
                                        </a>
                                        <button type="button" class="btn btn-sm btn-danger btn-delete-file"
                                                data-file-id="<?php echo e($file->id); ?>" title="Eliminar">
...
$(document).ready(function () {
    const addNoteUrl     = '<?php echo e(route('settings.forms.submissions.notes.add', [$submission->form, $submission])); ?>';
    const manageUrl      = '<?php echo e(route('forms.inbox.manage.update', $submission)); ?>';
    const uploadFileUrl  = '<?php echo e(route('forms.inbox.files.upload', $submission)); ?>';
    const deleteFileBase = '<?php echo e(route('forms.inbox.files.delete', [$submission, '__FILE_ID__'])); ?>';
    const customEmailUrl = '<?php echo e(route('forms.inbox.emails.send-custom', $submission)); ?>';
...
<?php echo $__env->make('layouts.theme', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/developerts/Herd/system/modules/Forms/resources/views/inbox/manage.blade.php ENDPATH**/ ?>