...
$__env->startSection('title', 'Meta SEO'); ?>

<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('core::components.card', ['title' => 'Meta SEO'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <div class="widget-content searchable-container list">
        ...
        <div class="card">
                    ...
                    <div class="ms-auto">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="<?php echo e(route('setting.seo.metas.export')); ?>">Exportar CSV</a>
                                <a class="dropdown-item" href="<?php echo e(route('setting.seo.metas.import')); ?>">Importar CSV</a>
                                <a class="dropdown-item" href="<?php echo e(route('setting.seo.metas.export-json')); ?>">Exportar JSON</a>
                                <a class="dropdown-item" href="<?php echo e(route('setting.seo.metas.import-json')); ?>">Importar JSON</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="<?php echo e(route('setting.seo.audit.index')); ?>">Auditoría SEO</a>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between">
                                    <div>
                                        ...
                                        <h4 class="mb-1 fw-bold"><?php echo e(number_format($stats['indexable'])); ?></h4>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between">
                                    <div>
                                        ...
                                        <h4 class="mb-1 fw-bold"><?php echo e(number_format($stats['noindex'])); ?></h4>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between">
                                    <div>
                                        ...
                                        <h4 class="mb-1 fw-bold"><?php echo e(number_format($stats['missing_description'] + $stats['missing_og_image'])); ?></h4>
                                        <small class="text-muted"><?php echo e($stats['missing_description']); ?> sin desc. / <?php echo e($stats['missing_og_image']); ?> sin imagen OG</small>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-start justify-content-between">
                                    <div>
                                        ...
                                        <h4 class="mb-1 fw-bold"><?php echo e($stats['avg_score'] > 0 ? $stats['avg_score'] : '-'); ?></h4>
            ...
            <!-- Filters Section -->
            <div class="card-body border-bottom">
                <form method="GET" action="<?php echo e(route('setting.seo.metas.index')); ?>" id="filter-form">
                    ...
                    <div class="d-flex flex-column flex-lg-row gap-3 align-items-stretch">
                        ...
                        <div class="flex-shrink-0" style="min-width: 180px;">
                            <select name="seoable_type" class="form-select select2 h-100">
                                ...
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php SupportCompiledWireKeys::openLoop(); ?><?php } ?><?php $__currentLoopData = $seoableTypes;
$__env->addLoop($__currentLoopData);
foreach ($__currentLoopData as $type) {
    ...
    $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                                    <option value="<?php echo e($type); ?>" <?php if (request('seoable_type') === $type) {
                                        echo 'selected';
                                    } ?>>
...
$loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php SupportCompiledWireKeys::closeLoop(); ?><?php } ?>
                        ...
                        <div class="flex-shrink-0" style="min-width: 160px;">
                            <select name="sort_by" class="form-select select2 h-100">
                                <option value="updated_at" <?php if (request('sort_by', 'updated_at') === 'updated_at') {
                                    echo 'selected';
                                } ?>>Actualizado</option>
                                <option value="created_at" <?php if (request('sort_by') === 'created_at') {
                                    echo 'selected';
                                } ?>>Creado</option>
                                <option value="title" <?php if (request('sort_by') === 'title') {
                                    echo 'selected';
                                } ?>>Título</option>
                                <option value="seo_score" <?php if (request('sort_by') === 'seo_score') {
                                    echo 'selected';
                                } ?>>Score SEO</option>
                                <option value="seo_grade" <?php if (request('sort_by') === 'seo_grade') {
                                    echo 'selected';
                                } ?>>Grado SEO</option>
                            </select>
                        </div>
                        <div class="flex-shrink-0" style="min-width: 150px;">
                            <select name="sort_direction" class="form-select select2 h-100">
                                <option value="asc" <?php if (request('sort_direction', 'desc') === 'asc') {
                                    echo 'selected';
                                } ?>>Ascendente</option>
                                <option value="desc" <?php if (request('sort_direction', 'desc') === 'desc') {
                                    echo 'selected';
                                } ?>>Descendente</option>
                            </select>
                        </div>
                        <div class="d-flex gap-2 flex-shrink-0">
                            ...
                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if (request()->hasAny(['search', 'seoable_type', 'sort_by', 'sort_direction'])) { ?>
                                <a href="<?php echo e(route('setting.seo.metas.index', ['tab' => $tab])); ?>"
            ...
            <ul class="nav nav-tabs border-0 user-profile-tab" id="seo-settings-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a href="<?php echo e(route('setting.seo.metas.index', array_merge(request()->except('tab', 'page'), ['tab' => 'all']))); ?>"
                       class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-3 <?php echo e($tab === 'all' ? 'active' : ''); ?>"
                       role="tab">
                        <span class="d-none d-md-block">Todas</span>
                    </a>
                </li>
                <li class="nav-item" role="presentation">
                    <a href="<?php echo e(route('setting.seo.metas.index', array_merge(request()->except('tab', 'page'), ['tab' => 'indexable']))); ?>"
                       class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-3 <?php echo e($tab === 'indexable' ? 'active' : ''); ?>"
                       role="tab">
                        <span class="d-none d-md-block">Indexables</span>
                    </a>
                </li>
                <li class="nav-item" role="presentation">
                    <a href="<?php echo e(route('setting.seo.metas.index', array_merge(request()->except('tab', 'page'), ['tab' => 'noindex']))); ?>"
                       class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-3 <?php echo e($tab === 'noindex' ? 'active' : ''); ?>"
                       role="tab">
                        <span class="d-none d-md-block">No indexables</span>
                    </a>
                </li>
                <li class="nav-item" role="presentation">
                    <a href="<?php echo e(route('setting.seo.metas.index', array_merge(request()->except('tab', 'page'), ['tab' => 'unoptimized']))); ?>"
                       class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-3 <?php echo e($tab === 'unoptimized' ? 'active' : ''); ?>"
                       role="tab">
...
?>
                ...
                <div class="mb-3 d-flex justify-content-between align-items-center">
                    <div>
                        <h6 class="mb-1 fw-bold"><?php echo e($tabTitle); ?></h6>
                        <p class="text-muted mb-0"><?php echo e($tabSubtitle); ?></p>
                    </div>
                </div>
                ...
                <div class="alert alert-info border-0 bg-info-subtle mb-3">
                    <div class="d-flex align-items-start gap-2">
                        <div>
                            ...
                            <small class="d-block"><?php echo e($tabAlert); ?></small>
                        </div>
                    </div>
                </div>

                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($metas->count() > 0) { ?>
                    <form id="bulk-robots-form" method="POST" action="<?php echo e(route('setting.seo.metas.bulk-robots')); ?>" class="d-none">
                        <?php echo csrf_field(); ?>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            <thead class="table-light">
                                <tr>
                                    ...
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($tab === 'all' || $tab === 'indexable') { ?>
                                        <th class="text-center">Score</th>
                                    <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($tab === 'unoptimized') { ?>
                            ...
                            <tbody>
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php SupportCompiledWireKeys::openLoop(); ?><?php } ?><?php $__currentLoopData = $metas;
                    $__env->addLoop($__currentLoopData);
                    foreach ($__currentLoopData as $meta) {
                        $__env->incrementLoopIndices();
                        $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                                    <?php
                        ...
                        ?>
                                    <tr>
                                        <td>
                                            <input type="checkbox" class="form-check-input bulk-checkbox" value="<?php echo e($meta->id); ?>">
                                        </td>
                                        <td class="editable-cell" data-meta-id="<?php echo e($meta->id); ?>" data-field="title" data-original-value="<?php echo e($meta->title ?? ''); ?>" style="cursor:pointer;">
                                            <span class="cell-text text-muted">
                                                    <?php echo e(Str::limit($meta->title ?? 'Sin título', 50)); ?>

                                            </span>
                                            <span class="cell-text d-block">
                                                <small class="text-muted editable-cell" data-meta-id="<?php echo e($meta->id); ?>" data-field="description" data-original-value="<?php echo e($meta->description ?? ''); ?>" style="cursor:pointer;">
                                                    <?php echo e(Str::limit($meta->description ?? 'Sin descripción', 60)); ?>

                                                </small>
                                            </span>
                                        </td>
                                        <td>
                                            <span class="badge bg-light text-dark"><?php echo e($meta->short_type); ?></span>
                                        </td>
                                        <td>
                                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($meta->locale) { ?>
                                                <span class="badge bg-primary"><?php echo e(strtoupper($meta->locale)); ?></span>
                                            <?php } else { ?>
                                                <span class="badge bg-secondary">Global</span>
                                            <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                                        </td>
                                        <td>
                                            <small><?php echo e(Str::limit($meta->seoable?->title ?? $meta->seoable?->name ?? '#'.$meta->seoable_id, 30)); ?></small>
                                        </td>
                                        <td class="text-center">
                                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($hasNoindex) { ?>
                                                <span class="badge bg-danger-subtle text-danger"><?php echo e($robots); ?></span>
                                            <?php } elseif ($hasNofollow) { ?>
                                                <span class="badge bg-warning-subtle text-warning"><?php echo e($robots); ?></span>
                                            <?php } else { ?>
                                                <span class="badge bg-success-subtle text-success"><?php echo e($robots); ?></span>
                                            <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                                        </td>
                                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($tab === 'all' || $tab === 'indexable') { ?>
                                            <td class="text-center">
                                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($meta->seo_score !== null) { ?>
                                                    <?php
                                            $score = $meta->seo_score;
                                                    ...
                                                    ?>
                                                    <span class="badge <?php echo e($scoreBg); ?> text-white" title="<?php echo e($score); ?>"><?php echo e($scoreGrade); ?></span>
                                                <?php } else { ?>
                                        ...
                                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($tab === 'unoptimized') { ?>
                                            <td class="text-center">
                                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if (empty($meta->description)) { ?>
                                            ...
                                            <td class="text-center">
                                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if (empty($meta->og_image)) { ?>
                                                    <i class="fas fa-times-circle text-danger"></i>
                                                <?php } else { ?>
                                                    <i class="fas fa-check-circle text-success"></i>
                                                <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                                        ...
                                        <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                                        <td>
                                            <small class="text-muted"><?php echo e($meta->updated_at->diffForHumans()); ?></small>
                                        </td>
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li>
                                                        <a class="dropdown-item" href="<?php echo e(route('setting.seo.metas.show', $meta)); ?>">
                                                            Ver detalle
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="<?php echo e(route('setting.seo.metas.edit', $meta)); ?>">
                                                            Editar
                                                        </a>
                                                    </li>
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item delete-btn"
                                                           ...
                                                           data-url="<?php echo e(route('setting.seo.metas.destroy', $meta)); ?>"
                                                           data-title="Eliminar meta SEO: <?php echo e(Str::limit($meta->title ?? 'Sin título', 30)); ?>">
                                                           Eliminar
                                                        </a>
                                                    </li>
                                                </ul>
                ...
                <?php } else { ?>
                    <div class="text-center py-5">
                        ...
                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($tab === 'all') { ?>
            ...
            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($metas->hasPages()) { ?>
                <div class="card-footer"><?php echo e($metas->links()); ?></div>
            <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
    ...
    <div id="bulk-modal" class="modal fade">
        <div class="modal-dialog modal-md modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="bulk-delete-form" method="POST" action="<?php echo e(route('setting.seo.metas.bulk-delete')); ?>">
                    <?php echo csrf_field(); ?>
...
$(document).ready(function() {
    ...
    $('#btn-bulk-canonical').on('click', function() {
        ...
        $.post('<?php echo e(route('setting.seo.metas.bulk-generate-canonicals')); ?>', {
    ...
    $(document).on('click', '.editable-cell', function (e) {
        ...
        const input = $('<input type="text" class="form-control form-control-sm">')
            ...
            .on('blur keydown', function (e) {
                ...
                $.ajax({
                    url: '<?php echo e(url('panel/setting/seo/metas')); ?>/' + metaId + '/inline-update',
                    method: 'PATCH',
...
<?php echo $__env->make('layouts.theme', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/developerts/Herd/system/modules/Seo/app/Providers/../../resources/views/settings/metas/index.blade.php ENDPATH**/ ?>