...
$__env->startSection('page_title', 'Editar Plantilla: '.($translation->subject ?? $template->name)); ?>

<?php $__env->startSection('content'); ?>

    
    <?php echo $__env->make('core::components.card', ['title' => 'Editor de Plantilla de Email'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    <?php echo $__env->make('mailer::partials.alerts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

    
    <form method="POST" action="<?php echo e(route('mailers.templates.update', $template->uid)); ?>" id="formEdit">
        <?php echo csrf_field(); ?>
        <?php echo method_field('PATCH'); ?>
        <input type="hidden" name="lang_id" value="<?php echo e($currentLangId ?? 1); ?>">
        <input type="hidden" name="translation_uid" value="<?php echo e($translation->uid ?? ''); ?>">
                    ...
                    <div class="card-header border-bottom p-3">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <a href="<?php echo e(route('mailers.templates.versions', ['uid' => $template->uid, 'lang_id' => $currentLangId ?? 1])); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                          ...
                                          placeholder="Descripción breve de para qué se usa esta plantilla"><?php echo e(old('description', $template->description ?? '')); ?></textarea>
                                <small class="text-muted">Descripción general y propósito de la plantilla</small>
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?>"
                                       id="subject" name="subject" value="<?php echo e(old('subject', $translation->subject ?? '')); ?>"
                                ...
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['subject'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                            ...
                            <div class="col-12 col-md-12">
                                ...
                                <input type="text" class="form-control <?php $__errorArgs = ['preheader'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?>"
                                       id="preheader" name="preheader" value="<?php echo e(old('preheader', $translation->preheader ?? '')); ?>"
                                ...
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['preheader'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                            ...
                            <div class="col-12 col-md-12">
                                ...
                                <select class="form-select select2 <?php $__errorArgs = ['layout_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?>" id="layout_id" name="layout_id">
                                    <option value="">Sin layout (solo contenido)</option>
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if (isset($layouts)) { ?>
                                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php SupportCompiledWireKeys::openLoop(); ?><?php } ?><?php $__currentLoopData = $layouts;
                                        $__env->addLoop($__currentLoopData);
                                        foreach ($__currentLoopData as $layout) {
                                            ...
                                            <option value="<?php echo e($layout->id); ?>"
                                                <?php if (old('layout_id', $template->layout_id) == $layout->id) { ?> selected <?php } ?>>
                                                <?php echo e($layout->alias); ?> - <?php echo e($layout->translate($currentLangId)?->subject ?? 'Sin nombre'); ?>
                                ...
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php $__errorArgs = ['layout_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) {
    if (isset($message)) {
        $__messageOriginal = $message;
...
unset($__errorArgs, $__bag); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                            ...
                            <div class="col-12 col-md-12">
                                ...
                                <input type="text" class="form-control" id="current_lang_display"
                                       value="<?php echo e($translation->lang?->title ?? 'No definido'); ?>" disabled readonly>
                            ...
                            <div class="col-12 ">
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" role="switch" id="is_enabled" name="is_enabled" value="1" <?php if (old('is_enabled', $template->is_enabled)) { ?> checked <?php } ?>>
                            ...
                            <div class="col-12 ">
                                <div class="form-check form-switch mt-2">
                                    <input class="form-check-input" type="checkbox" role="switch" id="is_protected" name="is_protected" value="1" <?php if (old('is_protected', $template->is_protected)) { ?> checked <?php } ?>>
                        ...
                        <div class="alert alert-info border-0 mb-0 mt-3 d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex flex-wrap gap-2 align-items-center">
                                    <span><strong>Key:</strong> <code class="text-primary"><?php echo e($template->key); ?></code></span>
                                    <span class="text-muted">•</span>
                                    <span><strong>Módulo:</strong> <code class="text-primary"><?php echo e($template->module); ?></code></span>
                    ...
                    <div class="tab-content" id="editorTabsContent">
                        ...
                        <div class="tab-pane fade show active p-0" id="code-panel" role="tabpanel" aria-labelledby="code-tab">
                            ...
                            <textarea class="form-control d-none" id="content" name="content"><?php echo e(old('content', $translation->content ?? '')); ?></textarea>
                    ...
                    <div class="card-footer bg-white border-top">
                        ...
                        <a href="<?php echo e(route('mailers.templates.preview', ['uid' => $template->uid, 'lang_id' => $currentLangId ?? 1])); ?>" class="btn btn-info w-100 mb-1" target="_blank">
                            Vista previa
                        </a>

                        <a href="<?php echo e(route('mailers.templates.index')); ?>" class="btn btn-secondary w-100">
                            Volver
                        </a>
                    </div>
                </div>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body p-0">
                        <div class="list-group list-group-flush">
                                    ...
                                    <div class="d-flex align-items-center gap-3 flex-grow-1">
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-center gap-2 mb-1">
                                                <strong class="text-black"><?php echo e($translation->lang?->title ?? 'Sin idioma'); ?></strong>
                                                <span class="badge bg-primary">
                                                    Editando
                                                </span>
                                            </div>
                                            <small class="text-muted">
                                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($translation->subject && $translation->content) { ?>
                            ...
                            <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if (! empty($langs) && $langs->count() > 1) { ?>
                                <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php SupportCompiledWireKeys::openLoop(); ?><?php } ?><?php $__currentLoopData = $langs;
                                $__env->addLoop($__currentLoopData);
                                foreach ($__currentLoopData as $lang) {
                                    $__env->incrementLoopIndices();
                                    $loop = $__env->getLastLoop(); ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><?php SupportCompiledWireKeys::startLoopIteration(); ?><?php } ?>
                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($lang->id !== $currentLangId) { ?>
                                        <?php
                                        ...
                                        ?>
                                        <a href="<?php echo e(route('mailers.templates.edit', ['uid' => $template->uid, 'translation_uid' => $translationUid])); ?>"
                                           class="list-group-item list-group-item-action d-flex justify-content-between align-items-center px-3 py-3 hover-shadow-sm"
                                           data-bs-toggle="tooltip" title="Cambiar a <?php echo e($lang->title); ?>">
                                            <div class="d-flex align-items-center gap-2 flex-grow-1">
                                                <div class="flex-grow-1">
                                                    <div class="d-flex align-items-center gap-2 mb-1">
                                                        <strong><?php echo e($lang->title); ?></strong>
                                                        <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if (! $isComplete) { ?>
                                                            <span class="badge bg-warning-subtle text-warning">
                                                                <i class="fas fa-exclamation-circle me-1"></i>Pendiente
                                                            </span>
                                                        <?php } ?><?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if ENDBLOCK]><![endif]--><?php } ?>
                                                    </div>
                                                    <?php if (ExtendBlade::isRenderingLivewireComponent()) { ?><!--[if BLOCK]><![endif]--><?php } ?><?php if ($langTranslation) { ?>
                                                        <small class="text-muted">
                                                            <i class="fas fa-clock me-1"></i>Actualizado: <?php echo e($langTranslation->updated_at->diffForHumans()); ?>
                    ...
                    <div class="card-footer bg-light p-2  text-muted">
                        <div class="d-flex gap-3 flex-wrap">
                            <span>
                                ...
                                <strong><?php echo e($template->translations->where('subject', '!=', null)->where('content', '!=', null)->count()); ?></strong> completas
                            </span>
                            <span>
                                <i class="fas fa-exclamation-circle text-warning me-1"></i>
                                <strong><?php echo e($langs->count() - $template->translations->where('subject', '!=', null)->where('content', '!=', null)->count()); ?></strong> pendientes
                            </span>
                        </div>
                    </div>
                </div>
...
<script src="<?php echo e(asset('js/modules/mailer-editor.js')); ?>"></script>
...
$(document).ready(function() {
    ...
    const currentLangId = <?php echo e($currentLangId ?? 1); ?>;
    let previewTimeout;
    ...
    function updatePreview() {
        ...
        const previewUrl = `<?php echo e(route('mailers.templates.preview-ajax', $template->uid)); ?>`;
    ...
    function loadVariables() {
        $.ajax({
            url: '<?php echo e(route('mailers.templates.variables', $template->uid)); ?>',
            type: 'GET',
            dataType: 'json',
            success: function(data) {
                if (data.success) {
...
<?php echo $__env->make('layouts.theme', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/developerts/Herd/system/modules/Mailer/app/Providers/../../resources/views/templates/edit.blade.php ENDPATH**/ ?>