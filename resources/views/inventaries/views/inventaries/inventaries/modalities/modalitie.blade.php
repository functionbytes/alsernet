        ...
        <div class="tab-content">
            <div  class="note-has-grid row">
                ...
                @if(!$shop->generate_location)
                    <div class="col-md-6">
                        <div class="card">
                            <a class="card-body text-center" href="{{ route('inventarie.inventarie.location.manual', $location->slack ) }}" >
                ...
                <div class="col-md-6">
                    <div class="card">
                        <a class="card-body text-center" href="{{ route('inventarie.inventarie.location.automatic', $location->slack ) }}" >
