                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        {!! Form::select('categories[]', $categories, null , ['class' => 'select2 form-control','id' => 'categories','multiple' => 'multiple']) !!}
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        {!! Form::select('lang', $langs, null , ['class' => 'select2 form-control','id' => 'lang']) !!}
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        {!! Form::select('lopd', $availables, null , ['class' => 'select2 form-control','id' => 'lopd']) !!}
                                    </div>
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    <label class="control-label col-form-label">Recibir informacion de terceros</label>
                                    <div class="input-group">
                                        {!! Form::select('parties', $availables, null , ['class' => 'select2 form-control','id' => 'parties']) !!}
                                    </div>
