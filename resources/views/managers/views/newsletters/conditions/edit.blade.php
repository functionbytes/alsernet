        ...
        <div class="col-lg-12 d-flex align-items-stretch">
            ...
            <div class="card w-100">
                ...
                <form id="formCondition" enctype="multipart/form-data" role="form" onSubmit="return false">
                    ...
                    <input type="hidden" id="slack" name="slack" value="{{ $condition->slack }}">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        {!! Form::select('available', $availables, $condition->available , ['class' => 'select2 form-control','id' => 'available']) !!}
                                    </div>
        ...
        $(document).ready(function() {
            ...
            $("#formCondition").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url: "{{ route('manager.newsletters.conditions.update') }}",
                        headers: {
                        ...
                        success: function(response) {
                            ...
                            if(response.success == true){
                                ...
                                setTimeout(function() {
                                    window.location.href = "{{ route('manager.newsletters.conditions') }}";
                                }, 2000);
