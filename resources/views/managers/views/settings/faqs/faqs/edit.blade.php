                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="position"  name="position"  placeholder="Ingresa una posición" value=" {{ $faq->position  }}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <select name="available" id="available" class="select2 form-control">
                                            @foreach($availables as $key => $value)
                                                <option value="{{ $key }}" {{ $faq->available == $key ? 'selected' : '' }}>
                                                    {{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <label class="control-label col-form-label" for="categorie">Categorias</label>
                                    <div class="input-group">
                                        <select name="categorie" id="categorie" class="select2 form-control">
                                            @foreach($categories as $key => $value)
                                                <option value="{{ $key }}" {{ $faq->category_id == $key ? 'selected' : '' }}>
                                                    {{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
