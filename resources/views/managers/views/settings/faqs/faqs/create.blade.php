                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="position"  name="position"  placeholder="Ingresa una posición">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <select class="select2 form-control" name="available" id="available">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <select class="select2 form-control" name="categorie" id="categorie">
