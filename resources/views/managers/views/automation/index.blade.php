                ...
                <div class="filter-box">
                    ...
                    <div class="dropdown list_actions" style="display: none">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a class="dropdown-item" link-method="POST" link-confirm="{{ trans('messages.disable_automations_confirm') }}" href="{{ route('Automation2Controller@disable') }}">
                                    <span class="material-symbols-rounded me-2">hide_source</span> {{ trans('messages.disable') }}</a></li>
                            <li>
                                <a class="dropdown-item" link-method='DELETE' link-confirm="{{ trans('messages.delete_automations_confirm') }}" href="{{ route('Automation2Controller@delete') }}">
